...
final class ProductVariantsTest extends JsonApiTestCase
{
    ...
    public function it_gets_products_with_original_price(): void
    {
        ...
        $this->assertResponse($response, 'shop/get_product_variant_with_original_price_response', Response::HTTP_OK);
    }
    ...
    public function it_gets_products_without_original_price(): void
    {
        ...
        $this->assertResponse($response, 'shop/get_product_variant_with_price_response', Response::HTTP_OK);
    }
}
