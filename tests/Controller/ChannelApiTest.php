...
EOT;
     ...
     * @test
     */
    public function it_allows_showing_channel_with_shippable_countries(): void
    {
        $this->loadFixturesFromFile('authentication/api_administrator.yml');
        $channels = $this->loadFixturesFromFile('resources/channels.yml');
        ...
        $response = $this->client->getResponse();
        $this->assertResponse($response, 'channel/show_with_shippable_countries_response', Response::HTTP_OK);
    }
