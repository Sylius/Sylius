...
Feature: Import jobs
    ...
    Background:
        ...
        And there are following import jobs set:
    ...
    Scenario: Seeing set import jobs for given import profile
        Given I am on the import profile index page
         ...
         Then I should be on the import jobs index page for profile with code "user_import"
          And I should see 1 import jobs in the list

    Scenario: Seeing import job details
        Given I am on the import jobs index page for profile with code "user_import"
          And I press "details" near 1 import job
