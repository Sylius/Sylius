...
Feature: Zones
    ...
    Background:
        Given I am logged in as administrator
          And there are following zones:
            ...
            | Baltic states + USA GMT | zone     | Baltic states, USA GMT-8                      |
    ...
    Scenario: Creating new zone built from countries
        Given I am on the zone creation page
         When I fill in "Name" with "EU"
          And I select "Country" from "Type"
          And I click "Add member"
         Then I wait for "#sylius_zone_members_0_country" element to appear
         When I select "Estonia" from "Country"
          And I press "Create"
    ...
    Scenario: Updating the zone
        Given I am editing zone "USA GMT-8"
         ...
         Then I should be on the page of zone "USA GMT-9"
          And I should not see zone with name "USA GMT-8" in the list
