...
Feature: Apply correct taxes for products with different tax rates for different zones
    ...
    @ui
    Scenario: Displaying correct tax before specifying billing address
    ...
    @ui
    Scenario: Displaying correct taxes for multiple products from different zones before specifying billing address
        When I add product "PHP T-Shirt" to the cart
