@applying_taxes
Feature: Applying correct taxes for customers with different customer tax rates for different zones when tax rate is included in price
    In order to pay proper amount when buying goods
    As a Customer
    I want to have correct taxes applied to my order when tax rate is included in price
    ...
    Background:
        ...
        And the store has included in price "High VAT" tax rate of 24% for "Clothes" and "General" customer tax category for the rest of the world
        And the store has included in price "VAT" tax rate of 20% for "Clothes" and "Business" customer tax category for the rest of the world
        And the store has also included in price "Low VAT" tax rate of 10% for "Clothes" and "General" customer tax category within the "US" zone
        And the store has also included in price "No VAT" tax rate of 0% for "Clothes" and "Business" customer tax category within the "US" zone
    ...
    Scenario: Applying correct taxes before specifying billing address for logged in customer
        ...
        And my cart taxes should be "$9.09"
    ...
    Scenario: Applying correct taxes after specifying billing address for logged in customer
        ...
        Then my cart total should be "$100.00"
        And my cart taxes should be "$19.35"
    ...
    Scenario: Applying correct taxes after specifying billing address for different logged in customer
        ...
        When I proceed selecting "Germany" as billing country
        Then my cart total should be "$100.00"
        And my cart taxes should be "$16.67"
