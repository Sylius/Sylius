...
Feature: Tax rate unique code validation
    ...
    Background:
        ...
        And the store has a "United States Sales Tax" tax rate of 20% for "Sports gear" and "General" customer tax category within the "US" zone identified by the "UNITED_STATES_SALES_TAX" code
