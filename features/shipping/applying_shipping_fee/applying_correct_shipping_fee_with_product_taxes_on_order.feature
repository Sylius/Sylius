...
Feature: Apply correct shipping fee with product taxes on order
    ...
    Background:
        ...
        And the store has a "Low tax" tax rate of 10% for "Clothes" and "General" customer tax category for the rest of the world
        And the store has a "US Shipping VAT" tax rate of 23% for "Shipping Services" and "General" customer tax category within the "US" zone
        And the store has a "Low Shipping VAT" tax rate of 10% for "Shipping Services" and "General" customer tax category for the rest of the world
