...
Feature: Apply correct shipping fee with product taxes on order
    ...
    Background:
        ...
        And the store has "US VAT" tax rate of 23% for "Clothes" within the "US-TAX" zone
        And the store has "Low tax" tax rate of 10% for "Clothes" for the rest of the world
        And the store has "US Shipping VAT" tax rate of 23% for "Shipping Services" within the "US-TAX" zone
