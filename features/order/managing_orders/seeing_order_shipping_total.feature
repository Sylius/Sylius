...
Feature: Seeing shipping total of an order
    ...
    Background:
        ...
        And the store has "EU VAT" tax rate of 23% for "Hogwart stuff" within "EU" zone
        ...
        And the store has "Owl post" shipping method with "€10.00" fee within "EU" zone
    ...
    Scenario: Seeing taxes of order items and shipping
        ...
        And the customer chose "Owl post" shipping method to "France" with "Offline" payment
