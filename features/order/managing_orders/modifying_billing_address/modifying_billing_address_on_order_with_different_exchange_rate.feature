@modifying_address
Feature: Modifying a customer's billing address of an order with a different currency
    ...
    @ui
    Scenario: Modifying a customer's billing address when the exchange rate has been changed
