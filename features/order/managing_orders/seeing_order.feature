...
Feature: Seeing basic information about an order
    ...
    Scenario: Seeing basic information about an order
        ...
        And it should be billed to "Lucifer Morningstar", "Seaside Fwy", "90802", "Los Angeles", "United States"
        And it should be shipped to "Mazikeen Lilim", "Pacific Coast Hwy", "90806", "Los Angeles", "United States"
