...
Feature: Verifying inventory quantity on cart summary
    ...
    Scenario: Being unable to save a cart with product that is out of stock
        ...
        And I should see "Iron Maiden T-Shirt" with quantity 3 in my cart
        And my cart's total should be "$37.62"
    ...
    @ui @api
    Scenario: Being unable to save quantity that is out of stock and save proper quantity at the same time
        Given I have added 3 products "Iron Maiden T-Shirt" in the cart
        Given I have added 1 products "Black Dress" in the cart
        When I change product "Iron Maiden T-Shirt" quantity to 4 in my cart
        When I change product "Black Dress" quantity to 11 in my cart
        Then I should be notified that this product cannot be updated
        And I should see "Iron Maiden T-Shirt" with quantity 4 in my cart
        And I should see "Black Dress" with quantity 1 in my cart
