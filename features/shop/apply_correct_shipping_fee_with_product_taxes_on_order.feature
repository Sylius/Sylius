...
Feature: Apply correct shipping fee with product taxes on order
    ...
    Background:
        ...
        And store has "EU Shipping VAT" tax rate of 23% for "Shipping Services" within "EU" zone
        And store has "Low Shipping VAT" tax rate of 10% for "Shipping Services" for the rest of the world
