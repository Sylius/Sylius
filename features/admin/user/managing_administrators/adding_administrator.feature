...
Feature: Adding a new administrator
    ...
    @api @ui
    Scenario: Adding a new administrator with API access only
        When I want to create a new administrator
        And I specify its email as "l.skywalker@gmail.com"
        And I specify its name as "Luke"
        And I specify its password as "lightsaber"
        ...
        And I grant it API access
        And I add it
        Then I should be notified that it has been successfully created
        And the administrator "l.skywalker@gmail.com" should have API access
        But the administrator "l.skywalker@gmail.com" should not have administration access

    @api @ui
    Scenario: Adding a new administrator with both access levels
        When I want to create a new administrator
        And I specify its email as "l.skywalker@gmail.com"
        And I specify its name as "Luke"
        And I specify its password as "lightsaber"
        And I specify its locale as "English (United States)"
        And I grant it administration access
        And I grant it API access
        And I add it
        Then I should be notified that it has been successfully created
        And the administrator "l.skywalker@gmail.com" should have administration access
        And the administrator "l.skywalker@gmail.com" should have API access
