@managing_promotions
Feature: Not decreasing a promotion usage with disabled track usage after cancelling an order
    In order to allow unlimited promotion usage tracking
    As an Administrator
    I want to have a promotion usage not decreased after order cancellation when track usage is disabled
    ...
    @api @ui
    Scenario: Seeing promotion usage not decreased after order cancellation when track usage is disabled
