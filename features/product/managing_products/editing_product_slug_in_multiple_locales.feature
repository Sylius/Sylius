...
Feature: Editing product's slug in multiple locales
    ...
    Scenario: Creating a product with custom slugs
        ...
        And I add it
        Then this product should have slug "sir-pugginton" in "English (United States)"
        And this product should have slug "pan-mopsinski" in "Polish (Poland)"
    ...
    Scenario: Creating a product with autogenerated slugs
        ...
        And I name it "Pluszak Mops Mopsiński" in "Polish (Poland)"
        And I add it
        Then this product should have slug "pug-pugginton-plushie" in "English (United States)"
        And this product should have slug "pluszak-mops-mopsinski" in "Polish (Poland)"
    ...
    Scenario: Manually modifying slugs on product's names change
        ...
        And I save my changes
        Then this product should have slug "sit-pugston-the-third" in "English (United States)"
