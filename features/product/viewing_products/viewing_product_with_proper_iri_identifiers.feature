...
Feature: Viewing a product with proper iri identifiers
    ...
    Scenario: Viewing proper iri identifiers for visitor
        ...
        And I should see shop as main iri identifier on this product
        And I should see shop as variants iri identifiers on this product
        And I should see shop as translations iri identifiers on this product
        And I should see shop as images iri identifiers on this product
        And I should see shop as product taxon iri identifiers on this product
        And I should see shop as main taxon iri identifiers on this product
        And I should see shop as product review iri identifiers on this product
        And I should see shop as product options iri identifiers on this product
