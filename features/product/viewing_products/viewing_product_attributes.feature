...
Feature: Viewing product's attributes
    ...
    Scenario: Viewing a detailed page with product's text attribute
        ...
        Then I should see the product attribute "T-shirt material"
        And I should see the product attribute value "Banana skin"
    ...
    Scenario: Viewing a detailed page with product's textarea attribute
        ...
        When I open this product page
        Then I should see the product attribute "T-shirt details"
        And I should see the product attribute value "Banana is very good material."
    ...
    Scenario: Viewing a detailed page with product's checkbox attribute
        ...
        When I open this product page
        Then I should see the product attribute "T-shirt with cotton"
        And I should see the product attribute value "Yes"
    ...
    Scenario: Viewing a detailed page with product's date attribute
        ...
        When I open this product page
        Then I should see the product attribute "T-shirt date of production"
        And I should see the product attribute value "December 12, 2015 00:00"
    ...
    Scenario: Viewing a detailed page with product's datetime attribute
        ...
        When I open this product page
        Then I should see the product attribute "T-shirt date of production"
        And I should see the product attribute value "December 12, 2015 12:34"
    ...
    Scenario: Viewing a detailed page with product's percent attribute
        ...
        When I open this product page
        Then I should see the product attribute "T-shirt cotton content"
        And I should see the product attribute value "50 %"
