...
Feature: Removing a product variant's price from obsolete channel
    ...
    Background:
        ...
        And this product has "Medium PHP Mug" variant originally priced at "$20" in "Web-US" channel
        And "Medium PHP Mug" variant originally priced at "£25" in "Web-GB" channel
