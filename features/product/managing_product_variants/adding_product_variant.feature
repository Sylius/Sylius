...
Feature: Adding a new product variant
    ...
    Scenario: Adding a new product variant
        ...
        And the variant with code "VODKA_WYBOROWA_PREMIUM" should be originally priced at $100.00 for channel "United States"
    ...
    Scenario: Adding a new product variant with specific option's value
        ...
        And I set its original price to "$80.00" for "United States" channel
    ...
    Scenario: Adding a new free product variant
        ...
        Then I should be notified that it has been successfully created
        And the "VODKA_WYBOROWA_PREMIUM" variant of the "Wyborowa Vodka" product should appear in the store
        And the variant with code "VODKA_WYBOROWA_PREMIUM" should be originally priced at $0.00 for channel "United States"
