@viewing_products
Feature: Seeing applied catalog promotions details for simple product
    ...
    Scenario: Seeing applied catalog promotion details on a simple product
        ...
        Then "Ursus C-355" variant price should be decreased by catalog promotion "Company bankruptcy sale"
