...
Feature: Viewing details of a product with variants
    ...
    Scenario: Viewing variants block
        ...
        And I should see "Iron shield" variant with code "123456789-xl", priced "$25.00" in "United States" channel and current stock 5
        And I should see "Iron shield" variant with code "123456789-xs", priced "$15.00" in "United States" channel and current stock 12
