...
Feature: Applying catalog promotion with proper priorities
    ...
    Background:
        ...
        And there is a catalog promotion "Winter sale" with priority 40 that reduces price by fixed "$10.00" and applies on "T-Shirt" product
        And there is a catalog promotion "Spring sale" with priority 20 that reduces price by fixed "$5.00" and applies on "Clothes" taxon
