...
Feature: Reapplying multiple catalog promotions after editing their channels
    ...
    Background:
        ...
        And there is a another catalog promotion "Christmas sale" available in "Web-US" channel and "Web-GB" channel that reduces price by "50%" and applies on "PHP T-shirt" variant
        And I am logged in as an administrator

    @api @todo
    Scenario: Removing only modified catalog promotion after removing its channel
        When I make "Winter sale" catalog promotion unavailable in the "Web-US" channel
