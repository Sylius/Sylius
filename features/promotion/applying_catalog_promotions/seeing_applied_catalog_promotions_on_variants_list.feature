...
Feature: Seeing applied catalog promotions on variants list
    ...
    Background:
        ...
        And there is a catalog promotion with "Winter sale" name that reduces price by "50%" and applies on variants "PHP T-shirt" variant and "Python T-Shirt" variant
