...
Feature: Prices get updated when exchange rate changes during the whole checkout
    ...
    Scenario: Prices get updated on checkout's start
        When the store has an exchange rate 2.0 with source currency "US Dollar" and target currency "British Pound"
    ...
    Scenario: Prices get updated after the addressing step
        ...
        When the store has an exchange rate 5.0 with source currency "US Dollar" and target currency "British Pound"
    ...
    Scenario: Prices get updated on readdressing
        ...
        When the store has an exchange rate 3.0 with source currency "US Dollar" and target currency "British Pound"
