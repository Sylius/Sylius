...
Feature: Having a default address preselected
    ...
    @ui
    Scenario: Having the default address preselected on checkout addressing step
    ...
    @ui
    Scenario: Not modifying the default address in address book after modifying it on addressing step
