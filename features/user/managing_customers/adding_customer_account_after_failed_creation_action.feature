...
Feature: Adding a new customer account after failed creation action
    ...
    @ui @javascript
    Scenario: Trying add new customer with an account without email
        Given I want to create a new customer account
        When I choose create account option
    ...
    @ui @javascript
    Scenario: Trying add new customer without an account without email
        Given I want to create a new customer account
    ...
    Scenario: Trying add new customer with an account without required information
        Given I want to create a new customer account
        When I choose create account option
        And I specify its password as "Na"
        And I try to add it
        Then I should still be on the customer creation page
        And I should be able to specify it password
        And I should not be able to select create account option
