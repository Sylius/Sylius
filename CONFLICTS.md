...
- `doctrine/migrations:3.5.3`:
  ...
  This version is causing a problem with migrations and results in throwing a `Doctrine\Migrations\Exception\MetadataStorageErr` exception e.g. when executing `sylius:install` command.
