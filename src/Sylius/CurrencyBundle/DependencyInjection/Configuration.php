...
namespace Sylius\CurrencyBundle\DependencyInjection;

use Sylius\CurrencyBundle\Controller\CurrencyController;
use Sylius\CurrencyBundle\Form\Type\CurrencyType;
