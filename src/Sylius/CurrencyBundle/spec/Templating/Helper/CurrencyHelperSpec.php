...
namespace spec\Sylius\CurrencyBundle\Templating\Helper;

use PhpSpec\ObjectBehavior;
use Sylius\CurrencyBundle\Templating\Helper\CurrencyHelper;
...
class CurrencyHelperSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CurrencyBundle\Templating\Helper\CurrencyHelper');
    }
