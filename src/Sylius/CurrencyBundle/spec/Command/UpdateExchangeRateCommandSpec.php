...
namespace spec\Sylius\CurrencyBundle\Command;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\ResourceBundle\Doctrine\ORM\EntityRepository;
use Sylius\Currency\Importer\ImporterInterface;
...
class UpdateExchangeRateCommandSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CurrencyBundle\Command\UpdateExchangeRateCommand');
    }
