...
namespace spec\Sylius\ArchetypeBundle\Form\Type;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\ArchetypeBundle\Form\EventListener\ParentArchetypeListener;
...
class ArchetypeTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ArchetypeBundle\Form\Type\ArchetypeType');
    }
