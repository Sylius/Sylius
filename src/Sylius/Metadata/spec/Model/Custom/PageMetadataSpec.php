...
namespace spec\Sylius\Metadata\Model\Custom;

use PhpSpec\ObjectBehavior;
use Sylius\Metadata\Model\Twitter\CardInterface;

/**
 * @mixin \Sylius\Metadata\Model\Custom\PageMetadata
 *
...
class PageMetadataSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\Model\Custom\PageMetadata');
    }

    function it_implements_Page_Metadata_interface()
    {
        $this->shouldImplement('Sylius\Metadata\Model\Custom\PageMetadataInterface');
    }
