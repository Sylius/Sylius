...
/**
 * @mixin \Sylius\Metadata\Model\Twitter\PlayerCard
 *
...
class PlayerCardSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\Model\Twitter\PlayerCard');
    }

    function it_implements_Summary_Card_interface()
    {
        $this->shouldImplement('Sylius\Metadata\Model\Twitter\PlayerCardInterface');
    }
