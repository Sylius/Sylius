...
namespace spec\Sylius\Metadata\Model\Twitter;
...
/**
 * @mixin \Sylius\Metadata\Model\Twitter\SummaryCard
 *
...
class SummaryCardSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\Model\Twitter\SummaryCard');
    }

    function it_implements_Summary_Card_interface()
    {
        $this->shouldImplement('Sylius\Metadata\Model\Twitter\SummaryCardInterface');
    }

    function it_is_serializable()
    {
        $that = new SummaryCard();
