...
/**
 * @mixin \Sylius\Metadata\Model\Twitter\AppCard
 *
...
class AppCardSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\Model\Twitter\AppCard');
    }

    function it_implements_App_Card_interface()
    {
        $this->shouldImplement('Sylius\Metadata\Model\Twitter\AppCardInterface');
    }
