...
/**
 * @mixin \Sylius\Metadata\Model\Twitter\SummaryLargeImageCard
 *
...
class SummaryLargeImageCardSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\Model\Twitter\SummaryLargeImageCard');
    }

    function it_implements_Summary_Large_Image_Card_interface()
    {
        $this->shouldImplement('Sylius\Metadata\Model\Twitter\SummaryLargeImageCardInterface');
    }
