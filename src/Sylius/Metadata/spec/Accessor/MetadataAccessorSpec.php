...
namespace spec\Sylius\Metadata\Accessor;
...
/**
 * @mixin \Sylius\Metadata\Accessor\MetadataAccessor
 *
...
class MetadataAccessorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\Accessor\MetadataAccessor');
    }

    function it_implements_Metadata_Helper_interface()
    {
        $this->shouldImplement('Sylius\Metadata\Accessor\MetadataAccessorInterface');
    }
