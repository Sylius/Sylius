...
namespace spec\Sylius\Metadata\Renderer;
...
/**
 * @mixin \Sylius\Metadata\Renderer\CompositeMetadataRenderer
 *
...
class CompositeMetadataRendererSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\Renderer\CompositeMetadataRenderer');
    }
