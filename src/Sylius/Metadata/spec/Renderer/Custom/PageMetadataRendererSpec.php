...
namespace spec\Sylius\Metadata\Renderer\Custom;
...
use Sylius\Metadata\Renderer\MetadataRendererInterface;
use Symfony\Component\OptionsResolver\OptionsResolver;
use Symfony\Component\PropertyAccess\PropertyAccessorInterface;

/**
 * @mixin \Sylius\Metadata\Renderer\Custom\PageMetadataRenderer
 *
...
class PageMetadataRendererSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\Renderer\Custom\PageMetadataRenderer');
    }

    function it_implements_Metadata_Renderer_interface()
    {
        $this->shouldImplement('Sylius\Metadata\Renderer\MetadataRendererInterface');
    }
