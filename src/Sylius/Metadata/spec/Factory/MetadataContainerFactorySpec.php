...
namespace spec\Sylius\Metadata\Factory;

use PhpSpec\ObjectBehavior;
use Sylius\Metadata\Factory\MetadataContainerFactory;
use Sylius\Metadata\Factory\MetadataContainerFactoryInterface;
use Sylius\Metadata\Model\MetadataContainer;
...
class MetadataContainerFactorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\Factory\MetadataContainerFactory');
    }
