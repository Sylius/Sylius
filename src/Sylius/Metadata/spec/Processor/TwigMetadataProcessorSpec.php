...
namespace spec\Sylius\Metadata\Processor;
...
/**
 * @mixin \Sylius\Metadata\Processor\TwigMetadataProcessor
 *
...
class TwigMetadataProcessorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\Processor\TwigMetadataProcessor');
    }

    function it_implements_Sylius_Metadata_Processor_interface()
    {
        $this->shouldImplement('Sylius\Metadata\Processor\MetadataProcessorInterface');
    }
