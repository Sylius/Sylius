...
namespace spec\Sylius\Metadata\Compiler;

use PhpSpec\ObjectBehavior;
use Sylius\Metadata\Model\MetadataInterface;

/**
 * @mixin \Sylius\Metadata\Compiler\MetadataCompiler
 *
...
class MetadataCompilerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\Compiler\MetadataCompiler');
    }

    function it_implements_Metadata_Compiler_interface()
    {
        $this->shouldImplement('Sylius\Metadata\Compiler\MetadataCompilerInterface');
    }
