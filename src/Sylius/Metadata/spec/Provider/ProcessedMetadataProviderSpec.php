...
use Sylius\Metadata\Processor\MetadataProcessorInterface;
use Sylius\Metadata\Provider\MetadataProviderInterface;

/**
 * @mixin \Sylius\Metadata\Provider\ProcessedMetadataProvider
 *
...
class ProcessedMetadataProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\Provider\ProcessedMetadataProvider');
    }
