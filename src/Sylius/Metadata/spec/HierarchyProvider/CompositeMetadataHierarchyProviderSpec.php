...
namespace spec\Sylius\Metadata\HierarchyProvider;
...
/**
 * @mixin \Sylius\Metadata\HierarchyProvider\CompositeMetadataHierarchyProvider
 *
...
class CompositeMetadataHierarchyProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\HierarchyProvider\CompositeMetadataHierarchyProvider');
    }

    function it_implements_Metadata_Parent_Resolver_interface()
    {
        $this->shouldImplement('Sylius\Metadata\HierarchyProvider\MetadataHierarchyProviderInterface');
    }
