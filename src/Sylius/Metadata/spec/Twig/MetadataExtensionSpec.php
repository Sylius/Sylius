...
namespace spec\Sylius\Metadata\Twig;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\Metadata\Accessor\MetadataAccessorInterface;
...
/**
 * @mixin \Sylius\Metadata\Twig\MetadataExtension
 *
...
class MetadataExtensionSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Metadata\Twig\MetadataExtension');
    }
