...
namespace spec\Sylius\AdminBundle\Controller;

use PhpSpec\ObjectBehavior;
use Sylius\AdminBundle\Controller\DashboardController;
...
class DashboardControllerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\AdminBundle\Controller\DashboardController');
    }
