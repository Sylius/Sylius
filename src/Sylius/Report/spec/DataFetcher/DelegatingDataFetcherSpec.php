...
namespace spec\Sylius\Report\DataFetcher;

use PhpSpec\ObjectBehavior;
use Sylius\Registry\ServiceRegistryInterface;
use Sylius\Report\DataFetcher\DataFetcherInterface;
use Sylius\Report\DataFetcher\DelegatingDataFetcherInterface;
...
class DelegatingDataFetcherSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Report\DataFetcher\DelegatingDataFetcher');
    }
