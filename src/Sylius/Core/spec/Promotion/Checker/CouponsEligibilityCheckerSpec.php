...
use Sylius\Promotion\Checker\CouponsEligibilityChecker;
use Sylius\Promotion\SyliusPromotionEvents;
use Symfony\Component\EventDispatcher\EventDispatcherInterface;
use Symfony\Component\EventDispatcher\GenericEvent;

/**
 * @mixin \Sylius\Core\Promotion\Checker\CouponsEligibilityChecker
 *
...
class CouponsEligibilityCheckerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Core\Promotion\Checker\CouponsEligibilityChecker');
    }
