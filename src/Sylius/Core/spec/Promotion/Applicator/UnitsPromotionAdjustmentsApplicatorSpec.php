...
namespace spec\Sylius\Core\Promotion\Applicator;
...
use Sylius\Core\Promotion\Applicator\UnitsPromotionAdjustmentsApplicator;
use Sylius\Core\Promotion\Applicator\UnitsPromotionAdjustmentsApplicatorInterface;
...
class UnitsPromotionAdjustmentsApplicatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Core\Promotion\Applicator\UnitsPromotionAdjustmentsApplicator');
    }
