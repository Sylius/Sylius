...
namespace spec\Sylius\Core\Resolver;
...
use Sylius\Core\Resolver\ShippingMethodsByZonesAndChannelResolver;
...
class ShippingMethodsByZonesAndChannelResolverSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Core\Resolver\ShippingMethodsByZonesAndChannelResolver');
    }
