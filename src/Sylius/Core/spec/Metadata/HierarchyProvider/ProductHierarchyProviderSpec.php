...
use Sylius\Core\Metadata\HierarchyProvider\ProductHierarchyProvider;
...
class ProductHierarchyProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Core\Metadata\HierarchyProvider\ProductHierarchyProvider');
    }
