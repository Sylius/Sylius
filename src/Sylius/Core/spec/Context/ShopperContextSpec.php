...
namespace spec\Sylius\Core\Context;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\Channel\Context\ChannelContextInterface;
use Sylius\Core\Context\ShopperContext;
use Sylius\Core\Context\ShopperContextInterface;
...
class ShopperContextSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Core\Context\ShopperContext');
    }
