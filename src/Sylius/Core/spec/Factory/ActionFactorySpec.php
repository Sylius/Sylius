...
use Sylius\Core\Factory\ActionFactory;
use Sylius\Core\Factory\ActionFactoryInterface;
use Sylius\Core\Promotion\Action\FixedDiscountAction;
use Sylius\Core\Promotion\Action\UnitFixedDiscountAction;
use Sylius\Core\Promotion\Action\UnitPercentageDiscountAction;
use Sylius\Core\Promotion\Action\PercentageDiscountAction;
use Sylius\Core\Promotion\Action\ShippingDiscountAction;
...
class ActionFactorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Core\Factory\ActionFactory');
    }
