...
class ProductVariantSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Core\Model\ProductVariant');
    }
    ...
    {
        $this->shouldHaveType('Sylius\Product\Model\Variant');
    }
    ...
    {
        $this->shouldImplement('Sylius\Shipping\Model\ShippableInterface');
    }
