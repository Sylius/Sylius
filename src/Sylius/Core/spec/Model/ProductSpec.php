...
use Sylius\Core\Model\ImageInterface;
use Sylius\Core\Model\Product;
use Sylius\Core\Model\ProductInterface;
use Sylius\Core\Model\ProductVariantInterface as VariantInterface;
use Sylius\Core\Model\ProductVariantInterface;
use Sylius\Core\Model\TaxonInterface;
use Sylius\Product\Model\Product as SyliusProduct;
...
class ProductSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Core\Model\Product');
    }
