...
namespace spec\Sylius\Core\Taxation\Processor;
...
use Sylius\Core\Taxation\Processor\OrderTaxesProcessor;
...
class OrderTaxesProcessorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Core\Taxation\Processor\OrderTaxesProcessor');
    }
