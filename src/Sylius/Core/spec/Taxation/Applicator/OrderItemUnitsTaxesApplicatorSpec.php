...
namespace spec\Sylius\Core\Taxation\Applicator;
...
use Sylius\Core\Taxation\Applicator\OrderItemUnitsTaxesApplicator;
...
class OrderItemUnitsTaxesApplicatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Core\Taxation\Applicator\OrderItemUnitsTaxesApplicator');
    }
