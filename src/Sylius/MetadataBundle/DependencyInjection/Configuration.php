...
namespace Sylius\MetadataBundle\DependencyInjection;

use Sylius\MetadataBundle\Controller\MetadataController;
use Sylius\MetadataBundle\Model\MetadataContainer;
use Sylius\MetadataBundle\Form\Type\MetadataContainerType;
use Sylius\ResourceBundle\SyliusResourceBundle;
use Sylius\Metadata\Factory\MetadataContainerFactory;
