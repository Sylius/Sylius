...
namespace spec\Sylius\PromotionBundle\Validator;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\PromotionBundle\Validator\Constraints\CouponPossibleGenerationAmount;
use Sylius\PromotionBundle\Validator\CouponGenerationAmountValidator;
use Sylius\Promotion\Generator\GenerationPolicyInterface;
use Sylius\Promotion\Generator\InstructionInterface;
...
class CouponGenerationAmountValidatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\PromotionBundle\Validator\CouponGenerationAmountValidator');
    }
