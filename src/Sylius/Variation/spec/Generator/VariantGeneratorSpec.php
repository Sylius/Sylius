...
namespace spec\Sylius\Variation\Generator;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\Resource\Factory\FactoryInterface;
use Sylius\Variation\Generator\VariantGeneratorInterface;
use Sylius\Variation\Model\OptionInterface;
use Sylius\Variation\Model\OptionValue;
use Sylius\Variation\Model\VariableInterface;
use Sylius\Variation\Model\VariantInterface;
use Sylius\Variation\SetBuilder\SetBuilderInterface;
...
class VariantGeneratorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Variation\Generator\VariantGenerator');
    }
    ...
    function it_generates_variants_for_every_value_of_an_objects_single_option(
        ...
        $permutationVariant->addOption(Argument::type('Sylius\Variation\Model\OptionValue'))->shouldBeCalled();
