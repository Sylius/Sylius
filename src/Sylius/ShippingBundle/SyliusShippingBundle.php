...
namespace Sylius\ShippingBundle;

use Sylius\ResourceBundle\AbstractResourceBundle;
use Sylius\ResourceBundle\SyliusResourceBundle;
use Sylius\ShippingBundle\DependencyInjection\Compiler\RegisterCalculatorsPass;
use Sylius\ShippingBundle\DependencyInjection\Compiler\RegisterRuleCheckersPass;
use Sylius\ShippingBundle\DependencyInjection\Compiler\RegisterShippingMethodsResolversPass;
