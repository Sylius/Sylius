...
namespace spec\Sylius\ShippingBundle\DependencyInjection\Compiler;
...
class RegisterRuleCheckersPassSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ShippingBundle\DependencyInjection\Compiler\RegisterRuleCheckersPass');
    }
