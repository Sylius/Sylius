...
namespace spec\Sylius\Originator\Originator;
...
class OriginatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Originator\Originator\Originator');
    }
    ...
    {
        $originAware->getOriginId()->willReturn(5);
        $originAware->getOriginType()->willReturn('Sylius\Originator\Model\FakeEntity');

        $manager->getRepository('Sylius\Originator\Model\FakeEntity')->willReturn($repository);
