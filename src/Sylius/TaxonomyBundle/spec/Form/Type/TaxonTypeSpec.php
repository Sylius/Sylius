...
namespace spec\Sylius\TaxonomyBundle\Form\Type;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\ResourceBundle\Form\EventSubscriber\AddCodeFormSubscriber;
use Sylius\TaxonomyBundle\Form\EventListener\BuildTaxonFormSubscriber;
...
class TaxonTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\TaxonomyBundle\Form\Type\TaxonType');
    }
