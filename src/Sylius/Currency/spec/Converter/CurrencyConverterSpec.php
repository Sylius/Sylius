...
namespace spec\Sylius\Currency\Converter;

use PhpSpec\ObjectBehavior;
use Sylius\Currency\Converter\CurrencyConverterInterface;
use Sylius\Currency\Converter\UnavailableCurrencyException;
...
class CurrencyConverterSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Currency\Converter\CurrencyConverter');
    }
