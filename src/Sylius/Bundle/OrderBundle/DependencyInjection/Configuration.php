                ...
                ->arrayNode('classes')
                    ...
                    ->children()
                        ...
                        ->arrayNode('history')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('model')->defaultValue('Sylius\\Bundle\\OrderBundle\\Model\\History')->end()
                                ->scalarNode('controller')->defaultValue('Sylius\\Bundle\\OrderBundle\\Controller\\HistoryController')->end()
                                ->scalarNode('repository')->cannotBeEmpty()->end()
                                ->scalarNode('form')->defaultValue('Sylius\\Bundle\\OrderBundle\\Form\\Type\\HistoryType')->end()
                            ->end()
                        ->end()
