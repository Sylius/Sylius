...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.form.data_mapper.order_item_quantity', OrderItemQuantityDataMapper::class)
        ->args([
            service('sylius.modifier.order_item_quantity'),
            inline_service(DataMapper::class),
        ]);

    $services->set('sylius.form.type.order', OrderType::class)
        ->args([
    ...
    $services->set('sylius.form.type.order_item', OrderItemType::class)
        ->args([
    ...
    $services->set('sylius.form.type.cart', CartType::class)
        ->args([
            '%sylius.model.order.class%',
    ...
    $services->set('sylius.form.type.cart_item', CartItemType::class)
        ->args([
            '%sylius.model.order_item.class%',
