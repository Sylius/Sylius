...
{
    public function __construct(private OrderRepositoryInterface $orderRepository, private ObjectManager $orderManager, private EventDispatcherInterface $eventDispatcher, private string $expirationPeriod)
    {
    }
