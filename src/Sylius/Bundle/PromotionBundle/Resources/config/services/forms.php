...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.form.type.catalog_promotion', CatalogPromotionType::class)
        ->args([
    ...
    $services->set('sylius.form.type.catalog_promotion_scope', CatalogPromotionScopeType::class)
        ->args([
    ...
    $services->set('sylius.form.type.catalog_promotion_action', CatalogPromotionActionType::class)
        ->args([
    ...
    $services->set('sylius.form.type.catalog_promotion_translation', CatalogPromotionTranslationType::class)
        ->args([
    ...
    $services->set('sylius.form.type.promotion', PromotionType::class)
        ->args([
    ...
    $services->set('sylius.form.type.promotion_translation', PromotionTranslationType::class)
        ->args([
    ...
    $services->set('sylius.form.type.promotion_action', PromotionActionType::class)
        ->args([
    ...
    $services->set('sylius.form.type.promotion_rule', PromotionRuleType::class)
        ->args([
    ...
    $services->set('sylius.form.type.promotion_coupon', PromotionCouponType::class)
        ->args([
    ...
    $services->set('sylius.form.type.promotion_action_collection', PromotionActionCollectionType::class)
        ->args([service('sylius.registry.promotion_action')])
        ->tag('form.type');

    $services->set('sylius.form.type.promotion_rule_collection', PromotionRuleCollectionType::class)
        ->args([service('sylius.registry.promotion.rule_checker')])
        ->tag('form.type');

    $services->set('sylius.form.type.promotion_action_choice', PromotionActionChoiceType::class)
        ->args(['%sylius.promotion_actions%'])
        ->tag('form.type');

    $services->set('sylius.form.type.promotion_rule_choice', PromotionRuleChoiceType::class)
        ->args(['%sylius.promotion_rules%'])
        ->tag('form.type');

    $services->set('sylius.form.type.promotion_coupon_to_code', PromotionCouponToCodeType::class)
        ->args([service('sylius.repository.promotion_coupon')])
        ->tag('form.type');

    $services->set('sylius.form.type.promotion_coupon_generator_instruction', PromotionCouponGeneratorInstructionType::class)
        ->args([
