...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.validator.promotion_subject_coupon', PromotionSubjectCouponValidator::class)
    ...
    $services->set('sylius.validator.promotion_date_range', PromotionDateRangeValidator::class)
        ->tag('validator.constraint_validator', ['alias' => 'sylius_promotion_date_range_validator']);

    $services->set('sylius.validator.promotion_coupon_generation_amount', CouponGenerationAmountValidator::class)
    ...
    $services->set('sylius.validator.catalog_promotion_action_group', CatalogPromotionActionGroupValidator::class)
    ...
    $services->set('sylius.validator.catalog_promotion_action_type', CatalogPromotionActionTypeValidator::class)
    ...
    $services->set('sylius.validator.catalog_promotion_scope_group', CatalogPromotionScopeGroupValidator::class)
    ...
    $services->set('sylius.validator.catalog_promotion_scope_type', CatalogPromotionScopeTypeValidator::class)
    ...
    $services->set('sylius.validator.promotion_action_group', PromotionActionGroupValidator::class)
    ...
    $services->set('sylius.validator.promotion_action_type', PromotionActionTypeValidator::class)
        ->args(['%sylius.promotion_actions%'])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_promotion_action_type']);

    $services->set('sylius.validator.promotion_role_group', PromotionRuleGroupValidator::class)
    ...
    $services->set('sylius.validator.promotion_role_type', PromotionRuleTypeValidator::class)
        ->args(['%sylius.promotion_rules%'])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_promotion_rule_type']);

    $services->set('sylius.validator.promotion_not_coupon_based', PromotionNotCouponBasedValidator::class)
