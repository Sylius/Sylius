...
class ItemMostExpensiveConfigurationTypeSpec extends ObjectBehavior
{
    function let()
    {
    ...
    {
        $this->shouldHaveType('Sylius\Bundle\PromotionBundle\Form\Type\Rule\ItemMostExpensiveConfigurationType');
    }
