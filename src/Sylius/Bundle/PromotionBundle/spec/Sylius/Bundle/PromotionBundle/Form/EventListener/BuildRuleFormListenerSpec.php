...
class BuildRuleFormListenerSpec extends ObjectBehavior
{
    ...
    function let(RuleCheckerRegistryInterface $checkerRegistry, RuleCheckerInterface $checker, FormFactoryInterface $factory)
    {
    ...
    function it_should_add_configuration_fields_in_pre_set_data($checkerRegistry, $factory, FormEvent $event, RuleInterface $rule, Form $form, Form $field)
    {
