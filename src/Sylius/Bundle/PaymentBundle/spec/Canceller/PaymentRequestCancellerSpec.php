...
{
    function let(PaymentRequestRepositoryInterface $paymentRequestRepository, StateMachineInterface $stateMachine): void
    {
        $this->beConstructedWith($paymentRequestRepository, $stateMachine);
    }
