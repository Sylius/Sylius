...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.checker.gateway_config_encryption', GatewayConfigEncryptionChecker::class)
    ...
    $services->set('sylius.encrypter.payment_request', PaymentRequestEncrypter::class)
        ->args([service('sylius.encrypter')]);

    $services->set('sylius.encrypter.gateway_config', GatewayConfigEncrypter::class)
        ->args([service('sylius.encrypter')]);

    $services->set('sylius.listener.gateway_config_encryption', GatewayConfigEncryptionListener::class)
        ->args([
    ...
    $services->set('sylius.listener.payment_request_encryption', EntityEncryptionListener::class)
        ->args([
