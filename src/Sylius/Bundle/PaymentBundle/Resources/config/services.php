...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.custom_factory.payment', PaymentFactory::class)
    ...
    $services->set('sylius.registry.payment_methods_resolver', PrioritizedServiceRegistry::class)
        ->args([
            '%sylius.payment_methods_resolver.interface%',
            'Payment methods resolver',
        ]);

    $services->set('sylius.resolver.payment_methods', CompositeMethodsResolver::class)
    ...
    $services->set('sylius.resolver.payment_methods.default', PaymentMethodsResolver::class)
    ...
    $services->set('sylius.validator.groups_generator.gateway_config', GatewayConfigGroupsGenerator::class)
        ->args([
    ...
    $services->set('sylius.validator.groups_generator.payment_method', PaymentMethodGroupsGenerator::class)
        ->args([
