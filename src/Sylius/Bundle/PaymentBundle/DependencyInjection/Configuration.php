                            ...
                            ->children()
                                ->arrayNode('classes')
                                    ->children()
                                        ...
                                        ->scalarNode('interface')->defaultValue('Sylius\Component\Payment\Model\PaymentMethodInterface')->end()
                            ...
                            ->children()
                                ->arrayNode('classes')
                                    ...
                                    ->children()
                                        ...
                                        ->scalarNode('interface')->defaultValue('Sylius\Component\Payment\Model\PaymentInterface')->end()
                                        ->scalarNode('controller')->defaultValue('Sylius\Bundle\ResourceBundle\Controller\ResourceController')->end()
                                        ->scalarNode('repository')->cannotBeEmpty()->end()
                                        ->scalarNode('factory')->cannotBeEmpty()->end()
                                        ->arrayNode('form')
                            ...
                            ->children()
                                ->arrayNode('classes')
                                    ...
                                    ->children()
                                        ...
                                        ->scalarNode('interface')->defaultValue('Sylius\Component\Payment\Model\CreditCardInterface')->end()
                                        ->scalarNode('controller')->defaultValue('Sylius\Bundle\ResourceBundle\Controller\ResourceController')->end()
                                        ->scalarNode('repository')->end()
                                        ->arrayNode('form')
                                            ->addDefaultsIfNotSet()
