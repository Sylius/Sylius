...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius_shop.twig.component.product.add_to_cart_form', AddToCartFormComponent::class)
        ->args([
    ...
    $services->set('sylius_shop.twig.component.product.association', AssociationComponent::class)
        ->args([
    ...
    $services->set('sylius_shop.twig.component.product.card', CardComponent::class)
        ->args([
            service('sylius.repository.product'),
    ...
    $services->set('sylius_shop.twig.component.product.list', ListComponent::class)
        ->args([
            service('sylius.repository.product'),
            service('sylius.context.locale'),
            service('sylius.context.channel'),
    ...
    $services->set('sylius_shop.twig.component.product.price', PriceComponent::class)
        ->args([
            service('sylius.calculator.product_variant_price'),
    ...
    $services->set('sylius_shop.twig.component.product.summary', SummaryComponent::class)
        ->args([
    ...
    $services->set('sylius_shop.twig.component.product.breadcrumb', BreadcrumbComponent::class)
        ->args([
            service('request_stack'),
