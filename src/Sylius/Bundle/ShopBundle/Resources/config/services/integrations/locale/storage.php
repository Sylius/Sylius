...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius_shop.locale_switcher', StorageBasedLocaleSwitcher::class)
        ->args([
    ...
    $services->set('sylius_shop.storage.locale', LocaleStorage::class)
        ->args([service('sylius.storage.session')]);

    $services->alias(LocaleStorageInterface::class, 'sylius_shop.storage.locale');

    $services->set('sylius_shop.context.locale.storage_based', StorageBasedLocaleContext::class)
        ->args([
            service('sylius.context.channel'),
            service('sylius_shop.storage.locale'),
    ...
    $services->set('sylius_shop.router.locale_stripping', LocaleStrippingRouter::class)
