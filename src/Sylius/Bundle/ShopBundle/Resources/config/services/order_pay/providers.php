...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius_shop.provider.order_pay.payment_request_pay_url')
    ...
    $services->set('sylius_shop.provider.order_pay.after_pay_url')
    ...
    $services->set('sylius_shop.provider.order_pay.final_url')
    ...
    $services->set('sylius_shop.provider.order_pay.pay_response.no_payment')
    ...
    $services->set('sylius_shop.provider.order_pay.pay_response.payment_request')
    ...
    $services->set('sylius_shop.provider.order_pay.after_pay_response.payment_request')
