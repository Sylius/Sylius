...
{
    public function let(RouterInterface $decoratedRouter, LocaleContextInterface $localeContext): void
    {
        $this->beConstructedWith($decoratedRouter, $localeContext);
    }

    public function it_is_a_symfony_router(): void
    {
        $this->shouldImplement(RouterInterface::class);
    }

    public function it_is_warmable(): void
    {
    ...
    public function it_strips_locale_from_the_generated_url_if_locale_is_the_same_as_the_one_from_context(
    ...
    public function it_does_not_strip_locale_from_the_generated_url_if_locale_is_different_than_the_one_from_context(
        RouterInterface $decoratedRouter,
        LocaleContextInterface $localeContext
    ): void {
    ...
    public function it_does_not_stirp_locale_from_the_generated_url_if_there_is_no_locale_parameter(
        RouterInterface $decoratedRouter
    ): void {
        $decoratedRouter
            ->generate('route_name', [], UrlGeneratorInterface::ABSOLUTE_PATH)
