...
This bundle uses [GitHub issues](https://github.com/Sylius/SyliusUiBundle/issues).
...
License can be found [here](https://github.com/Sylius/SyliusUiBundle/blob/master/Resources/meta/LICENSE).
