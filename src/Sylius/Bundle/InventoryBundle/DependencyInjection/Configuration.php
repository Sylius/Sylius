    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->children()
                ...
                ->scalarNode('manager')->defaultValue('sylius.manager.inventory.default')->cannotBeEmpty()->end()
                ...
                ->arrayNode('classes')
                    ...
                    ->children()
                        ...
                        ->arrayNode('stock')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('model')->defaultValue('Sylius\Component\Inventory\Model\Stock')->end()
                                ->scalarNode('form')->defaultValue('Sylius\Bundle\InventoryBundle\Form\Type\StockType')->end()                                
                            ->end()
                        ->end()
