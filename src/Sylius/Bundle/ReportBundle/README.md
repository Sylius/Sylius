SyliusReportBundle [![Build status...](https://secure.travis-ci.org/Sylius/SyliusReportBundle.png?branch=master)](http://travis-ci.org/Sylius/SyliusReportBundle)
====================

Report component for [**Symfony2**](http://symfony.com) ecommerce applications.
It provides architecture for report management system.
