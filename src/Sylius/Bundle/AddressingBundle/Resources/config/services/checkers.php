...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.checker.zone_deletion', ZoneDeletionChecker::class)
        ->args([service('sylius.repository.zone_member')]);

    $services->alias(ZoneDeletionCheckerInterface::class, 'sylius.checker.zone_deletion');

    $services->set('sylius.checker.country_provinces_deletion', CountryProvincesDeletionChecker::class)
        ->args([
