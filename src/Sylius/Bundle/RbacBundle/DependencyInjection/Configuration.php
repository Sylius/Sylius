    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('credential_provider')->defaultValue('sylius.credential_provider.cached')->end()
                ->arrayNode('super_user_roles')
                    ->prototype('scalar')->end()
                    ->defaultValue(array('ROLE_ADMINISTRATION_ACCESS'))
                ->end()
