...
{
    public function let(InputInterface $input, OutputInterface $output, Application $application)
    {
    ...
    public function it_should_preserve_the_current_value_of_interactive_option(InputInterface $input, Application $application)
    {
    ...
    public function it_should_use_passed_options_rather_than_default_params(InputInterface $input, Application $application)
    {
        $input->hasOption('no-interaction')
            ->willReturn(true);
        $input->getOption('no-interaction')
