...
class RouteChoiceTypeSpec extends ObjectBehavior
{
    function let()
    {
    ...
    {
        $this->shouldHaveType('Sylius\Bundle\ContentBundle\Form\Type\RouteChoiceType');
    }
    ...
    {
        $this->getParent()->shouldReturn('sylius_route_choice');
    }
