...
class TaxRateResolverSpec extends ObjectBehavior
{
    ...
    function it_returns_null_if_tax_rate_for_given_taxable_category_does_not_exist($taxRateRepository, TaxableInterface $taxable, TaxCategoryInterface $taxCategory)
    {
        $taxable->getTaxCategory()->willReturn($taxCategory);
    ...
    function it_returns_null_if_taxable_does_not_belong_to_any_category($taxRateRepository, TaxableInterface $taxable)
    {
