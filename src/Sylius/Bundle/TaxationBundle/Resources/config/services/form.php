...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.form.type.tax_category', TaxCategoryType::class)
        ->args([
    ...
    $services->set('sylius.form.type.tax_category_choice', TaxCategoryChoiceType::class)
        ->args([service('sylius.repository.tax_category')])
        ->tag('form.type');

    $services->set('sylius.form.type.tax_rate', TaxRateType::class)
        ->args([
    ...
    $services->set('sylius.form.type.tax_calculator_choice', TaxCalculatorChoiceType::class)
