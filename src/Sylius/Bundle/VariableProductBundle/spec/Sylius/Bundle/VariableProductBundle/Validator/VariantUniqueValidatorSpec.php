...
class VariantUniqueValidatorSpec extends ObjectBehavior
{
    ...
    function let(ObjectRepository $variantRepository, ExecutionContextInterface $context)
    {
    ...
    function it_should_add_violation_if_variant_with_given_property_value_already_exists($variantRepository, VariantInterface  $variant, VariantInterface $conflictualVariant, $context)
    {
    ...
    function it_should_not_add_violation_if_variant_with_given_property_value_does_not_exist($variantRepository, VariantInterface $variant, $context)
    {
        $constraint = new VariantUnique(array(
            'property' => 'presentation',
            'message'  => 'Variant with given presentation already exists'
