...
class SyliusVariableProductBundle extends Bundle
{
    ...
    {
        $interfaces = array(
            'Sylius\Component\VariableProduct\Model\VariantInterface'     => 'sylius.model.variant.class',
            'Sylius\Component\VariableProduct\Model\OptionInterface'      => 'sylius.model.option.class',
            'Sylius\Component\VariableProduct\Model\OptionValueInterface' => 'sylius.model.option_value.class',
        );

        $container->addCompilerPass(new ResolveDoctrineTargetEntitiesPass('sylius_product', $interfaces));

        $mappings = array(
            realpath(__DIR__ . '/Resources/config/doctrine/model') => 'Sylius\Component\VariableProduct\Model',
        );
