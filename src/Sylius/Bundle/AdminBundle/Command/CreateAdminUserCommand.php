...
final class CreateAdminUserCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        /** @var CreateAdminUserResult $commandResult */
        $commandResult = $this->handle(new CreateAdminUser(...array_values($adminUserData)));

        if ($commandResult->hasViolations()) {
            $this->io->error($commandResult->getViolationMessages());
