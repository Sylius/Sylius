...
const assetsDir = path.dirname(require.resolve('@sylius/admin-bundle/package.json'));
...
class SyliusAdmin {
    ...
    static getBaseWebpackConfig(rootDir) {
        ...
        Encore
            .addEntry('admin-entry', path.resolve(assetsDir, 'entrypoint.js'));
    ...
    static getWebpackConfig(rootDir) {
        ...
        Encore
            .addEntry('admin-entry', path.resolve(assetsDir, 'app.js'))
    ...
    static _prepareWebpackConfig(rootDir) {
        Encore
            ...
            .addEntry('admin-product-entry', path.resolve(assetsDir, 'product-entrypoint.js'))
