...
return (new ResourceMetadata())
    ...
    ->withRouteCondition("not context.isSyliusRoutingBcLayerEnabled('admin_customer')")
    ->withOperations(new Operations(operations: [
        new Create(
            routeName: '_sylius_admin_customer_create',
        ...
        new Index(
            routeName: '_sylius_admin_customer_index',
            grid: 'sylius_admin_customer',
        ),
        new Show(
            routeName: '_sylius_admin_customer_show',
        ),
    ]))
;
