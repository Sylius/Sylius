...
return (new ResourceMetadata())
    ...
    ->withOperations(operations: new Operations(operations: [
        new Create(redirectToRoute: 'sylius_admin_tax_category_update'),
        new Update(redirectToRoute: 'sylius_admin_tax_category_update'),
        new Delete(),
        new BulkDelete(),
        new Index(grid: 'sylius_admin_tax_category'),
    ]))
;
