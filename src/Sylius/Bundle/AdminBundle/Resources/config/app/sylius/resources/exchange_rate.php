...
return (new ResourceMetadata())
    ...
    ->withOperations(new Operations([
        new Create(redirectToRoute: 'sylius_admin_exchange_rate_update'),
        new Update(redirectToRoute: 'sylius_admin_exchange_rate_update'),
        new Delete(),
        new BulkDelete(),
        new Index(grid: 'sylius_admin_exchange_rate')
    ]))
;
