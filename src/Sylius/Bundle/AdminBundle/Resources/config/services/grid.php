...
return static function (ContainerConfigurator $container) {
    ...
    $services->set("sylius_admin.grid.tax_rate",\Sylius\Bundle\AdminBundle\Grid\TaxRateGrid::class)
        ->args([
    ...
    $services->set("sylius_admin.grid.promotion",\Sylius\Bundle\AdminBundle\Grid\PromotionGrid::class)
        ->args([
    ...
    $services->alias(\Sylius\Bundle\AdminBundle\Grid\PaymentRequestGridInterface::class, "sylius_admin.grid.payment_request");
};
