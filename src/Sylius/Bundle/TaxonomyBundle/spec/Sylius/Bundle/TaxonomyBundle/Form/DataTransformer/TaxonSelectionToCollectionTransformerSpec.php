...
{
    public function let(FakeEntity $entityOne, FakeEntity $entityTwo)
    {
    ...
    public function it_does_reverse_transform_array_of_arrays_value(FakeEntity $entityThree, FakeEntity $entityFour)
    {
        $entityThree->getId()->willReturn(3);
        $entityFour->getId()->willReturn(4);
