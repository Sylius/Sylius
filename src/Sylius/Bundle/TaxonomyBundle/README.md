...
Flexible categorization system based on [Spree Taxonomies system](https://guides.spreecommerce.org/user/configuring_taxonomies.html) for [**Symfony**](https://symfony.com) eCommerce applications.
