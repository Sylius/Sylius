...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.console.command.demote_user', DemoteUserCommand::class)
        ->public()
        ->args([
            service('doctrine'),
            '%sylius.user.users%',
    ...
    $services->set('sylius.console.command.promote_user', PromoteUserCommand::class)
        ->public()
        ->args([
            service('doctrine'),
            '%sylius.user.users%',
    ...
    $services->set('sylius.authentication.success_handler', AuthenticationSuccessHandler::class)
        ->parent('security.authentication.success_handler');

    $services->set('sylius.authentication.failure_handler', AuthenticationFailureHandler::class)
        ->parent('security.authentication.failure_handler')
        ->args([service('translator')]);

    $services->set('sylius.controller.user_security', SecurityController::class)
        ->public()
        ->args([
    ...
    $services->set('sylius.security.password_updater', PasswordUpdater::class)
    ...
    $services->set('sylius.form.type.user_login', UserLoginType::class)
        ->tag('form.type');

    $services->set('sylius.form.type.user_request_password_reset', UserRequestPasswordResetType::class)
        ->args([
    ...
    $services->set('sylius.form.type.user_reset_password', UserResetPasswordType::class)
        ->args([
            PasswordReset::class,
    ...
    $services->set('sylius.form.type.user_change_password', UserChangePasswordType::class)
        ->args([
    ...
    $services->set('sylius.user_checker.enabled', EnabledUserChecker::class)
