                        ...
                        ->arrayNode('currency')
                            ...
                            ->children()
                                ->arrayNode('classes')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('model')->defaultValue(Currency::class)->end()
                                        ->scalarNode('interface')->defaultValue(CurrencyInterface::class)->end()
                                        ...
                                        ->arrayNode('form')
                                            ->addDefaultsIfNotSet()
                                            ->children()
                                                ->scalarNode('default')->defaultValue(CurrencyType::class)->end()
