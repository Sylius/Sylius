...
This bundle uses [GitHub issues](https://github.com/Sylius/SyliusChannelBundle/issues).
...
See the list of [contributors](https://github.com/Sylius/SyliusChannelBundle/contributors).
