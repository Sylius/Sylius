...
class CompositeRequestResolverPassTest extends AbstractCompilerPassTestCase
{
    ...
    {
        $this->setDefinition('sylius.channel_context.request_based.resolver.composite', new Definition());
        $this->setDefinition(
            'sylius.channel_context.request_based.resolver.tagged_one',
            (new Definition())->addTag('sylius.channel_context.request_based.resolver')
        );
        ...
        $this->assertContainerBuilderHasServiceDefinitionWithMethodCall(
            ...
            'addResolver',
            [new Reference('sylius.channel_context.request_based.resolver.tagged_one')]
        );
    }
    ...
    public function it_collects_tagged_request_based_channel_contexts_with_custom_priority()
    {
        ...
        $this->setDefinition(
            'sylius.channel_context.request_based.resolver.tagged_one',
            (new Definition())->addTag('sylius.channel_context.request_based.resolver', ['priority' => 42])
        );
        ...
        $this->assertContainerBuilderHasServiceDefinitionWithMethodCall(
            'sylius.channel_context.request_based.resolver',
            'addResolver',
            [new Reference('sylius.channel_context.request_based.resolver.tagged_one'), 42]
        );
    }
    ...
    {
        $this->setDefinition('sylius.channel_context.request_based.resolver', new Definition());
        $this->setDefinition('sylius.channel_context.request_based.resolver.composite', new Definition());
        $this->setDefinition(
            'sylius.channel_context.request_based.resolver.tagged_one',
            (new Definition())->addTag('sylius.channel_context.request_based.resolver')
