...
namespace spec\Sylius\Bundle\NewsletterBundle\Form\Type;
 ...
 */
class SubscriptionListTypeSpec extends ObjectBehavior
{
    function let()
    {
    ...
    {
        $this->shouldHaveType('Sylius\Bundle\NewsletterBundle\Form\Type\SubscriptionListType');
    }
