 ...
 */
class LoadSupportRequestData extends DataFixture
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $supportRequestRepository = $this->getSupportRequestRepository();
        ...
        for ($i = 0; $i < 20; $i++) {
            ...
            $supportRequest->setTopic($this->getReference('Sylius.SupportTopic.'.rand(0, 4)));
