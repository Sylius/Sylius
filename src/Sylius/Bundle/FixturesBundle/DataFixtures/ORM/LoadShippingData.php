...
class LoadShippingData extends DataFixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $manager->persist($this->createShippingMethod([$this->defaultLocale => 'FedEx World Shipping', 'es_ES' => 'FedEx internacional'], 'SM4', 'Rest of World', DefaultCalculators::FLEXIBLE_RATE, $config));
     ...
     */
    protected function createShippingMethod(array $translatedNames, $code, $zoneName, $calculator = DefaultCalculators::PER_ITEM_RATE, array $configuration = [], ShippingCategoryInterface $category = null)
    {
