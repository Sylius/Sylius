...
namespace Sylius\Bundle\ResourceBundle\Doctrine\ORM\EventSubscriber;
...
use Sylius\Bundle\ResourceBundle\Doctrine\EventSubscriber\AbstractTranslatableSubscriber;
 ...
 */
class TranslatableSubscriber extends AbstractTranslatableSubscriber implements EventSubscriber
{
    /**
     * {@inheritdoc}
     */
    ...
    public function loadClassMetadata(LoadClassMetadataEventArgs $eventArgs)
    {
        ...
        if ($reflection->implementsInterface('Sylius\Component\Resource\Model\TranslationInterface')) {
