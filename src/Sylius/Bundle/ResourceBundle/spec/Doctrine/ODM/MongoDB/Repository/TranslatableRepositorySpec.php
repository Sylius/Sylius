...
namespace spec\Sylius\Bundle\ResourceBundle\Doctrine\ODM\MongoDB\Repository;
 ...
 */
class TranslatableRepositorySpec extends ObjectBehavior
{
    function let(
    ...
    {
        $this->shouldHaveType('Sylius\Bundle\ResourceBundle\Doctrine\ODM\MongoDB\TranslatableResourceRepository');
    }

    function it_implements_Sylius_repository_interface()
    {
        $this->shouldImplement(TranslatableRepositoryInterface::class);
    }
