...
namespace spec\Sylius\Bundle\ResourceBundle\Doctrine\ORM\Repository;
...
require_once __DIR__.'/../Fixtures/Entity/TranslatableFoo.php';
...
class TranslatableResourceRepositorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Bundle\ResourceBundle\Doctrine\ORM\TranslatableResourceRepository');
    }
