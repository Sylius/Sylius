...
final class AddCodeFormSubscriberSpec extends ObjectBehavior
{
    ...
    {
        $this->beConstructedWith(CurrencyType::class);
        ...
        $form
            ->add('code', CurrencyType::class, Argument::withEntry('disabled', true))
            ->shouldBeCalled()
        ;
    ...
    function it_adds_code_with_specified_type_and_label(
        ...
        $this->beConstructedWith(CurrencyType::class, 'sylius.ui.name');
        ...
        $form
            ->add('code', CurrencyType::class, Argument::withEntry('label', 'sylius.ui.name'))
            ->shouldBeCalled()
        ;
