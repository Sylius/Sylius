...
class ObjectToIdentifierTransformerSpec extends ObjectBehavior
{
    ...
    function it_does_not_reverse_transform_null_value(ObjectRepository $repository)
    {
    ...
    function it_reverse_transforms_identifier_to_entity(ObjectRepository $repository, FakeEntity $entity)
    {
