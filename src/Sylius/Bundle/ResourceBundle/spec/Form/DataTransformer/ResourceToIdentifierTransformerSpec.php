...
final class ResourceToIdentifierTransformerSpec extends ObjectBehavior
{
    ...
    public function it_does_not_reverses_null_value(RepositoryInterface $repository): void
    {
    ...
    public function it_throws_an_exception_on_non_existing_resource(RepositoryInterface $repository): void
    {
    ...
    public function it_reverse_transform_identifier_to_resource(RepositoryInterface $repository, ResourceInterface $resource): void
    {
    ...
    public function it_transforms_null_value_to_empty_string(RepositoryInterface $repository): void
    {
        $repository->getClassName()->willReturn(ResourceInterface::class);
    ...
    public function it_transforms_resource_in_identifier(RepositoryInterface $repository, ResourceInterface $resource): void
    {
        $repository->getClassName()->willReturn(ResourceInterface::class);
