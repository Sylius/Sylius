...
class RequestConfigurationFactorySpec extends ObjectBehavior
{
    ...
    )
    {
        ...
        $headersBag->has(RequestConfigurationFactory::API_GROUPS_HEADER)->willReturn(false);
        $headersBag->has(RequestConfigurationFactory::API_VERSION_HEADER)->willReturn(false);
        ...
        $parametersParser->parseRequestValues($configuration, $request)->shouldBeCalled()->willReturn($configuration);
