        ...
        $node
            ->children()
                ->arrayNode('settings')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->arrayNode('response_code')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->integerNode('create')->defaultValue(201)->end()
                                ->integerNode('update')->defaultValue(204)->end()
                                ->integerNode('delete')->defaultValue(204)->end()
                                ->integerNode('applyStateMachineTransition')->defaultValue(200)->end()
                                ->integerNode('enable')->defaultValue(204)->end()
                                ->integerNode('disable')->defaultValue(204)->end()
                                ->integerNode('moveUp')->defaultValue(204)->end()
                                ->integerNode('moveDown')->defaultValue(204)->end()
                            ->end()
                        ->end()
