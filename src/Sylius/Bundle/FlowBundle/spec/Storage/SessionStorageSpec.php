...
{
    public function let(SessionInterface $session, SessionFlowsBag $bag)
    {
    ...
    public function itd_message_is_mutable($bag)
    {
    ...
    public function it_has_message($bag)
    {
    ...
    public function it_checks_is_the_message_exists($bag)
    {
    ...
    public function it_removes_a_message($bag)
    {
    ...
    public function it_removes_all_messages($bag)
    {
        $bag->remove('domain/message_key')->shouldBeCalled();
