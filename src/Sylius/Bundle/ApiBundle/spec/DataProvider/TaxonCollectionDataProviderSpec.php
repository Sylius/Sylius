...
{
    function let(TaxonRepositoryInterface $taxonRepository, UserContextHelperInterface $userContextHelper): void
    {
        $this->beConstructedWith($taxonRepository, $userContextHelper);
    }
