...
final class OrderPatchMethodItemExtensionSpec extends ObjectBehavior
{
    ...
    function it_applies_conditions_to_patch_order_with_state_cart_and_with_null_user_if_present_user_is_null(
    ...
    function it_throws_an_exception_when_unauthorized_shop_user_try_to_patch_order_with_state_cart(
        UserContextInterface $userContext,
        QueryBuilder $queryBuilder,
        ShopUserInterface $shopUser,
        CustomerInterface $customer,
    ...
    function it_throws_an_exception_when_unauthorized_admin_user_try_to_patch_order_with_state_cart(
        UserContextInterface $userContext,
        QueryBuilder $queryBuilder,
        AdminUserInterface $adminUser,
        QueryNameGeneratorInterface $queryNameGenerator
