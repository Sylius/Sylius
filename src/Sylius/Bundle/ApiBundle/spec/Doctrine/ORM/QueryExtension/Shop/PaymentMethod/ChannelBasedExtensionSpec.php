...
namespace spec\Sylius\Bundle\ApiBundle\Doctrine\ORM\QueryExtension\Shop\PaymentMethod;
...
final class ChannelBasedExtensionSpec extends ObjectBehavior
{
    ...
    function it_filters_payment_method_by_current_channel(
    ...
    function it_filters_payment_methods_by_current_channel(
        SectionProviderInterface $sectionProvider,
        QueryBuilder $queryBuilder,
        QueryNameGeneratorInterface $queryNameGenerator,
        ChannelInterface $channel,
    ...
    function it_does_nothing_if_the_current_resource_is_not_a_payment_method_for_item(
        SectionProviderInterface $sectionProvider,
        QueryBuilder $queryBuilder,
        QueryNameGeneratorInterface $queryNameGenerator,
    ): void {
    ...
    function it_does_nothing_if_the_current_resource_is_not_a_payment_method_for_collection(
        SectionProviderInterface $sectionProvider,
        QueryBuilder $queryBuilder,
        QueryNameGeneratorInterface $queryNameGenerator,
    ): void {
