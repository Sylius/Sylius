...
{
    public function let(EntityManager $em, EntityRepository $repository, $clientClass = 'Client/Class/String')
    {
    ...
    public function it_finds_client_by_public_id(ClientInterface $client, $repository)
    {
