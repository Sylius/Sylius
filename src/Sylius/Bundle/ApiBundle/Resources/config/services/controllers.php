...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius_api.controller.delete_order_item', DeleteOrderItemAction::class)
        ->args([
            service('sylius.command_bus'),
            service('sylius.repository.order_item'),
        ]);

    $services->set('sylius_api.controller.get_customer_statistics', GetCustomerStatisticsAction::class)
        ->args([service('sylius.query_bus')])
        ->tag('controller.service_arguments');

    $services->set('sylius_api.controller.get_product_by_slug', GetProductBySlugAction::class)
        ->args([
    ...
    $services->set('sylius_api.controller.remove_catalog_promotion', RemoveCatalogPromotionAction::class)
        ->args([service('sylius.processor.catalog_promotion.removal')]);

    $services->set('sylius_api.controller.remove_customer_shop_user', RemoveCustomerShopUserAction::class)
        ->args([
            service('sylius.command_bus'),
            service('sylius.repository.shop_user'),
        ]);

    $services->set('sylius_api.controller.get_statistics', GetStatisticsAction::class)
        ->args([
    ...
    $services->set('sylius_api.controller.get_taxon_by_slug', GetTaxonBySlugAction::class)
        ->args([
            service('sylius.context.locale'),
