...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius_api.api_platform.routing.iri_converter', IriConverter::class)
    ...
    $services->set('sylius_api.api_platform.routing.api_loader', ApiLoader::class)
    ...
    $services->set('sylius_api.api_platform.metadata.resource.metadata_collection_factory.duplicate_operation_replacer', DuplicateOperationReplacerResourceMetadataCollectionFactory::class)
        ->private()
        ->decorate('api_platform.metadata.resource.metadata_collection_factory', null, 799)
        ->args([service('.inner')]);

    $services->set('sylius_api.api_platform.metadata.resource.metadata_collection_factory.image_filter_aware', ImageFilterAwareResourceMetadataCollectionFactory::class)
        ->private()
    ...
    $services->set('sylius_api.api_platform.hydra.normalizer.empty_collection_filters', EmptyCollectionFiltersNormalizer::class)
        ->private()
