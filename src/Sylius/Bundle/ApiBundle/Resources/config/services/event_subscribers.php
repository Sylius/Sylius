...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius_api.event_subscriber.product_variant', ProductVariantEventSubscriber::class)
        ->args([service('sylius.event_bus')])
        ->tag('kernel.event_subscriber');

    $services->set('sylius_api.event_subscriber.catalog_promotion', CatalogPromotionEventSubscriber::class)
        ->args([service('sylius.announcer.catalog_promotion')])
        ->tag('kernel.event_subscriber');

    $services->set('sylius_api.event_subscriber.kernel_request', KernelRequestEventSubscriber::class)
        ->args([
            '%sylius_api.enabled%',
    ...
    $services->set('sylius_api.event_subscriber.payment_request', PaymentRequestEventSubscriber::class)
        ->args([service('sylius.announcer.payment_request')])
        ->tag('kernel.event_subscriber');

    $services->set('sylius_api.event_subscriber.product_deletion', ProductDeletionEventSubscriber::class)
        ->args([service('sylius.checker.promotion.product_in_promotion_rule')])
        ->tag('kernel.event_subscriber');

    $services->set('sylius_api.event_subscriber.product_slug', ProductSlugEventSubscriber::class)
        ->args([service('sylius.generator.slug')])
        ->tag('kernel.event_subscriber');

    $services->set('sylius_api.event_subscriber.taxon_deletion', TaxonDeletionEventSubscriber::class)
        ->args([
    ...
    $services->set('sylius_api.event_subscriber.taxon_slug', TaxonSlugEventSubscriber::class)
        ->args([service('sylius.generator.taxon_slug')])
        ->tag('kernel.event_subscriber');

    $services->set('sylius_api.event_subscriber.attribute', AttributeEventSubscriber::class)
