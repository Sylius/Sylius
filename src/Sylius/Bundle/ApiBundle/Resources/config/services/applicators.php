...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius_api.applicator.archiving_shipping_method', ArchivingShippingMethodApplicator::class)
        ->args([service('clock')]);

    $services->alias(ArchivingShippingMethodApplicatorInterface::class, 'sylius_api.applicator.archiving_shipping_method');

    $services->set('sylius_api.applicator.order_state_machine_transition', OrderStateMachineTransitionApplicator::class)
    ...
    $services->set('sylius_api.applicator.payment_state_machine_transition', PaymentStateMachineTransitionApplicator::class)
        ->args([service('sylius_abstraction.state_machine')]);
    ...
    $services->set('sylius_api.applicator.product_review_state_machine_transition', ProductReviewStateMachineTransitionApplicator::class)
        ->args([service('sylius_abstraction.state_machine')]);
    ...
    $services->set('sylius_api.applicator.archiving_promotion', ArchivingPromotionApplicator::class)
        ->args([service('clock')]);
