...
final class ValidDatetimeAttributeConfigurationValidator extends ConstraintValidator
{
    public function validate(mixed $value, Constraint $constraint): void
    {
        ...
        /** @var ValidDatetimeAttributeConfiguration $constraint */
        Assert::isInstanceOf($constraint, ValidDatetimeAttributeConfiguration::class);

        if (DatetimeAttributeType::TYPE !== $value->getType()) {
            return;
        }
        ...
        $date = \DateTime::createFromFormat('Y-m-d H:i:s', '2024-01-01 00:00:00');
