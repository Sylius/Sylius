                        ...
                        ->children()
                            ...
                            ->arrayNode('attribute')
                                ...
                                ->children()
                                    ...
                                    ->scalarNode('repository')->defaultValue('Sylius\Bundle\TranslationBundle\Doctrine\ORM\TranslatableEntityRepository')->end()
                                    ->scalarNode('form')->defaultValue('Sylius\Bundle\AttributeBundle\Form\Type\AttributeType')->end()
                                    ->arrayNode('translatable')
                                        ->addDefaultsIfNotSet()
                                        ->children()
                                            ->scalarNode('targetEntity')->defaultValue('Sylius\Component\Attribute\Model\AttributeTranslation')->end()
                            ...
                            ->arrayNode('attribute_translation')
                                ...
                                ->addDefaultsIfNotSet()
                                ->children()
                                    ->scalarNode('model')->defaultValue('Sylius\Component\Attribute\Model\AttributeTranslation')->end()
                                    ->scalarNode('controller')->defaultValue('Sylius\Bundle\ResourceBundle\Controller\ResourceController')->end()
                                    ->scalarNode('repository')->end()
                                    ->scalarNode('form')->defaultValue('Sylius\Bundle\AttributeBundle\Form\Type\AttributeTranslationType')->end()
                                ->end()
                            ->end()
                            ->arrayNode('attribute_value')
                                ->isRequired()
