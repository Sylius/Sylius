                            ...
                            ->children()
                                ->arrayNode('classes')
                                    ...
                                    ->children()
                                        ...
                                        ->scalarNode('interface')->defaultValue('Sylius\Bundle\PayumBundle\Model\PaymentSecurityTokenInterface')->end()
                            ...
                            ->children()
                                ->arrayNode('classes')
                                    ...
                                    ->children()
                                        ...
                                        ->scalarNode('interface')->defaultValue('Sylius\Bundle\PayumBundle\Model\PaymentConfigInterface')->end()
                                        ->scalarNode('controller')->defaultValue('Sylius\Bundle\ResourceBundle\Controller\ResourceController')->end()
                                    ->end()
                                ->end()
                                ->arrayNode('validation_groups')
