...
{
    public function let(OrderInterface $order)
    {
    ...
    public function it_should_allow_get_order_set_in_constructor(OrderInterface $order)
    {
        $this->getOrder()->shouldReturn($order);
    }

    public function it_should_allow_get_credit_card_set_before(CreditCardInterface $creditCard)
    {
