 ...
 */
class InquiryTypeSpec extends ObjectBehavior
{
    function let()
    {
        $this->beConstructedWith('Support', array('sylius'));
    }

    function it_is_initializable()
    {
        $this->shouldHaveType('Sylius\Bundle\SupportBundle\Form\Type\InquiryType');
    }
    ...
    function it_should_build_form_with_proper_fields(FormBuilder $builder)
    {
        ...
        $builder
            ->add('topic', 'sylius_support_topic_choice', Argument::any())
            ->willReturn($builder)
        ;
    ...
    {
        $this->getName()->shouldReturn('sylius_support_inquiry');
    }
}
