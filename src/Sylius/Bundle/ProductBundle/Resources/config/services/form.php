...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.form.type.product_association', ProductAssociationType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_association_type', ProductAssociationTypeType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_association_type_translation', ProductAssociationTypeTranslationType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_association_type_choice', ProductAssociationTypeChoiceType::class)
        ->args([service('sylius.repository.product_association_type')])
        ->tag('form.type');

    $services->set('sylius.form.type.product_associations', ProductAssociationsType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_attribute', ProductAttributeType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_attribute_translation', ProductAttributeTranslationType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_attribute_choice', ProductAttributeChoiceType::class)
        ->args([service('sylius.repository.product_attribute')])
        ->tag('form.type');

    $services->set('sylius.form.type.product_attribute_value', ProductAttributeValueType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product', ProductType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_translation', ProductTranslationType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_choice', ProductChoiceType::class)
        ->args([service('sylius.repository.product')])
        ->tag('form.type');

    $services->set('sylius.form.type.product_code_choice', ProductCodeChoiceType::class)
        ->args([service('sylius.repository.product')])
        ->tag('form.type');

    $services->set('sylius.form.type.product_generate_variants', ProductGenerateVariantsType::class)
        ->args([
            '%sylius.model.product.class%',
    ...
    $services->set('sylius.form.type.product_option', ProductOptionType::class)
        ->args([
            '%sylius.model.product_option.class%',
    ...
    $services->set('sylius.form.type.product_option_translation', ProductOptionTranslationType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_option_value', ProductOptionValueType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_option_value_translation', ProductOptionValueTranslationType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_variant', ProductVariantType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_variant_translation', ProductVariantTranslationType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_variant_generation', ProductVariantGenerationType::class)
        ->args([
            '%sylius.model.product_variant.class%',
    ...
    $services->set('sylius.form.event_subscriber.generate_product_variants', GenerateProductVariantsSubscriber::class)
        ->args([
            service('sylius.generator.product_variant'),
            service('request_stack'),
        ]);

    $services->set('sylius.form.type.data_transformer.products_to_product_associations', ProductsToProductAssociationsTransformer::class)
        ->args([
    ...
    $services->set('sylius.form.type.product_option_value_choice', ProductOptionValueChoiceType::class)
