...
class CartHelper extends Helper
{
     ...
     * @param ResourceFactoryInterface   $cartItemFactory
     * @param FormFactoryInterface  $formFactory
     */
    public function __construct(CartProviderInterface $cartProvider, ResourceFactoryInterface $cartItemFactory, FormFactoryInterface $formFactory)
    {
