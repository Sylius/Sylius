...
{
    function let(CartStorageInterface $storage, ObjectManager $manager, CartRepositoryInterface $repository)
    {
    ...
    function it_looks_for_cart_by_identifier_if_any_in_storage($storage, $repository, CartInterface $cart)
    {
    ...
    function it_creates_new_cart_if_there_is_no_identifier_in_storage($storage, $repository, CartInterface $cart)
    {
    ...
    function it_creates_new_cart_if_identifier_is_wrong($storage, $repository, CartInterface $cart)
    {
