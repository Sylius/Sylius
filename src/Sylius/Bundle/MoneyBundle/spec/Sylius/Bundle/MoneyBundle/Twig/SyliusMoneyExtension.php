...
class SyliusMoneyExtension extends ObjectBehavior
{
    ...
    function it_allows_to_format_money_in_different_currencies($converter)
    {
        $this->formatMoney(15, 'USD')->shouldReturn('$0.15');
        $this->formatMoney(2500, 'USD')->shouldReturn('$25.00');
        $this->formatMoney(312, 'USD')->shouldReturn('$3.12');
        $this->formatMoney(500, 'USD')->shouldReturn('$5.00');
    }

    function it_allows_to_convert_prices_in_different_currencies($converter)
    {
        ...
        $this->formatPrice(312, 'USD')->shouldReturn('$4.08');
        $this->formatPrice(500, 'USD')->shouldReturn('$6.53');
    }
}
