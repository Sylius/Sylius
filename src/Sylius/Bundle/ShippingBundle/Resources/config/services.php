...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.resolver.shipping_methods', CompositeMethodsResolver::class)
    ...
    $services->set('sylius.resolver.shipping_methods.default', ShippingMethodsResolver::class)
        ->args([
    ...
    $services->set('sylius.resolver.shipping_method.default', DefaultShippingMethodResolver::class)
    ...
    $services->set('sylius.calculator.shipping', DelegatingCalculator::class)
    ...
    $services->set('sylius.assigner.shipping_date', ShippingDateAssigner::class)
        ->public()
        ->args([service('clock')]);

    $services->set('sylius.checker.shipping_method_rule.total_weight_greater_than_or_equal', TotalWeightGreaterThanOrEqualRuleChecker::class)
    ...
    $services->set('sylius.checker.shipping_method_rule.total_weight_less_than_or_equal', TotalWeightLessThanOrEqualRuleChecker::class)
