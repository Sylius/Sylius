...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.validator.shipping_method_calculator_exists', ShippingMethodCalculatorExistsValidator::class)
        ->args(['%sylius.shipping_calculators%'])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_shipping_method_calculator_exists']);

    $services->set('sylius.validator.shipping_method_rule', ShippingMethodRuleValidator::class)
        ->args([
    ...
    $services->set('sylius.validator.groups_generator.shipping_method_configuration', ShippingMethodConfigurationGroupsGenerator::class)
        ->args(['%sylius.shipping.shipping_method_calculator.validation_groups%']);

    $services->set('sylius.validator.shipping_method_valid_delivery_time_range', ValidDeliveryTimeRangeValidator::class)
