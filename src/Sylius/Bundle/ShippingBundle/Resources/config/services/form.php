...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.form.type.shipping_method', ShippingMethodType::class)
        ->args([
    ...
    $services->set('sylius.form.type.shipping_method_translation', ShippingMethodTranslationType::class)
        ->args([
    ...
    $services->set('sylius.form.type.shipping_method_choice', ShippingMethodChoiceType::class)
        ->args([
    ...
    $services->set('sylius.form.type.shipping_method_rule', ShippingMethodRuleType::class)
        ->args([
    ...
    $services->set('sylius.form.type.shipping_method_rule_collection', ShippingMethodRuleCollectionType::class)
        ->args([service('sylius.registry.shipping_method_rule_checker')])
        ->tag('form.type');

    $services->set('sylius.form.type.shipping_method_rule_choice', ShippingMethodRuleChoiceType::class)
        ->args(['%sylius.shipping_method_rules%'])
        ->tag('form.type');

    $services->set('sylius.form.type.shipping_category', ShippingCategoryType::class)
        ->args([
    ...
    $services->set('sylius.form.type.shipping_category_choice', ShippingCategoryChoiceType::class)
        ->args([service('sylius.repository.shipping_category')])
        ->tag('form.type');

    $services->set('sylius.form.type.shipment', ShipmentType::class)
        ->args([
    ...
    $services->set('sylius.form.type.shipment_ship', ShipmentShipType::class)
        ->args([
            '%sylius.model.shipment.class%',
    ...
    $services->set('sylius.form.type.shipping_calculator_choice', CalculatorChoiceType::class)
