...
class FlexibleRateCalculatorSpec extends ObjectBehavior
{
    ...
    function it_should_calculate_the_first_item_cost_if_shipment_has_only_one_item(ShipmentInterface $shipment, $shippingItems, $method)
    {
        $configuration = array(
    ...
    function it_should_calculate_the_first_and_every_additional_item_cost_when_shipment_has_more_items(ShipmentInterface $shipment, $shippingItems, $method)
    {
        $configuration = array(
    ...
    function it_should_calculate_the_first_and_every_additional_item_cost_taking_limit_into_account(ShipmentInterface $shipment, $shippingItems, $method)
    {
        $configuration = array(
            'first_item_cost'       => 1500,
            'additional_item_cost'  => 300,
