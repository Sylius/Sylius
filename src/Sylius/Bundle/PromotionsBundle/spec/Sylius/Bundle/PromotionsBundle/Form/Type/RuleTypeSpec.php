...
class RuleTypeSpec extends ObjectBehavior
{
    ...
    function it_should_build_form_with_rule_choice_field(FormBuilder $builder, FormFactoryInterface $factory)
    {
    ...
    function it_should_add_build_promotion_rule_event_subscriber(FormBuilder $builder, FormFactoryInterface $factory)
    {
