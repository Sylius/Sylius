...
class RuleType extends ObjectBehavior
{
    ...
    function it_should_build_form_with_rule_choice_field($builder, $factory)
    {
        ...
        $builder
            ->add('type', 'sylius_promotion_rule_choice', ANY_ARGUMENT)
            ->shouldBeCalled()
            ->willReturn($builder)
        ;
    ...
    function it_should_add_build_promotion_rule_event_subscriber($builder, $factory)
    {
        ...
        $builder
            ->addEventSubscriber(\Mockery::type('Sylius\Bundle\PromotionsBundle\Form\EventListener\BuildRuleFormListener'))
            ->shouldBeCalled()
            ->willReturn($builder)
        ;
