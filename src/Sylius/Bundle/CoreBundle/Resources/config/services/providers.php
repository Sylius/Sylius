...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.provider.delivery_time', FastestDeliveryTimeProvider::class)
    ...
    $services->set('sylius.provider.channel_based_product_translation', ChannelBasedProductTranslationProvider::class)
    ...
    $services->set('sylius.provider.customer', CustomerProvider::class)
        ->args([
    ...
    $services->set('sylius.provider.translation_locale.admin', TranslationLocaleProvider::class)
        ->args([
            service('sylius.provider.locale_collection'),
            '%locale%',
        ]);

    $services->set('sylius.provider.statistics', StatisticsProvider::class)
        ->args([
    ...
    $services->set('sylius.provider.statistics.business_activity_summary', BusinessActivitySummaryProvider::class)
        ->args([
    ...
    $services->set('sylius.provider.statistics.sales', SalesStatisticsProvider::class)
        ->args([
    ...
    $services->set('sylius.provider.statistics.orders_totals.day', DayBasedOrdersTotalProvider::class)
        ->args([service('sylius.repository.order')])
        ->tag('sylius.statistics.orders_totals_provider', ['type' => 'day']);

    $services->set('sylius.provider.statistics.orders_totals.month', MonthBasedOrdersTotalProvider::class)
        ->args([service('sylius.repository.order')])
        ->tag('sylius.statistics.orders_totals_provider', ['type' => 'month']);

    $services->set('sylius.provider.statistics.orders_totals.year', YearBasedOrdersTotalProvider::class)
        ->args([service('sylius.repository.order')])
        ->tag('sylius.statistics.orders_totals_provider', ['type' => 'year']);

    $services->set('sylius.provider.statistics.orders_count.day', DayBasedOrdersCountProvider::class)
        ->args([service('sylius.repository.order')])
        ->tag('sylius.statistics.orders_count_provider', ['type' => 'day']);

    $services->set('sylius.provider.statistics.orders_count.month', MonthBasedOrdersCountProvider::class)
        ->args([service('sylius.repository.order')])
        ->tag('sylius.statistics.orders_count_provider', ['type' => 'month']);

    $services->set('sylius.provider.statistics.orders_count.year', YearBasedOrdersCountProvider::class)
        ->args([service('sylius.repository.order')])
