...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.validator.has_enabled_entity', HasEnabledEntityValidator::class)
        ->args([
            service('doctrine'),
    ...
    $services->set('sylius.validator.customer_initializer', CustomerInitializer::class)
        ->args([service('sylius.canonicalizer')])
        ->tag('validator.initializer');

    $services->set('sylius.validator.registered_user', RegisteredUserValidator::class)
        ->args([service('sylius.repository.customer')])
        ->tag('validator.constraint_validator', ['alias' => 'registered_user_validator']);

    $services->set('sylius.validator.cart_item_availability', CartItemAvailabilityValidator::class)
        ->args([service('sylius.checker.inventory.availability')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_cart_item_availability']);

    $services->set('sylius.validator.cart_item_variant_enabled', CartItemVariantEnabledValidator::class)
        ->tag('validator.constraint_validator', ['alias' => 'sylius_cart_item_variant_enabled']);

    $services->set('sylius.validator.has_all_prices_defined', HasAllPricesDefinedValidator::class)
        ->tag('validator.constraint_validator', ['alias' => 'sylius_has_all_prices_defined']);

    $services->set('sylius.validator.has_all_variant_prices_defined', HasAllVariantPricesDefinedValidator::class)
        ->tag('validator.constraint_validator', ['alias' => 'sylius_has_all_variant_prices_defined']);

    $services->set('sylius.validator.translation_for_existing_locales', TranslationForExistingLocalesValidator::class)
        ->args([service('sylius.repository.locale')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_translation_for_existing_locales']);

    $services->set('sylius.validator.unique_reviewer_email', UniqueReviewerEmailValidator::class)
        ->args([
    ...
    $services->set('sylius.validator.locales_aware_valid_attribute_value', LocalesAwareValidAttributeValueValidator::class)
        ->args([
    ...
    $services->set('sylius.validator.order_shipping_method_eligibility', OrderShippingMethodEligibilityValidator::class)
    ...
    $services->set('sylius.validator.order_payment_method_eligibility', OrderPaymentMethodEligibilityValidator::class)
        ->tag('validator.constraint_validator', ['alias' => 'sylius_order_payment_method_eligibility_validator']);

    $services->set('sylius.validator.order_product_eligibility', OrderProductEligibilityValidator::class)
        ->tag('validator.constraint_validator', ['alias' => 'sylius_order_product_eligibility_validator']);

    $services->set('sylius.validator.channel_default_locale_enabled', ChannelDefaultLocaleEnabledValidator::class)
        ->tag('validator.constraint_validator', ['alias' => 'sylius_channel_default_locale_enabled']);

    $services->set('sylius.validator.channel_code_among_existing_ones', ExistingChannelCodeValidator::class)
        ->args([service('sylius.repository.channel')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_channel_code_among_existing_ones']);

    $services->set('sylius.validator.channel_code_collection', ChannelCodeCollectionValidator::class)
        ->args([
    ...
    $services->set('sylius.validator.customer_group_code_exists', CustomerGroupCodeExistsValidator::class)
        ->args([service('sylius.repository.customer_group')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_customer_group_code_exists']);

    $services->set('sylius.validator.country_code_exists', CountryCodeExistsValidator::class)
        ->args([service('sylius.repository.country')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_country_code_exists']);

    $services->set('sylius.validator.taxon_code_exists', TaxonCodeExistsValidator::class)
        ->args([service('sylius.repository.taxon')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_taxon_code_exists']);

    $services->set('sylius.validator.product_code_exists', ProductCodeExistsValidator::class)
        ->args([service('sylius.repository.product')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_product_code_exists']);

    $services->set('sylius.validator.product_variant_code_exists', ProductVariantCodeExistsValidator::class)
    ...
    $services->set('sylius.validator.resend_order_confirmation_email_with_valid_order_state', ResendOrderConfirmationEmailWithValidOrderStateValidator::class)
        ->args([
    ...
    $services->set('sylius.validator.product_image_variants_belong_to_owner', ProductImageVariantsBelongToOwnerValidator::class)
        ->tag('validator.constraint_validator', ['alias' => 'sylius_product_image_variants_belong_to_owner']);

    $services->set('sylius.validator.resend_shipment_confirmation_email_with_valid_order_state', ResendShipmentConfirmationEmailWithValidShipmentStateValidator::class)
    ...
    $services->set('sylius.validator.max_integer', MaxIntegerValidator::class)
        ->args(['%sylius_core.max_int_value%'])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_max_integer']);

    $services->set('sylius.validator.province_code_exists', ProvinceCodeExistsValidator::class)
        ->args([service('sylius.repository.province')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_province_code_exists']);

    $services->set('sylius.validator.zone_code_exists', ZoneCodeExistsValidator::class)
        ->args([service('sylius.repository.zone')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_zone_code_exists']);

    $services->set('sylius.validator.cart_item_quantity_range', CartItemQuantityRangeValidator::class)
        ->args([
            service('property_accessor'),
    ...
    $services->set('sylius.validator.allowed_image_mime_types', AllowedImageMimeTypesValidator::class)
