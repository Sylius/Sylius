...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.custom_factory.promotion_action', PromotionActionFactory::class)
    ...
    $services->set('sylius.custom_factory.promotion_rule', PromotionRuleFactory::class)
    ...
    $services->set('sylius.provider.active_promotions', ActivePromotionsByChannelProvider::class)
        ->args([service('sylius.repository.promotion')]);

    $services->set('sylius.checker.promotion_rule.customer_group', CustomerGroupRuleChecker::class)
    ...
    $services->set('sylius.checker.promotion_rule.nth_order', NthOrderRuleChecker::class)
    ...
    $services->set('sylius.checker.promotion_rule.shipping_country', ShippingCountryRuleChecker::class)
    ...
    $services->set('sylius.checker.promotion_rule.has_taxon', HasTaxonRuleChecker::class)
    ...
    $services->set('sylius.checker.promotion_rule.total_of_items_from_taxon', TotalOfItemsFromTaxonRuleChecker::class)
    ...
    $services->set('sylius.checker.promotion_rule.contains_product', ContainsProductRuleChecker::class)
    ...
    $services->set('sylius.checker.promotion_rule.item_total', ItemTotalRuleChecker::class)
    ...
    $services->set('sylius.checker.promotion_rule.cart_quantity', CartQuantityRuleChecker::class)
    ...
    $services->set('sylius.command.promotion_action.fixed_discount', FixedDiscountPromotionActionCommand::class)
        ->args([
    ...
    $services->set('sylius.command.promotion_action.unit_fixed_discount', UnitFixedDiscountPromotionActionCommand::class)
        ->args([
    ...
    $services->set('sylius.command.promotion_action.percentage_discount', PercentageDiscountPromotionActionCommand::class)
        ->args([
            service('sylius.distributor.proportional_integer'),
            service('sylius.applicator.promotion.units_adjustments'),
            service('sylius.distributor.minimum_price'),
    ...
    $services->set('sylius.command.promotion_action.unit_percentage_discount', UnitPercentageDiscountPromotionActionCommand::class)
        ->args([
            service('sylius.factory.adjustment'),
            service('sylius.filter.promotion.price_range'),
            service('sylius.filter.promotion.taxon'),
    ...
    $services->set('sylius.command.promotion_action.shipping_percentage_discount', ShippingPercentageDiscountPromotionActionCommand::class)
    ...
    $services->set('sylius.checker.promotion.promotion_coupon_per_customer_usage_limit_eligibility', PromotionCouponPerCustomerUsageLimitEligibilityChecker::class)
        ->args([service('sylius.repository.order')])
    ...
    $services->set('sylius.filter.promotion.price_range', PriceRangeFilter::class)
        ->args([service('sylius.calculator.product_variant_price')]);

    $services->set('sylius.applicator.promotion.units_adjustments', UnitsPromotionAdjustmentsApplicator::class)
        ->args([
            service('sylius.factory.adjustment'),
    ...
    $services->set('sylius.modifier.promotion.order_usage', OrderPromotionsUsageModifier::class)
        ->public()
        ->args([service('sylius.manager.promotion')]);

    $services->alias(OrderPromotionsUsageModifierInterface::class, 'sylius.modifier.promotion.order_usage')
        ->public();

    $services->set('sylius.updater.promotion_rule.has_taxon', HasTaxonRuleUpdater::class)
        ->args([
            service('sylius.repository.promotion_rule'),
            service('doctrine.orm.entity_manager'),
        ]);

    $services->set('sylius.checker.promotion.product_in_promotion_rule', ProductInPromotionRuleChecker::class)
    ...
    $services->set('sylius.checker.promotion.taxon_in_promotion_rule', TaxonInPromotionRuleChecker::class)
        ->args([service('sylius.repository.promotion_rule')]);
