...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.registry.tax_calculation_strategy', PrioritizedServiceRegistry::class)
        ->args([
            '%sylius.tax_calculation_strategy.interface%',
            'Tax calculation strategy',
        ]);

    $services->set('sylius.applicator.taxation.order_shipment', OrderShipmentTaxesApplicator::class)
        ->args([
    ...
    $services->set('sylius.applicator.taxation.order_items', OrderItemsTaxesApplicator::class)
        ->args([
            service('sylius.tax_calculator'),
            service('sylius.factory.adjustment'),
    ...
    $services->set('sylius.applicator.taxation.order_item_units', OrderItemUnitsTaxesApplicator::class)
        ->args([
            service('sylius.tax_calculator'),
            service('sylius.factory.adjustment'),
            service('sylius.resolver.tax_rate'),
    ...
    $services->set('sylius.strategy.taxation.tax_calculation.order_items_based', TaxCalculationStrategy::class)
        ->args([
            'order_items_based',
    ...
    $services->set('sylius.strategy.taxation.tax_calculation.order_item_units_based', TaxCalculationStrategy::class)
        ->args([
