...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.context.channel.cached', CachedPerRequestChannelContext::class)
    ...
    $services->set('sylius.context.shopper', ShopperContext::class)
        ->lazy()
        ->args([
    ...
    $services->set('sylius.context.cart.new_shop_based', ShopBasedCartContext::class)
    ...
    $services->set('sylius.context.cart.customer_and_channel_based', CustomerAndChannelBasedCartContext::class)
        ->args([
            service('sylius.context.customer'),
            service('sylius.context.channel'),
    ...
    $services->set('sylius.storage.currency', CurrencyStorage::class)
        ->args([service('sylius.storage.cookie')]);

    $services->alias(CurrencyStorageInterface::class, 'sylius.storage.currency');

    $services->set('sylius.context.currency.storage_based', StorageBasedCurrencyContext::class)
        ->args([
            service('sylius.context.channel'),
    ...
    $services->set('sylius.context.currency.channel_aware', ChannelAwareCurrencyContext::class)
    ...
    $services->set('sylius.provider.locale.channel_based', ChannelBasedLocaleProvider::class)
    ...
    $services->set('sylius.context.locale.request_based', RequestBasedLocaleContext::class)
        ->args([
            service('request_stack'),
    ...
    $services->set('sylius.context.locale.provider_based', ProviderBasedLocaleContext::class)
