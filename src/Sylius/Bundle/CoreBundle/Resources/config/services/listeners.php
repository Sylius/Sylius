...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.listener.channel_deletion', ChannelDeletionListener::class)
        ->args([
    ...
    $services->set('sylius.listener.images_upload', ImagesUploadListener::class)
    ...
    $services->set('sylius.listener.images_remove', ImagesRemoveListener::class)
        ->args([
    ...
    $services->set('sylius.listener.avatar_upload', ImageUploadListener::class)
        ->args([service('sylius.uploader.image')])
    ...
    $services->set('sylius.listener.order_recalculation', OrderRecalculationListener::class)
    ...
    $services->set('sylius.listener.default_username_orm', DefaultUsernameORMListener::class)
        ->tag('doctrine.event_listener', ['event' => 'onFlush', 'lazy' => true]);

    $services->set('sylius.listener.canonicalizer', CanonicalizerListener::class)
    ...
    $services->set('sylius.listener.password_updater', PasswordUpdaterListener::class)
    ...
    $services->set('sylius.listener.review_create', ReviewCreateListener::class)
    ...
    $services->set('sylius.listener.locking', LockingListener::class)
        ->args([service('doctrine.orm.entity_manager')])
        ->tag('kernel.event_listener', ['event' => 'sylius.product_variant.initialize_update', 'method' => 'lock']);

    $services->set('sylius.listener.simple_product_locking', SimpleProductLockingListener::class)
        ->args([service('doctrine.orm.entity_manager')])
        ->tag('kernel.event_listener', ['event' => 'sylius.product.initialize_update', 'method' => 'lock']);

    $services->set('sylius.listener.customer_default_address', CustomerDefaultAddressListener::class)
        ->tag('kernel.event_listener', ['event' => 'sylius.address.pre_create', 'method' => 'preCreate']);

    $services->set('sylius.listener.locale_aware', LocaleAwareListener::class)
        ->decorate('locale_aware_listener')
        ->args([service('.inner')]);

    $services->set('sylius.event_subscriber.x_frame_options', XFrameOptionsSubscriber::class)
        ->tag('kernel.event_subscriber');

    $services->set('sylius.listener.taxon_deletion', TaxonDeletionListener::class)
        ->args([
    ...
    $services->set('sylius.listener.payment_pre_complete', PaymentPreCompleteListener::class)
    ...
    $services->set('sylius.listener.product_deletion', ProductDeletionListener::class)
    ...
    $services->set('sylius.listener.product_option_value', ProductOptionValueDeletionListener::class)
    ...
    $services->set('sylius.listener.postgre_sql_default_schema', PostgreSQLDefaultSchemaListener::class)
        ->tag('doctrine.event_listener', ['event' => 'postGenerateSchema', 'method' => 'postGenerateSchema', 'lazy' => true]);

    $services->set('sylius.listener.migration_skip', MigrationSkipListener::class)
    ...
    $services->set('sylius.listener.user_impersonator', UserImpersonatorSubscriber::class)
        ->args([service('security.firewall.map')])
        ->tag('kernel.event_subscriber');

    $services->set('sylius.listener.telemetry_index_schema', TelemetryIndexSchemaListener::class)
