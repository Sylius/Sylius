...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.listener.workflow.payment.process_order', ProcessOrderListener::class)
    ...
    $services->set('sylius.listener.workflow.payment.resolve_order_payment_state', ResolveOrderPaymentStateListener::class)
