...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.form.extension.type.address', AddressTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.channel', ChannelTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.order', OrderTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.cart', CartTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.cart_item', CartItemTypeExtension::class)
        ->args(['%sylius.order_item_quantity_modifier.limit%'])
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.catalog_promotion', CatalogPromotionTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.payment_method', PaymentMethodTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.tax_rate', TaxRateTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.taxon', TaxonTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.promotion', PromotionTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.promotion_coupon', PromotionCouponTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.promotion_filter_collection', PromotionFilterCollectionTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.shipping_method', ShippingMethodTypeExtension::class)
        ->args([service('sylius.validator.groups_generator.shipping_method_configuration')])
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.product', ProductTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.product_translation', ProductTranslationTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.product_variant', ProductVariantTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.extension.type.product_variant_generation', ProductVariantGenerationTypeExtension::class)
        ->tag('form.type_extension', ['priority' => 100]);

    $services->set('sylius.form.type.product_review', ProductReviewType::class)
        ->args([
    ...
    $services->set('sylius.form.type.admin_user', AdminUserType::class)
        ->args([
    ...
    $services->set('sylius.form.type.shop_user', ShopUserType::class)
        ->args([
    ...
    $services->set('sylius.form.type.shop_user_registration', ShopUserRegistrationType::class)
        ->args([
            '%sylius.model.shop_user.class%',
    ...
    $services->set('sylius.form.type.product_image', ProductImageType::class)
        ->args([
    ...
    $services->set('sylius.form.type.taxon_image', TaxonImageType::class)
        ->args(['%sylius.model.taxon_image.class%'])
        ->tag('form.type');

    $services->set('sylius.form.type.avatar_image', AvatarImageType::class)
        ->args(['%sylius.model.avatar_image.class%'])
        ->tag('form.type');

    $services->set('sylius.form.type.catalog_promotion_action.percentage_discount_action_configuration', PercentageDiscountActionConfigurationType::class)
        ->tag('sylius.catalog_promotion.action_configuration_type', ['key' => '%sylius.catalog_promotion.action.percentage_discount%'])
        ->tag('form.type');

    $services->set('sylius.form.type.catalog_promotion_action.channel_based_fixed_discount_action_configuration', ChannelBasedFixedDiscountActionConfigurationType::class)
        ->tag('sylius.catalog_promotion.action_configuration_type', ['key' => '%sylius.catalog_promotion.action.fixed_discount%'])
        ->tag('form.type');

    $services->set('sylius.form.type.catalog_promotion_scope.for_products_scope_configuration', ForProductsScopeConfigurationType::class)
    ...
    $services->set('sylius.form.type.catalog_promotion_scope.for_taxons_scope_configuration', ForTaxonsScopeConfigurationType::class)
    ...
    $services->set('sylius.form.type.catalog_promotion_scope.for_variants_scope_configuration', ForVariantsScopeConfigurationType::class)
    ...
    $services->set('sylius.form.type.tax_calculation_strategy_choice', TaxCalculationStrategyChoiceType::class)
        ->args(['%sylius.tax_calculation_strategies%'])
        ->tag('form.type');

    $services->set('sylius.form.type.promotion_rule.customer_group_configuration', CustomerGroupConfigurationType::class)
        ->tag('form.type');

    $services->set('sylius.form.type.promotion_rule.has_taxon_configuration', HasTaxonConfigurationType::class)
        ->args([service('sylius.form.type.data_transformer.taxons_to_codes')])
        ->tag('form.type');

    $services->set('sylius.form.type.promotion_rule.total_of_items_from_taxon_configuration', TotalOfItemsFromTaxonConfigurationType::class)
        ->args([service('sylius.repository.taxon')])
        ->tag('form.type');

    $services->set('sylius.form.type.promotion_rule.contains_product_configuration', ContainsProductConfigurationType::class)
        ->args([service('sylius.repository.product')])
        ->tag('form.type');

    $services->set('sylius.form.type.promotion_action.filter.taxon', TaxonFilterConfigurationType::class)
        ->args([service('sylius.form.type.data_transformer.taxons_to_codes')])
        ->tag('form.type');

    $services->set('sylius.form.type.promotion_action.filter.product', ProductFilterConfigurationType::class)
        ->args([service('sylius.form.type.data_transformer.products_to_codes')])
        ->tag('form.type');

    $services->set('sylius.form.type.data_transformer.taxons_to_codes', TaxonsToCodesTransformer::class)
        ->args([service('sylius.repository.taxon')]);

    $services->set('sylius.form.type.data_transformer.product_variants_to_codes', ProductVariantsToCodesTransformer::class)
        ->args([service('sylius.repository.product_variant')]);

    $services->set('sylius.form.type.data_transformer.products_to_codes', ProductsToCodesTransformer::class)
        ->args([service('sylius.repository.product')]);

    $services->set('sylius.form.type.customer.guest', CustomerGuestType::class)
        ->args([
    ...
    $services->set('sylius.form.type.customer.checkout_guest', CustomerCheckoutGuestType::class)
        ->args([
            '%sylius.model.customer.class%',
    ...
    $services->set('sylius.form.type.customer.simple_registration', CustomerSimpleRegistrationType::class)
        ->args([
            '%sylius.model.customer.class%',
    ...
    $services->set('sylius.form.type.customer.registration', CustomerRegistrationType::class)
        ->args([
            '%sylius.model.customer.class%',
    ...
    $services->set('sylius.form.type.address_choice', AddressChoiceType::class)
        ->args([service('sylius.repository.address')])
        ->tag('form.type');

    $services->set('sylius.form.type.order.add_to_cart', AddToCartType::class)
        ->args([
    ...
    $services->set('sylius.form.type.product.channel_pricing', ChannelPricingType::class)
        ->args([
    ...
    $services->set('sylius.form.type.channels_collection', ChannelCollectionType::class)
        ->args([service('sylius.repository.channel')])
        ->tag('form.type');

    $services->set('sylius.form.type.shipping.calculator.channel_based_flat_rate_configuration', ChannelBasedFlatRateConfigurationType::class)
        ->tag('form.type');

    $services->set('sylius.form.type.shipping.calculator.channel_based_per_unit_rate_configuration', ChannelBasedPerUnitRateConfigurationType::class)
        ->tag('form.type');

    $services->set('sylius.form.type.shop_billing_data', ShopBillingDataType::class)
        ->args(['%sylius.model.shop_billing_data.class%'])
        ->tag('form.type');

    $services->set('sylius.form.type.product_taxon_autocomplete_choice', ProductTaxonAutocompleteChoiceType::class)
        ->args([
    ...
    $services->set('sylius.form.type.channel_price_history_config', ChannelPriceHistoryConfigType::class)
        ->args([
