...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('sylius.listener.catalog_promotion', CatalogPromotionEventListener::class)
    ...
    $services->set('sylius.listener.catalog_promotion.product', ProductEventListener::class)
    ...
    $services->set('sylius.listener.catalog_promotion.product_variant', ProductVariantEventListener::class)
        ->args([service('sylius.event_bus')])
    ...
    $services->set('sylius.listener.catalog_promotion.created', CatalogPromotionCreatedListener::class)
        ->args([
    ...
    $services->set('sylius.listener.catalog_promotion.updated', CatalogPromotionUpdatedListener::class)
        ->args([
            service('sylius.processor.catalog_promotion.all_product_variant'),
            service('sylius.repository.catalog_promotion'),
            service('doctrine.orm.entity_manager'),
    ...
    $services->set('sylius.listener.catalog_promotion.ended', CatalogPromotionEndedListener::class)
        ->args([
            service('sylius.processor.catalog_promotion.all_product_variant'),
            service('sylius.repository.catalog_promotion'),
            service('doctrine.orm.entity_manager'),
    ...
    $services->set('sylius.listener.catalog_promotion.state_changed', CatalogPromotionStateChangedListener::class)
        ->args([service('sylius.command_bus')])
        ->tag('messenger.message_handler', ['bus' => 'sylius.event_bus']);

    $services->set('sylius.listener.catalog_promotion.product_created', ProductCreatedListener::class)
        ->args([
    ...
    $services->set('sylius.listener.catalog_promotion.product_updated', ProductUpdatedListener::class)
        ->args([
            service('sylius.repository.product'),
            service('sylius.processor.catalog_promotion.product'),
            service('doctrine.orm.entity_manager'),
    ...
    $services->set('sylius.listener.catalog_promotion.product_variant_created', ProductVariantCreatedListener::class)
        ->args([
    ...
    $services->set('sylius.listener.catalog_promotion.product_variant_updated', ProductVariantUpdatedListener::class)
        ->args([
            service('sylius.repository.product_variant'),
            service('sylius.processor.catalog_promotion.product_variant'),
            service('doctrine.orm.entity_manager'),
