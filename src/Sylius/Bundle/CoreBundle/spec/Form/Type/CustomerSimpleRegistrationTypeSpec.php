...
use Sylius\Bundle\Coreundle\Form\EventSubscriber\CustomerRegistrationFormSubscriber;
...
class CustomerRegistrationTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Bundle\CoreBundle\Form\Type\CustomerRegistrationType');
    }
    ...
    {
        $this->getName()->shouldReturn('sylius_customer_simple_registration');
    }
}
