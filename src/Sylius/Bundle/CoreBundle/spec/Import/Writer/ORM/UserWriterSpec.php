...
use Sylius\Bundle\CoreBundle\Import\Writer\ORM\Processor\UserProcessorInterface;
...
class UserWriterSpec extends ObjectBehavior
{
    ...
    )
    {
        ...
        $userProcessor->convert($flattenUsers, 'format')->shouldBeCalled()->willReturn($restoredUsers);
