...
{
    public function let(TwigMailerInterface $mailer)
    {
        $params = array(
    ...
    public function it_sends_order_confirmation_email(OrderInterface $order, UserInterface $user, TwigMailerInterface $mailer)
    {
