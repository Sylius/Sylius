...
class SecurityStepSpec extends ObjectBehavior
{
    /**
    ...
    function its_forwardAction_render_step_without_register($context, $templating, $request)
    {
        ...
        $templating->renderResponse(Argument::any(), Argument::cetera())->shouldBeCalled();
    ...
    function its_forwardAction_complete_and_register_new_user($context, $templating, $request, $form, $user, $userManager, $container, $security)
    {
        ...
        $security->setToken(Argument::any())->shouldBeCalled();

        $templating->renderResponse(Argument::any(), Argument::cetera())->shouldNotBeCalled();
