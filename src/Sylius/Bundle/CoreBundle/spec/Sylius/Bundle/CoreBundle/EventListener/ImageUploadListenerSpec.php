...
class ImageUploadListenerSpec extends ObjectBehavior
{
    ...
    function it_uses_image_uploader_to_upload_images(GenericEvent $event, Variant $variant, ProductInterface $product, ImageInterface $image, $uploader)
    {
    ...
    function it_uses_image_uploader_to_upload_taxon_image(GenericEvent $event, Taxon $taxon, ImageInterface $image, $uploader)
    {
    ...
    function it_throws_exception_if_event_subject_is_not_a_product(GenericEvent $event, $uploader)
    {
