...
class OrderSpec extends ObjectBehavior
{
    ...
    function it_should_return_shipping_adjustments(AdjustmentInterface $shippingAdjustment, AdjustmentInterface $taxAdjustment)
    {
    ...
    function it_should_remove_shipping_adjustments(AdjustmentInterface $shippingAdjustment, AdjustmentInterface $taxAdjustment)
    {
        $this->addShippingAndTaxAdjustments($this, $shippingAdjustment, $taxAdjustment);
    ...
    function it_should_return_tax_adjustments(AdjustmentInterface $shippingAdjustment, AdjustmentInterface $taxAdjustment)
    {
        $this->addShippingAndTaxAdjustments($this, $shippingAdjustment, $taxAdjustment);
    ...
    */
    ...
    function it_is_a_backorder_if_contains_at_least_one_backordered_unit(InventoryUnitInterface $unit1, InventoryUnitInterface $unit2)
    {
    ...
    function it_not_a_backorder_if_contains_no_backordered_units(InventoryUnitInterface $unit1, InventoryUnitInterface $unit2)
    {
        $unit1->setOrder($this)->shouldBeCalled();
        $unit2->setOrder($this)->shouldBeCalled();
