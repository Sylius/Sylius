...
final class CustomerAndChannelBasedCartContextSpec extends ObjectBehavior
{
    ...
    function it_returns_uncompleted_cart_for_currently_logged_user(
        ...
        $orderRepository->findFirstNotEmptyAuthorizedCartByChannelAndCustomer($channel, $customer)->willReturn($order);
    ...
    function it_throws_exception_if_no_cart_can_be_provided(
        ...
        $orderRepository->findFirstNotEmptyAuthorizedCartByChannelAndCustomer($channel, $customer)->willReturn(null);
