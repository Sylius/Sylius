...
use Sylius\Bundle\CoreBundle\Workflow\Listener\OrderCheckout\AfterSkippedPaymentListener;
use Sylius\Component\Core\Model\OrderInterface;
use Symfony\Component\Workflow\Event\Event;

final class AfterSkippedPaymentListenerSpec extends ObjectBehavior
{
    function let(
        AfterSkippedPaymentCallbackInterface $firstCallback,
        AfterSkippedPaymentCallbackInterface $secondCallback,
    ): void {
    ...
    {
        $this->shouldHaveType(AfterSkippedPaymentListener::class);
    }
