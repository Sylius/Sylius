...
use Sylius\Bundle\CoreBundle\Workflow\Listener\OrderCheckout\AfterSelectedShippingListener;
use Sylius\Component\Core\Model\OrderInterface;
use Symfony\Component\Workflow\Event\Event;

final class AfterSelectedShippingListenerSpec extends ObjectBehavior
{
    function let(
        AfterSelectedShippingCallbackInterface $firstCallback,
        AfterSelectedShippingCallbackInterface $secondCallback,
    ): void {
    ...
    {
        $this->shouldHaveType(AfterSelectedShippingListener::class);
    }
