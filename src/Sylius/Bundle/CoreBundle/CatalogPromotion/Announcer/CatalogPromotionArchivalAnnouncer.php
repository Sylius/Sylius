...
final class CatalogPromotionArchivalAnnouncer implements CatalogPromotionArchivalAnnouncerInterface
{
    public function __construct(private MessageBusInterface $commandBus)
    {
    }

    public function dispatchCatalogPromotionArchival(CatalogPromotionInterface $catalogPromotion): void
    {
        ...
        $this->commandBus->dispatch(new ArchiveCatalogPromotion($catalogPromotion->getCode()));
    }

    public function dispatchCatalogPromotionRestoral(CatalogPromotionInterface $catalogPromotion): void
    {
        $this->commandBus->dispatch(new RestoreCatalogPromotion($catalogPromotion->getCode()));
    }
}
