...
final class ProductUpdatedListenerTest extends TestCase
{
    ...
    private ProductUpdatedListener $listener;
    ...
    protected function setUp(): void
    {
        ...
        $this->listener = new ProductUpdatedListener(
    ...
    public function testProcessesCatalogPromotionsForUpdatedProduct(): void
    {
        ...
        ($this->listener)(new ProductUpdated('MUG'));
    }
