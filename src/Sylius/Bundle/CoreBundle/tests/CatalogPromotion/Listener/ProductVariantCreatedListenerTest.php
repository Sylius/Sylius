...
final class ProductVariantCreatedListenerTest extends TestCase
{
    ...
    private ProductVariantCreatedListener $listener;
    ...
    protected function setUp(): void
    {
        ...
        $this->listener = new ProductVariantCreatedListener(
    ...
    public function testProcessesCatalogPromotionsForCreatedProductVariant(): void
    {
        ...
        ($this->listener)(new ProductVariantCreated('PHP_MUG'));
    }
