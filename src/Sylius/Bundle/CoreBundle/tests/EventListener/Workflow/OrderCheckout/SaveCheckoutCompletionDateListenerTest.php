...
final class SaveCheckoutCompletionDateListenerTest extends TestCase
{
    private SaveCheckoutCompletionDateListener $listener;

    protected function setUp(): void
    {
        $this->listener = new SaveCheckoutCompletionDateListener();
    }
    ...
    public function testItCompletesCheckout(): void
    {
