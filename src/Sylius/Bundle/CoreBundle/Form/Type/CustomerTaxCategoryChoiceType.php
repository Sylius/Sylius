...
final class CustomerTaxCategoryChoiceType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'choices' => function (Options $options) {
                return $this->customerTaxCategoryRepository->findAll();
            },
            'choice_value' => 'code',
            'choice_label' => 'name',
    ...
    {
        return 'sylius_customer_tax_category_choice';
    }
}
