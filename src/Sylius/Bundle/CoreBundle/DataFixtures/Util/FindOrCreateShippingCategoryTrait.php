...
trait FindOrCreateShippingCategoryTrait
{
    /**
     * @return ShippingCategoryInterface|Proxy
     */
    private function findOrCreateShippingCategory(EventDispatcherInterface $eventDispatcher, array $attributes): Proxy
    {
        /** @var ResourceEventInterface $event */
        $event = $eventDispatcher->dispatch(
            new FindOrCreateResourceEvent(ShippingCategoryFactoryInterface::class, $attributes),
        );
