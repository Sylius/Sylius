 ...
 */
interface ShippingMethodFactoryInterface extends WithCodeInterface, WithNameInterface, WithDescriptionInterface, WithZoneInterface, WithTaxCategoryInterface, WithChannelInterface
{
