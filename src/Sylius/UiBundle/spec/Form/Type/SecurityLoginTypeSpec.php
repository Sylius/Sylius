...
namespace spec\Sylius\UiBundle\Form\Type;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\UiBundle\Form\Type\SecurityLoginType;
...
class SecurityLoginTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\UiBundle\Form\Type\SecurityLoginType');
    }
