...
namespace spec\Sylius\UiBundle\Controller;

use PhpSpec\ObjectBehavior;
use Sylius\UiBundle\Controller\SecurityController;
...
class SecurityControllerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\UiBundle\Controller\SecurityController');
    }
