...
namespace spec\Sylius\Contact\Model;

use PhpSpec\ObjectBehavior;
use Sylius\Contact\Model\RequestInterface;
use Sylius\Contact\Model\TopicInterface;
...
class RequestSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Contact\Model\Request');
    }
