...
namespace spec\Sylius\FlowBundle\DependencyInjection\Compiler;
...
class RegisterSessionBagsPassSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\FlowBundle\DependencyInjection\Compiler\RegisterSessionBagsPass');
    }
