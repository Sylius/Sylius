...
namespace spec\Sylius\FlowBundle\Process\Coordinator;
...
use Sylius\FlowBundle\Process\Coordinator\CoordinatorInterface;
...
class CoordinatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\FlowBundle\Process\Coordinator\Coordinator');
    }
