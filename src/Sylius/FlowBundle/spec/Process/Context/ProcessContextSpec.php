...
namespace spec\Sylius\FlowBundle\Process\Context;
...
use Sylius\FlowBundle\Storage\StorageInterface;
...
class ProcessContextSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\FlowBundle\Process\Context\ProcessContext');
    }
