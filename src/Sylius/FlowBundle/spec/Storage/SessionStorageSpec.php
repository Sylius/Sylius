...
class SessionStorageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\FlowBundle\Storage\SessionStorage');
        $this->shouldHaveType('Sylius\FlowBundle\Storage\AbstractStorage');
        $this->shouldImplement('Sylius\FlowBundle\Storage\StorageInterface');
    }
