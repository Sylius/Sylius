...
namespace Sylius\FlowBundle\Process\Builder;

use Sylius\FlowBundle\Process\Process;
use Sylius\FlowBundle\Process\ProcessInterface;
use Sylius\FlowBundle\Process\Scenario\ProcessScenarioInterface;
use Sylius\FlowBundle\Process\Step\StepInterface;
use Sylius\FlowBundle\Validator\ProcessValidatorInterface;
...
class ProcessBuilder implements ProcessBuilderInterface
{
    ...
    public function add($name, $step)
    {
        ...
        if (!$step instanceof StepInterface) {
            throw new \InvalidArgumentException('Step added via builder must implement "Sylius\FlowBundle\Process\Step\StepInterface"');
        }
