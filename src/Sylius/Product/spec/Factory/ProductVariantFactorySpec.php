...
namespace spec\Sylius\Product\Factory;

use PhpSpec\ObjectBehavior;
use Sylius\Product\Factory\ProductVariantFactoryInterface;
...
class ProductVariantFactorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Product\Factory\ProductVariantFactory');
    }
