...
namespace spec\Sylius\UserBundle\Provider;

use PhpSpec\ObjectBehavior;
use Sylius\UserBundle\Provider\AbstractUserProvider;
...
class UsernameOrEmailProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\UserBundle\Provider\UsernameOrEmailProvider');
    }
    ...
    {
        $this->supportsClass('Sylius\User\Model\GroupInterface')->shouldReturn(false);
