...
use Sylius\User\Model\CredentialsHolderInterface;
use Sylius\User\Security\UserPasswordEncoderInterface;
...
class UserPasswordEncoderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\UserBundle\Security\UserPasswordEncoder');
    }
