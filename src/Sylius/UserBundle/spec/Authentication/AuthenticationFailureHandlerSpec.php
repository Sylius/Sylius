...
namespace spec\Sylius\UserBundle\Authentication;

use PhpSpec\ObjectBehavior;
use Sylius\UserBundle\Authentication\AuthenticationFailureHandler;
...
class AuthenticationFailureHandlerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\UserBundle\Authentication\AuthenticationFailureHandler');
    }
