...
namespace spec\Sylius\UserBundle\EventListener;

use Doctrine\Common\Persistence\ObjectManager;
use PhpSpec\ObjectBehavior;
use Sylius\UserBundle\Event\UserEvent;
use Sylius\UserBundle\UserEvents;
...
class UserLastLoginSubscriberSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\UserBundle\EventListener\UserLastLoginSubscriber');
    }

    function it_is_subscriber()
    {
        $this->shouldImplement('Sylius\UserBundle\EventListener\UserLastLoginSubscriber');
    }
