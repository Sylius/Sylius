...
use Sylius\UserBundle\Form\EventSubscriber\CustomerRegistrationFormSubscriber;
use Sylius\UserBundle\Form\EventSubscriber\UserRegistrationFormSubscriber;
...
class CustomerRegistrationTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\UserBundle\Form\Type\CustomerRegistrationType');
    }
