...
namespace Sylius\UserBundle\OAuth;

use Doctrine\Common\Persistence\ObjectManager;
use HWI\Bundle\OAuthBundle\Connect\AccountConnectorInterface;
use HWI\Bundle\OAuthBundle\OAuth\Response\UserResponseInterface;
use HWI\Bundle\OAuthBundle\Security\Core\User\OAuthAwareUserProviderInterface;
use Sylius\UserBundle\Provider\UsernameOrEmailProvider as BaseUserProvider;
...
use Sylius\User\Model\UserInterface as SyliusUserInterface;
...
class UserProvider extends BaseUserProvider implements AccountConnectorInterface, OAuthAwareUserProviderInterface
{
    ...
    {
        /** @var \Sylius\User\Model\UserInterface $user */
