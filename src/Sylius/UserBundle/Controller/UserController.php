...
namespace Sylius\UserBundle\Controller;

use FOS\RestBundle\View\View;
use Sylius\ResourceBundle\Controller\RequestConfiguration;
use Sylius\ResourceBundle\Controller\ResourceController;
use Sylius\UserBundle\Form\Model\ChangePassword;
use Sylius\UserBundle\Form\Model\PasswordReset;
use Sylius\UserBundle\Form\Model\PasswordResetRequest;
use Sylius\UserBundle\UserEvents;
use Sylius\User\Model\UserInterface;
use Sylius\User\Security\TokenProviderInterface;
