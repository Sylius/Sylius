...
namespace spec\Sylius\ReviewBundle\Validator\Constraints;

use PhpSpec\ObjectBehavior;
use Sylius\ReviewBundle\Validator\Constraints\UniqueReviewerEmail;
...
class UniqueReviewerEmailValidatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ReviewBundle\Validator\Constraints\UniqueReviewerEmailValidator');
    }
