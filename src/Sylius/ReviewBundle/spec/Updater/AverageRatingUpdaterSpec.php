...
namespace spec\Sylius\ReviewBundle\Updater;

use Doctrine\Common\Persistence\ObjectManager;
use PhpSpec\ObjectBehavior;
use Sylius\ReviewBundle\Updater\ReviewableRatingUpdaterInterface;
use Sylius\Review\Calculator\ReviewableRatingCalculatorInterface;
...
class AverageRatingUpdaterSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ReviewBundle\Updater\AverageRatingUpdater');
    }
