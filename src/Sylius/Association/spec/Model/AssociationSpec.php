...
namespace spec\Sylius\Association\Model;

use PhpSpec\ObjectBehavior;
use Sylius\Association\Model\AssociableInterface;
use Sylius\Association\Model\AssociationInterface;
use Sylius\Association\Model\AssociationType;
...
class AssociationSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Association\Model\Association');
    }
