...
namespace spec\Sylius\AddressingBundle\Twig;

use PhpSpec\ObjectBehavior;
use Sylius\Addressing\Provider\ProvinceNamingProviderInterface;
...
class ProvinceNamingExtensionSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\AddressingBundle\Twig\ProvinceNamingExtension');
    }
