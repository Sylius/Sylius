...
namespace spec\Sylius\AddressingBundle\Validator\Constraints;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\AddressingBundle\Validator\Constraints\ProvinceAddressConstraint;
use Sylius\Addressing\Model\AddressInterface;
use Sylius\Addressing\Model\Country;
use Sylius\Addressing\Model\Province;
...
class ProvinceAddressConstraintValidatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\AddressingBundle\Validator\Constraints\ProvinceAddressConstraintValidator');
    }
