...
namespace Sylius\AddressingBundle\Validator\Constraints;
    ...
    public function validate($value, Constraint $constraint)
    {
        if (!$value instanceof AddressInterface) {
            throw new \InvalidArgumentException(
                'ShippableAddressConstraintValidator can only validate instances of "Sylius\Addressing\Model\AddressInterface"'
            );
        }
