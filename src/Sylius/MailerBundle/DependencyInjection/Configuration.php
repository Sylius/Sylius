...
namespace Sylius\MailerBundle\DependencyInjection;

use Sylius\MailerBundle\Form\Type\EmailType;
                            ...
                            ->children()
                                ...
                                ->arrayNode('classes')
                                    ...
                                    ->children()
                                        ...
                                        ->scalarNode('interface')->defaultValue(EmailInterface::class)->cannotBeEmpty()->end()
                                        ...
                                        ->arrayNode('form')
                                            ->addDefaultsIfNotSet()
                                            ->children()
                                                ->scalarNode('default')->defaultValue(EmailType::class)->cannotBeEmpty()->end()
