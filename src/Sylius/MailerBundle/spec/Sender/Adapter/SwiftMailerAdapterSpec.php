...
namespace spec\Sylius\MailerBundle\Sender\Adapter;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\Mailer\Event\EmailSendEvent;
use Sylius\Mailer\Model\EmailInterface;
use Sylius\Mailer\Renderer\RenderedEmail;
use Sylius\Mailer\Sender\Adapter\AbstractAdapter;
...
class SwiftMailerAdapterSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\MailerBundle\Sender\Adapter\SwiftMailerAdapter');
    }
