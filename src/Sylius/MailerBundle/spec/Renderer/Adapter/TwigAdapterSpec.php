...
namespace spec\Sylius\MailerBundle\Renderer\Adapter;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\Mailer\Event\EmailRenderEvent;
use Sylius\Mailer\Model\EmailInterface;
use Sylius\Mailer\Renderer\Adapter\AbstractAdapter;
use Sylius\Mailer\Renderer\RenderedEmail;
use Sylius\Mailer\SyliusMailerEvents;
...
class TwigAdapterSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\MailerBundle\Renderer\Adapter\TwigAdapter');
    }
