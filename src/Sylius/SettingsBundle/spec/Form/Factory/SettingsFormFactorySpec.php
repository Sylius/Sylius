...
namespace spec\Sylius\SettingsBundle\Form\Factory;

use PhpSpec\ObjectBehavior;
use Sylius\SettingsBundle\Form\Factory\SettingsFormFactoryInterface;
...
class SettingsFormFactorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\SettingsBundle\Form\Factory\SettingsFormFactory');
    }
