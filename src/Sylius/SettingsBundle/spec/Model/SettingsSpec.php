...
namespace spec\Sylius\SettingsBundle\Model;

use PhpSpec\ObjectBehavior;
use Sylius\SettingsBundle\Exception\ParameterNotFoundException;
...
class SettingsSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\SettingsBundle\Model\Settings');
    }
