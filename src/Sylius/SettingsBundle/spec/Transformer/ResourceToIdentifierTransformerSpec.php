...
namespace spec\Sylius\SettingsBundle\Transformer;

use PhpSpec\ObjectBehavior;
use Sylius\SettingsBundle\spec\Fixture\ParameterFixture;
use Sylius\SettingsBundle\Transformer\ParameterTransformerInterface;
...
class ResourceToIdentifierTransformerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\SettingsBundle\Transformer\ResourceToIdentifierTransformer');
    }
