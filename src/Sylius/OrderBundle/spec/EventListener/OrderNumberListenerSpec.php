...
namespace spec\Sylius\OrderBundle\EventListener;

use PhpSpec\ObjectBehavior;
use Sylius\SequenceBundle\Doctrine\ORM\NumberListener;
...
class OrderNumberListenerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\OrderBundle\EventListener\OrderNumberListener');
    }
