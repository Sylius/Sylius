...
namespace spec\Sylius\OrderBundle\Templating\Helper;

use PhpSpec\ObjectBehavior;
use Sylius\Order\Aggregator\AdjustmentsAggregatorInterface;
...
class AdjustmentsHelperSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\OrderBundle\Templating\Helper\AdjustmentsHelper');
    }
