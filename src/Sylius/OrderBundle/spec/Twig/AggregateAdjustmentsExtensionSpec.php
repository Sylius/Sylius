...
namespace spec\Sylius\OrderBundle\Twig;

use PhpSpec\Exception\Example\FailureException;
use PhpSpec\ObjectBehavior;
use Sylius\OrderBundle\Templating\Helper\AdjustmentsHelper;
...
class AggregateAdjustmentsExtensionSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\OrderBundle\Twig\AggregateAdjustmentsExtension');
    }
