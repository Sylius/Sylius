...
namespace spec\Sylius\InstallerBundle\Requirement;

use PhpSpec\ObjectBehavior;
use Sylius\InstallerBundle\Requirement\RequirementCollection;
use Sylius\InstallerBundle\Requirement\SyliusRequirements;
