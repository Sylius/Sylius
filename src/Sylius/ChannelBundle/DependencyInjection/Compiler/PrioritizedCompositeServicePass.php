...
namespace Sylius\ChannelBundle\DependencyInjection\Compiler;
...
abstract class PrioritizedCompositeServicePass implements CompilerPassInterface
{
     ...
     * @param array $tags
     */
    private function addMethodCalls($channelContextDefinition, $id, $tags)
    {
     ...
     */
    private function addMethodCall($channelContextDefinition, $id, $attributes)
    {
