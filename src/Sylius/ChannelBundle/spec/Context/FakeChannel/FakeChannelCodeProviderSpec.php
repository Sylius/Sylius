...
namespace spec\Sylius\ChannelBundle\Context\FakeChannel;

use PhpSpec\ObjectBehavior;
use Sylius\ChannelBundle\Context\FakeChannel\FakeChannelCodeProvider;
use Sylius\ChannelBundle\Context\FakeChannel\FakeChannelCodeProviderInterface;
...
class FakeChannelCodeProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ChannelBundle\Context\FakeChannel\FakeChannelCodeProvider');
    }
