...
namespace spec\Sylius\ChannelBundle\DependencyInjection\Compiler;

use PhpSpec\ObjectBehavior;
use Sylius\Channel\Factory\ChannelFactory;
...
class RegisterChannelFactoryPassSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ChannelBundle\DependencyInjection\Compiler\RegisterChannelFactoryPass');
    }
