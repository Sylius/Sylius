...
namespace Sylius\CoreBundle\Behat;

use Behat\Gherkin\Node\TableNode;
use Behat\Mink\Element\ElementInterface;
use Behat\Mink\Element\NodeElement;
use Sylius\ResourceBundle\Behat\DefaultContext;
use Sylius\Core\Model\ProductInterface;
use Sylius\Metadata\Model\Custom\PageMetadata;
use Sylius\Metadata\Model\Custom\PageMetadataInterface;
use Sylius\Metadata\Model\MetadataContainerInterface;
use Sylius\Metadata\Model\Twitter\AppCard;
use Sylius\Metadata\Model\Twitter\CardInterface;
use Sylius\Metadata\Model\Twitter\PlayerCard;
use Sylius\Metadata\Model\Twitter\SummaryCard;
use Sylius\Metadata\Model\Twitter\SummaryLargeImageCard;
