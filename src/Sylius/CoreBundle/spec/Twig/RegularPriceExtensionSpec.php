...
namespace spec\Sylius\CoreBundle\Twig;

use PhpSpec\ObjectBehavior;
use Sylius\CoreBundle\Templating\Helper\RegularPriceHelper;
...
class RegularPriceExtensionSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\Twig\RegularPriceExtension');
    }
