...
namespace spec\Sylius\CoreBundle\Test\Factory;

use PhpSpec\ObjectBehavior;
use Sylius\Core\Model\CustomerInterface;
use Sylius\Core\Model\UserInterface;
use Sylius\Core\Test\Factory\TestUserFactoryInterface;
...
class TestUserFactorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\Test\Factory\TestUserFactory');
    }
