...
namespace spec\Sylius\CoreBundle\Fixture;

use Doctrine\Common\Persistence\ObjectManager;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\AddressingBundle\Factory\ZoneFactoryInterface;
use Sylius\CoreBundle\Fixture\GeographicalFixture;
...
final class GeographicalFixtureSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\Fixture\GeographicalFixture');
    }
