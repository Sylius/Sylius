...
namespace spec\Sylius\CoreBundle\Purger;

use Doctrine\DBAL\Logging\SQLLogger;
use PhpSpec\ObjectBehavior;
use Sylius\CoreBundle\Purger\QueryLoggerInterface;

/**
 * @mixin \Sylius\CoreBundle\Purger\QueryLogger
 *
...
class QueryLoggerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\Purger\QueryLogger');
    }
