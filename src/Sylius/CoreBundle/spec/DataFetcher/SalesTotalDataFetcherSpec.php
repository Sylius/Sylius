...
namespace spec\Sylius\CoreBundle\DataFetcher;
...
class SalesTotalDataFetcherSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\DataFetcher\SalesTotalDataFetcher');
    }
    ...
    {
        $rawData = [['date' => '2014-12-31', 'total_sale' => '20'], ['date' => '2015-01-01', 'total_sale' => '2']];
    ...
    {
        $rawData = [['date' => '2014-12-30', 'total_sale' => '20'], ['date' => '2015-01-01', 'total_sale' => '2']];
    ...
    {
        $rawData = [['date' => '2014-01-01', 'total_sale' => '20'], ['date' => '2015-01-30', 'total_sale' => '2']];
    ...
    public function it_does_not_allowed_wrong_data_period()
    {
        $configuration = [
