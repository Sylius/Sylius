...
namespace spec\Sylius\CoreBundle\Context;

use Doctrine\Common\Persistence\ObjectManager;
use PhpSpec\ObjectBehavior;
use Sylius\CoreBundle\Context\CurrencyContext;
...
use Sylius\Currency\Context\CurrencyContext as SyliusCurrencyContext;
...
class CurrencyContextSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\Context\CurrencyContext');
    }
