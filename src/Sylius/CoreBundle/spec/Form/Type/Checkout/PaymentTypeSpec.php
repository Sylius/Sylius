...
use Sylius\CoreBundle\Form\EventSubscriber\AddPaymentMethodsFormSubscriber;
use Sylius\Core\Model\Payment;
...
class PaymentTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\Form\Type\Checkout\PaymentType');
    }
