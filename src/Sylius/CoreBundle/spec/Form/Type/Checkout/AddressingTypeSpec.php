...
namespace spec\Sylius\CoreBundle\Form\Type\Checkout;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\CoreBundle\Form\EventSubscriber\AddDefaultBillingAddressOnOrderFormSubscriber;
use Sylius\CoreBundle\Form\Type\Checkout\AddressingType;
use Sylius\UserBundle\Form\EventSubscriber\AddCustomerGuestTypeFormSubscriber;
...
class AddressingTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\Form\Type\Checkout\AddressingType');
    }
