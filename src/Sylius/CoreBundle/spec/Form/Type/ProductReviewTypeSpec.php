...
use Sylius\CoreBundle\Form\EventSubscriber\AddAuthorGuestTypeFormSubscriber;
use Sylius\CoreBundle\Form\Type\ProductReviewType;
use Sylius\ResourceBundle\Form\Type\AbstractResourceType;
use Sylius\ReviewBundle\Form\Type\ReviewType;
...
class ProductReviewTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\Form\Type\ProductReviewType');
    }
