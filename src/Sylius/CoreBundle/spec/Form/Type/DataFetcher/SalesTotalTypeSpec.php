...
namespace spec\Sylius\CoreBundle\Form\Type\DataFetcher;
...
class SalesTotalTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\Form\Type\DataFetcher\SalesTotalType');
    }
    ...
    {
        $this->getName()->shouldReturn('sylius_data_fetcher_sales_total');
    }
