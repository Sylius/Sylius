...
use Sylius\ShippingBundle\Form\EventListener\BuildShippingMethodFormSubscriber;
use Sylius\ShippingBundle\Form\Type\ShippingMethodType;
...
class ShippingMethodTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\Form\Type\ShippingMethodType');
    }
