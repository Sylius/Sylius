...
namespace spec\Sylius\CoreBundle\Form\EventSubscriber;
...
class AddDefaultBillingAddressOnOrderFormSubscriberSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\Form\EventSubscriber\AddDefaultBillingAddressOnOrderFormSubscriber');
    }
