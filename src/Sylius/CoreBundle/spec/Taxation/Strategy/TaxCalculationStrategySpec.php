...
namespace spec\Sylius\CoreBundle\Taxation\Strategy;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\CoreBundle\Taxation\Strategy\TaxCalculationStrategy;
...
class TaxCalculationStrategySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\Taxation\Strategy\TaxCalculationStrategy');
    }
