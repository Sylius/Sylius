...
namespace spec\Sylius\CoreBundle\Sitemap\Model;
 
use PhpSpec\ObjectBehavior;
use Sylius\CoreBundle\Sitemap\Exception\SitemapUrlNotFoundException;
...
class SitemapSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CoreBundle\Sitemap\Model\Sitemap');
    }
