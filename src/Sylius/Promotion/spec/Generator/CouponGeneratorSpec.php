...
namespace spec\Sylius\Promotion\Generator;

use Doctrine\Common\Persistence\ObjectManager;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\Promotion\Exception\FailedGenerationException;
use Sylius\Promotion\Generator\CouponGeneratorInterface;
...
class CouponGeneratorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Promotion\Generator\CouponGenerator');
    }
