Mailer Component [![Build status...](https://secure.travis-ci.org/Sylius/Mailer.png?branch=master)](http://travis-ci.org/Sylius/Mailer)
================
...
Documentation is available on [**docs.sylius.org**](http://docs.sylius.org/en/latest/components/Mailer/index.html).
...
License can be found [here](https://github.com/Sylius/Mailer/blob/master/LICENSE).
