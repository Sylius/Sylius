...
namespace spec\Sylius\Mailer\Sender;

use PhpSpec\ObjectBehavior;
use Sylius\Mailer\Model\EmailInterface;
use Sylius\Mailer\Provider\DefaultSettingsProviderInterface;
use Sylius\Mailer\Provider\EmailProvider;
use Sylius\Mailer\Provider\EmailProviderInterface;
use Sylius\Mailer\Renderer\Adapter\AdapterInterface as RendererAdapterInterface;
use Sylius\Mailer\Renderer\RenderedEmail;
use Sylius\Mailer\Sender\Adapter\AdapterInterface as SenderAdapterInterface;
...
class SenderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Mailer\Sender\Sender');
    }
