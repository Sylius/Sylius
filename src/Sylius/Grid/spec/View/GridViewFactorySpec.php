...
namespace spec\Sylius\Grid\View;
...
use Sylius\Grid\View\GridViewFactory;
use Sylius\Grid\View\GridViewFactoryInterface;
...
class GridViewFactorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Grid\View\GridViewFactory');
    }
