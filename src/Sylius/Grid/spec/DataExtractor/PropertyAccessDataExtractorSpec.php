...
namespace spec\Sylius\Grid\DataExtractor;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\Grid\DataExtractor\DataExtractorInterface;
use Sylius\Grid\DataExtractor\PropertyAccessDataExtractor;
...
class PropertyAccessDataExtractorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Grid\DataExtractor\PropertyAccessDataExtractor');
    }
