...
namespace spec\Sylius\Grid\Data;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\Grid\Data\DataSourceProvider;
use Sylius\Grid\Data\DataSourceProviderInterface;
use Sylius\Grid\Data\DriverInterface;
use Sylius\Grid\Data\UnsupportedDriverException;
...
class DataSourceProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Grid\Data\DataSourceProvider');
    }
