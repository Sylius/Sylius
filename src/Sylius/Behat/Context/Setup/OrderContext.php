...
final class OrderContext implements Context
{
    ...
    {
        $this->addProductVariantToOrder($product->getFirstVariant(), $product->getFirstVariant()->getPrice(), 1);
    ...
    {
        $this->addProductVariantToOrder($product->getFirstVariant(), $product->getFirstVariant()->getPrice(), $quantity);
    ...
    {
        $order = $this->addProductVariantToOrder($product->getFirstVariant(), $product->getFirstVariant()->getPrice());
