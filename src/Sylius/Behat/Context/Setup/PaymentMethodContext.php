...
final class PaymentMethodContext implements Context
{
     ...
     */
    public function theStoreHasAPaymentMethodDisabled($paymentMethodName)
    {
        $paymentMethod = $this->createPaymentMethodFromNameAndCode($paymentMethodName);
     ...
     */
    private function createPaymentMethodFromNameAndCode($name, $code = 'PM')
    {
