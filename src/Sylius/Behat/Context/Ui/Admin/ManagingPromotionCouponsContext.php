...
final class ManagingPromotionCouponsContext implements Context
{
     ...
     */
    public function iWantToGenerateANewCouponsForThisPromotion(PromotionInterface $promotion): void
    {
     ...
     */
    public function iSpecifyItsCodeLengthAs($codeLength = null): void
    {
     ...
     */
    public function iSetGeneratedCouponsUsageLimitTo($limit): void
    {
     ...
     */
    public function iLimitItsUsageLimitTo($limit): void
    {
     ...
     */
    public function iLimitItsPerCustomerUsageLimitTo($limit): void
    {
     ...
     */
    public function iChangeItsPerCustomerUsageLimitTo($limit): void
    {
     ...
     */
    public function thereShouldBeCouponRelatedTo($number, PromotionInterface $promotion): void
    {
        $this->indexPage->open(['promotionId' => $promotion->getId()]);
     ...
     */
    public function iShouldBeNotifiedThatGeneratingCouponsWithCodeLengthIsNotPossible($amount, $codeLength): void
    {
