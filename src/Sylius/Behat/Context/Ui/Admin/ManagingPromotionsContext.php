...
final class ManagingPromotionsContext implements Context
{
     ...
     */
    public function iAddTheRuleConfiguredWith($taxonName, $amount, $channelName): void
    {
     ...
     */
    public function iAddTheActionConfiguredWithAmountForChannel($actionType, $amount, $channelName): void
    {
     ...
     */
    public function itIsConfiguredWithAmountForChannel($amount, $channelName): void
    {
        $this->createPage->fillActionOptionForChannel($channelName, 'Amount', $amount);
    }
     ...
     */
    public function iAddAMinPriceFilterRangeForChannel($channelName, $minimum): void
    {
     ...
     */
    public function iAddAMaxPriceFilterRangeForChannel($channelName, $maximum): void
    {
     ...
     */
    public function iAddAMinMaxPriceFilterRangeForChannel($channelName, $minimum, $maximum): void
    {
     ...
     */
    public function iAddTheActionConfiguredWithAPercentageValueForChannel($actionType, $percentage = null, $channelName): void
    {
        $this->createPage->addAction($actionType);
     ...
     */
    public function iShouldBeNotifiedThatTheMaximumValueOfAPercentageDiscountIs100(): void
    {
        Assert::same(
            $this->createPage->getValidationMessageForAction(),
     ...
     */
    public function iShouldBeNotifiedThatAPercentageDiscountValueMustBeAtLeast0(): void
    {
        Assert::same(
            $this->createPage->getValidationMessageForAction(),
     ...
     */
    public function thePromotionsShouldHavePriority(PromotionInterface $promotion, $priority): void
    {
        $this->iWantToModifyAPromotion($promotion);
