...
use Sylius\Behat\Page\Admin\Product\ConfigurableProduct\CreateConfigurableProductPageInterface;
use Sylius\Behat\Page\Admin\Product\ConfigurableProduct\UpdateConfigurableProductPageInterface;
use Sylius\Behat\Page\Admin\Product\IndexPageInterface;
use Sylius\Behat\Page\Admin\Product\IndexPerTaxonPageInterface;
use Sylius\Behat\Page\Admin\Product\SimpleProduct\CreateSimpleProductPageInterface;
...
final readonly class ManagingProductsContext implements Context
{
     ...
     */
    public function thisProductElementShouldBe(string $name): void
    {
    ...
    {
        Assert::same($this->updateSimpleProductPage->getNumberOfAttributes(), $count);
    }
    ...
    public function thereShouldStillBeOnlyOneImageInThisProduct(ProductInterface $product, int $count = 1): void
    {
        ...
        Assert::same($currentPage->countImages(), $count);
    }
    ...
    private function resolveCurrentPage(): CreateConfigurableProductPageInterface|CreateSimpleProductPageInterface|IndexPerTaxonPageInterface|IndexPageInterface|UpdateConfigurableProductPageInterface|UpdateSimpleProductPageInterface
    {
