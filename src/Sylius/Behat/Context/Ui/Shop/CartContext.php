...
final readonly class CartContext implements Context
{
    ...
    /**
     * @Givenhe added product :product to the cart
     * @WhenI add product :product to the cart
     * @WhenI add the product :product to the cart
     * @Whenthey add product :product to the cart
     */
