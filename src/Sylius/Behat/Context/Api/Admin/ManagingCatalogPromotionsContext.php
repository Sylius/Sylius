...
{
    private const RESOURCE = 'catalog-promotions';
    ...
    {
        $channels = $this->responseChecker->getValue($this->client->show(self::RESOURCE, $catalogPromotion->getCode()), 'channels');
    ...
    {
        $this->client->buildUpdateRequest(self::RESOURCE, $catalogPromotion->getCode());
    ...
    public function iMakeThisCatalogPromotionUnavailableInTheChannel(
        ...
        $this->client->buildUpdateRequest(self::RESOURCE, $catalogPromotionCode);
        $content = $this->client->getContent();
    ...
    {
        $this->client->show(self::RESOURCE, $catalogPromotion->getCode());
    ...
    {
        Assert::count($this->responseChecker->getCollection($this->client->index(self::RESOURCE)), $amount);
    }
    ...
    {
        Assert::true(
            $this->responseChecker->hasItemWithValues($this->client->index(self::RESOURCE), ['code' => $code, 'name' => $name]),
    ...
    {
        Assert::true(
            $this->responseChecker->hasItemWithValues($this->client->index(self::RESOURCE), ['priority' => $priority]),
    ...
    {
        $response = $this->client->show(self::RESOURCE, $catalogPromotion->getCode());
