...
namespace spec\Sylius\CartBundle\Purger;

use Doctrine\Common\Persistence\ObjectManager;
use PhpSpec\ObjectBehavior;
use Sylius\Cart\Model\CartInterface;
use Sylius\Cart\Repository\CartRepositoryInterface;
...
class ExpiredCartsPurgerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\CartBundle\Purger\ExpiredCartsPurger');
    }
