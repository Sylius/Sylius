...
namespace spec\Sylius\ShopBundle\Controller;

use PhpSpec\ObjectBehavior;
use Sylius\ShopBundle\Controller\HomepageController;
...
class HomepageControllerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ShopBundle\Controller\HomepageController');
    }
