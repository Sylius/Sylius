...
use Sylius\FixturesBundle\Fixture\FixtureRegistryInterface;
use Sylius\FixturesBundle\Listener\ListenerInterface;
use Sylius\FixturesBundle\Listener\ListenerRegistryInterface;
use Sylius\FixturesBundle\Suite\SuiteFactory;
use Sylius\FixturesBundle\Suite\SuiteFactoryInterface;
...
final class SuiteFactorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\FixturesBundle\Suite\SuiteFactory');
    }
