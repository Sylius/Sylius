...
use Sylius\FixturesBundle\Suite\LazySuiteRegistry;
...
use Sylius\FixturesBundle\Suite\SuiteRegistryInterface;
...
final class LazySuiteRegistrySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\FixturesBundle\Suite\LazySuiteRegistry');
    }
