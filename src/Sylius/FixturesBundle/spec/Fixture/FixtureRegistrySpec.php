...
namespace spec\Sylius\FixturesBundle\Fixture;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\FixturesBundle\Fixture\FixtureInterface;
use Sylius\FixturesBundle\Fixture\FixtureNotFoundException;
use Sylius\FixturesBundle\Fixture\FixtureRegistry;
...
final class FixtureRegistrySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\FixturesBundle\Fixture\FixtureRegistry');
    }
