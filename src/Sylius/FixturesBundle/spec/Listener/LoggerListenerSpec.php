...
use Sylius\FixturesBundle\Listener\BeforeFixtureListenerInterface;
use Sylius\FixturesBundle\Listener\BeforeSuiteListenerInterface;
use Sylius\FixturesBundle\Listener\FixtureEvent;
use Sylius\FixturesBundle\Listener\ListenerInterface;
use Sylius\FixturesBundle\Listener\LoggerListener;
...
final class LoggerListenerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\FixturesBundle\Listener\LoggerListener');
    }
