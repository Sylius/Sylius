...
namespace spec\Sylius\FixturesBundle\Listener;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\FixturesBundle\Listener\ListenerInterface;
use Sylius\FixturesBundle\Listener\ListenerNotFoundException;
use Sylius\FixturesBundle\Listener\ListenerRegistry;
use Sylius\FixturesBundle\Listener\ListenerRegistryInterface;
...
final class ListenerRegistrySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\FixturesBundle\Listener\ListenerRegistry');
    }
