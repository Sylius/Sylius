...
use Sylius\FixturesBundle\Listener\AfterFixtureListenerInterface;
...
use Sylius\FixturesBundle\Loader\HookableFixtureLoader;
...
final class HookableFixtureLoaderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\FixturesBundle\Loader\HookableFixtureLoader');
    }
