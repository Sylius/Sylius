...
use Sylius\FixturesBundle\Listener\AfterSuiteListenerInterface;
use Sylius\FixturesBundle\Listener\BeforeSuiteListenerInterface;
use Sylius\FixturesBundle\Listener\SuiteEvent;
use Sylius\FixturesBundle\Loader\HookableSuiteLoader;
use Sylius\FixturesBundle\Loader\SuiteLoaderInterface;
...
final class HookableSuiteLoaderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\FixturesBundle\Loader\HookableSuiteLoader');
    }
