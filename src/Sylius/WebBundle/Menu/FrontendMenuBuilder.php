...
namespace Sylius\WebBundle\Menu;

use Knp\Menu\FactoryInterface;
use Knp\Menu\ItemInterface;
use Sylius\CurrencyBundle\Templating\Helper\CurrencyHelperInterface;
use Sylius\WebBundle\Event\MenuBuilderEvent;
use Sylius\Cart\Provider\CartProviderInterface;
use Sylius\Channel\Context\ChannelContextInterface;
use Sylius\Currency\Provider\CurrencyProviderInterface;
use Sylius\Rbac\Authorization\AuthorizationCheckerInterface as RbacAuthorizationCheckerInterface;
use Sylius\Taxonomy\Model\TaxonInterface;
use Sylius\Taxonomy\Repository\TaxonRepositoryInterface;
