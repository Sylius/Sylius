...
namespace spec\Sylius\GridBundle\FieldTypes;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\GridBundle\FieldTypes\TwigFieldType;
...
class TwigFieldTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\GridBundle\FieldTypes\TwigFieldType');
    }
