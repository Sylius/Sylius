...
namespace spec\Sylius\GridBundle\Renderer;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\GridBundle\Renderer\TwigGridRenderer;
use Sylius\Grid\Definition\Action;
use Sylius\Grid\Definition\Field;
use Sylius\Grid\FieldTypes\FieldTypeInterface;
use Sylius\Grid\Filter\StringFilter;
use Sylius\Grid\Renderer\GridRendererInterface;
...
class TwigGridRendererSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\GridBundle\Renderer\TwigGridRenderer');
    }
