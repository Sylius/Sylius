...
namespace spec\Sylius\GridBundle\Doctrine\PHPCRODM;
...
use Sylius\GridBundle\Doctrine\PHPCRODM\DataSource;
...
class DriverSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\GridBundle\Doctrine\PHPCRODM\Driver');
    }
