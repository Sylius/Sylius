...
namespace spec\Sylius\GridBundle\Doctrine\ORM;
...
use Sylius\GridBundle\Doctrine\ORM\DataSource;
use Sylius\GridBundle\Doctrine\ORM\Driver;
...
class DriverSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\GridBundle\Doctrine\ORM\Driver');
    }
