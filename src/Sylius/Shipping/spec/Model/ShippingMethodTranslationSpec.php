...
namespace spec\Sylius\Shipping\Model;

use PhpSpec\ObjectBehavior;
use Sylius\Shipping\Model\ShippingMethodTranslationInterface;
...
class ShippingMethodTranslationSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Shipping\Model\ShippingMethodTranslation');
    }
