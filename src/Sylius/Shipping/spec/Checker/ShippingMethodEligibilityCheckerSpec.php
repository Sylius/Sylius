...
namespace spec\Sylius\Shipping\Checker;

use PhpSpec\ObjectBehavior;
use Sylius\Registry\ServiceRegistryInterface;
use Sylius\Shipping\Checker\RuleCheckerInterface;
use Sylius\Shipping\Checker\ShippingMethodEligibilityCheckerInterface;
...
class ShippingMethodEligibilityCheckerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Shipping\Checker\ShippingMethodEligibilityChecker');
    }
