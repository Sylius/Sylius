...
use Sylius\SearchBundle\Doctrine\ORM\SearchIndexRepository;
use Sylius\SearchBundle\Model\SearchIndex;
...
use Sylius\SearchBundle\QueryLogger\QueryLoggerInterface;
...
class OrmFinder extends AbstractFinder
{
    ...
    {
        $query = $em->createQuery('SELECT u.itemId, u.tags, u.entity FROM Sylius\SearchBundle\Model\SearchIndex u WHERE MATCH(u.value) AGAINST (:searchTerm BOOLEAN) > 0');
