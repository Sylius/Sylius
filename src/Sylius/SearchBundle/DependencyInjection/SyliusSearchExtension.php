...
use Sylius\SearchBundle\DependencyInjection\Configuration as SyliusSearchConfiguration;
use Sylius\SearchBundle\Extension\Doctrine\MatchAgainstFunction;
use Sylius\SearchBundle\Listener\ElasticaProductListener;
