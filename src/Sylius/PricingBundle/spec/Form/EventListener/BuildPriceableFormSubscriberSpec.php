...
namespace spec\Sylius\PricingBundle\Form\EventListener;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\Pricing\Calculator\CalculatorInterface;
use Sylius\Pricing\Calculator\Calculators;
...
class BuildPriceableFormSubscriberSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\PricingBundle\Form\EventListener\BuildPriceableFormSubscriber');
    }
