...
namespace spec\Sylius\MoneyBundle\Templating\Helper;

use PhpSpec\ObjectBehavior;
use Sylius\MoneyBundle\Formatter\MoneyFormatterInterface;
use Sylius\MoneyBundle\Templating\Helper\MoneyHelper;
...
class MoneyHelperSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\MoneyBundle\Templating\Helper\MoneyHelper');
    }
