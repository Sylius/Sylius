...
namespace spec\Sylius\MoneyBundle\Formatter;

use PhpSpec\ObjectBehavior;
use Sylius\MoneyBundle\Formatter\MoneyFormatter;
...
class MoneyFormatterSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\MoneyBundle\Formatter\MoneyFormatter');
    }
