...
namespace spec\Sylius\TaxationBundle\DependencyInjection\Compiler;
...
class RegisterCalculatorsPassSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\TaxationBundle\DependencyInjection\Compiler\RegisterCalculatorsPass');
    }
