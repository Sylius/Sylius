...
namespace spec\Sylius\ContentBundle\Doctrine\ODM\PHPCR;
...
use Sylius\ResourceBundle\Doctrine\ODM\PHPCR\DocumentRepository;
...
class StaticContentRepositorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ContentBundle\Doctrine\ODM\PHPCR\StaticContentRepository');
    }
