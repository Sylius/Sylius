...
namespace Sylius\AttributeBundle;

use Sylius\AttributeBundle\DependencyInjection\Compiler\RegisterAttributeFactoryPass;
use Sylius\AttributeBundle\DependencyInjection\Compiler\RegisterAttributeTypePass;
