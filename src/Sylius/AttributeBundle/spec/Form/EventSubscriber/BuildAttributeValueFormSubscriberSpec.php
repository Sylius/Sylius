...
namespace spec\Sylius\AttributeBundle\Form\EventSubscriber;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\AttributeBundle\Form\EventSubscriber\BuildAttributeValueFormSubscriber;
use Sylius\Attribute\AttributeType\CheckboxAttributeType;
use Sylius\Attribute\AttributeType\DateAttributeType;
...
class BuildAttributeValueFormSubscriberSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\AttributeBundle\Form\EventSubscriber\BuildAttributeValueFormSubscriber');
    }
