...
namespace spec\Sylius\AttributeBundle\Form\Type;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\AttributeBundle\Form\EventSubscriber\BuildAttributeFormSubscriber;
...
class AttributeTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\AttributeBundle\Form\Type\AttributeType');
    }
