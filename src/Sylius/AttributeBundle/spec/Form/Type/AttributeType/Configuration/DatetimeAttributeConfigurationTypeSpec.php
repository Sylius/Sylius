...
namespace spec\Sylius\AttributeBundle\Form\Type\AttributeType;
...
class DatetimeAttributeConfigurationTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\AttributeBundle\Form\Type\AttributeType\Configuration\DatetimeAttributeConfigurationType');
    }
