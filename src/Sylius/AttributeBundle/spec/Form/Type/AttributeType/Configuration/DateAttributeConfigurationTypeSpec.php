...
namespace spec\Sylius\AttributeBundle\Form\Type\Configuration\AttributeType;
...
class DateAttributeConfigurationTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\AttributeBundle\Form\Type\AttributeType\Configuration\DateAttributeConfigurationType');
    }
