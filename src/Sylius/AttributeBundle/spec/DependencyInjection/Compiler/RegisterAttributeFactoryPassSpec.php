...
namespace spec\Sylius\AttributeBundle\DependencyInjection\Compiler;
...
class RegisterAttributeFactoryPassSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\AttributeBundle\DependencyInjection\Compiler\RegisterAttributeFactoryPass');
    }
