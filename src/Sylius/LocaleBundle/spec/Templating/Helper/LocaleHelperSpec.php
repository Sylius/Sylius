...
namespace spec\Sylius\LocaleBundle\Templating\Helper;

use PhpSpec\ObjectBehavior;
use Sylius\LocaleBundle\Templating\Helper\LocaleHelper;
use Sylius\LocaleBundle\Templating\Helper\LocaleHelperInterface;
...
class LocaleHelperSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\LocaleBundle\Templating\Helper\LocaleHelper');
    }
