...
use Sylius\ThemeBundle\Locator\ResourceLocator;
 ...
 */
class ResourceLocatorSpec extends ObjectBehavior
{
    function let(
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Locator\ResourceLocator');
    }
