...
namespace spec\Sylius\ThemeBundle\Asset\Package;

use PhpSpec\ObjectBehavior;
use Sylius\ThemeBundle\Asset\Package\PathPackage;
use Sylius\ThemeBundle\Asset\PathResolverInterface;
...
class PathPackageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Asset\Package\PathPackage');
    }
