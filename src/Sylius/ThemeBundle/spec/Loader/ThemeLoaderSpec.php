...
namespace spec\Sylius\ThemeBundle\Loader;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\ThemeBundle\Configuration\ConfigurationProviderInterface;
use Sylius\ThemeBundle\Factory\ThemeAuthorFactoryInterface;
use Sylius\ThemeBundle\Factory\ThemeFactoryInterface;
use Sylius\ThemeBundle\Factory\ThemeScreenshotFactoryInterface;
use Sylius\ThemeBundle\Loader\CircularDependencyCheckerInterface;
use Sylius\ThemeBundle\Loader\CircularDependencyFoundException;
use Sylius\ThemeBundle\Loader\ThemeLoader;
use Sylius\ThemeBundle\Loader\ThemeLoaderInterface;
use Sylius\ThemeBundle\Loader\ThemeLoadingFailedException;
use Sylius\ThemeBundle\Model\ThemeAuthor;
...
class ThemeLoaderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Loader\ThemeLoader');
    }
