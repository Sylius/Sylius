...
namespace spec\Sylius\ThemeBundle\Controller;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\ThemeBundle\Controller\ThemeScreenshotController;
...
final class ThemeScreenshotControllerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Controller\ThemeScreenshotController');
    }
