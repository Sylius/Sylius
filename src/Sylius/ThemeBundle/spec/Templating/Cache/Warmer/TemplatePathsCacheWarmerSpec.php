...
namespace spec\Sylius\ThemeBundle\Templating\Cache\Warmer;
...
use Sylius\ThemeBundle\Templating\Cache\Warmer\TemplatePathsCacheWarmer;
use Sylius\ThemeBundle\Templating\Locator\TemplateLocatorInterface;
...
class TemplatePathsCacheWarmerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Templating\Cache\Warmer\TemplatePathsCacheWarmer');
    }
