...
namespace spec\Sylius\ThemeBundle\Templating\Cache\Clearer;

use Doctrine\Common\Cache\Cache;
use Doctrine\Common\Cache\ClearableCache;
use PhpSpec\ObjectBehavior;
use Sylius\ThemeBundle\Templating\Cache\Clearer\TemplatePathsCacheClearer;
...
class TemplatePathsCacheClearerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Templating\Cache\Clearer\TemplatePathsCacheClearer');
    }
