...
namespace spec\Sylius\ThemeBundle\Templating\Locator;
...
use Sylius\ThemeBundle\Templating\Locator\CachedTemplateLocator;
...
class CachedTemplateLocatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Templating\Locator\CachedTemplateLocator');
    }
