...
namespace spec\Sylius\ThemeBundle\Configuration\Test;
...
use Sylius\ThemeBundle\Configuration\ConfigurationProcessorInterface;
use Sylius\ThemeBundle\Configuration\Test\TestThemeConfigurationManager;
...
final class TestThemeConfigurationManagerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Configuration\Test\TestThemeConfigurationManager');
    }
