...
use Sylius\ThemeBundle\Configuration\Test\TestConfigurationProvider;
...
final class TestConfigurationProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Configuration\Test\TestConfigurationProvider');
    }
