...
namespace spec\Sylius\ThemeBundle\Configuration;

use PhpSpec\ObjectBehavior;
use Sylius\ThemeBundle\Configuration\ConfigurationProcessorInterface;
use Sylius\ThemeBundle\Configuration\SymfonyConfigurationProcessor;
...
class SymfonyConfigurationProcessorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Configuration\SymfonyConfigurationProcessor');
    }
