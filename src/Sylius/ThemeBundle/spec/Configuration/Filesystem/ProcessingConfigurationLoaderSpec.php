...
use Sylius\ThemeBundle\Configuration\Filesystem\ProcessingConfigurationLoader;
...
class ProcessingConfigurationLoaderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Configuration\Filesystem\ProcessingConfigurationLoader');
    }
