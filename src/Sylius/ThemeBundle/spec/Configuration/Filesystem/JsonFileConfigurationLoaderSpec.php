...
use Sylius\ThemeBundle\Configuration\Filesystem\JsonFileConfigurationLoader;
use Sylius\ThemeBundle\Filesystem\FilesystemInterface;
...
class JsonFileConfigurationLoaderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Configuration\Filesystem\JsonFileConfigurationLoader');
    }
