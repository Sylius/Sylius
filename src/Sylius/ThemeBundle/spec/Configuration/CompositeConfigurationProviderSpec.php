...
use Sylius\ThemeBundle\Configuration\CompositeConfigurationProvider;
...
final class CompositeConfigurationProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Configuration\CompositeConfigurationProvider');
    }
