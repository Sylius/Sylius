...
namespace spec\Sylius\ThemeBundle\HierarchyProvider;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\ThemeBundle\HierarchyProvider\NoopThemeHierarchyProvider;
...
class NoopThemeHierarchyProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\HierarchyProvider\NoopThemeHierarchyProvider');
    }
