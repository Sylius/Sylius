...
use Sylius\ThemeBundle\Translation\Provider\CompositeTranslatorResourceProvider;
use Sylius\ThemeBundle\Translation\Provider\TranslationResourceInterface;
...
class CompositeTranslatorResourceProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Translation\Provider\CompositeTranslatorResourceProvider');
    }
