...
use Sylius\ThemeBundle\Translation\Provider\TranslationResource;
use Sylius\ThemeBundle\Translation\Provider\TranslatorResourceProvider;
...
class TranslatorResourceProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Translation\Provider\TranslatorResourceProvider');
    }
