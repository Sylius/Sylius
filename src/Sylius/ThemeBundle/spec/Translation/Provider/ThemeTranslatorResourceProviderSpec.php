...
namespace spec\Sylius\ThemeBundle\Translation\Provider;
...
use Sylius\ThemeBundle\Translation\Finder\TranslationFilesFinderInterface;
use Sylius\ThemeBundle\Translation\Provider\ThemeTranslationResource;
use Sylius\ThemeBundle\Translation\Provider\ThemeTranslatorResourceProvider;
use Sylius\ThemeBundle\Translation\Provider\TranslatorResourceProviderInterface;
...
class ThemeTranslatorResourceProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Translation\Provider\ThemeTranslatorResourceProvider');
    }
