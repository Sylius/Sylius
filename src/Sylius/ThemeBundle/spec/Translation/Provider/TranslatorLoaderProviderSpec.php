...
use Sylius\ThemeBundle\Translation\Provider\TranslatorLoaderProvider;
use Sylius\ThemeBundle\Translation\Provider\TranslatorLoaderProviderInterface;
...
class TranslatorLoaderProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Translation\Provider\TranslatorLoaderProvider');
    }
