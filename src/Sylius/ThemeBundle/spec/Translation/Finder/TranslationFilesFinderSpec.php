...
namespace spec\Sylius\ThemeBundle\Translation\Finder;

use PhpSpec\ObjectBehavior;
use Sylius\ThemeBundle\Factory\FinderFactoryInterface;
use Sylius\ThemeBundle\Translation\Finder\TranslationFilesFinder;
...
class TranslationFilesFinderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Translation\Finder\TranslationFilesFinder');
    }
