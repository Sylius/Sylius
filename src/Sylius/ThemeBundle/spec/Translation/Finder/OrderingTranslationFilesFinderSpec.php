...
use Sylius\ThemeBundle\Translation\Finder\OrderingTranslationFilesFinder;
...
class OrderingTranslationFilesFinderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Translation\Finder\OrderingTranslationFilesFinder');
    }
