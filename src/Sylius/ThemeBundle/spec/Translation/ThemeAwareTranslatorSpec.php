...
class ThemeAwareTranslatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ThemeBundle\Translation\ThemeAwareTranslator');
    }
