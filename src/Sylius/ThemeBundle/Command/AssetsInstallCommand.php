...
namespace Sylius\ThemeBundle\Command;

use Sylius\ThemeBundle\Asset\Installer\AssetsInstallerInterface;
use Sylius\ThemeBundle\Asset\Installer\OutputAwareInterface;
