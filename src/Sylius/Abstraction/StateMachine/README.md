StateMachineAbstraction
=======================

State Machine Abstraction package provides a configurable abstraction for Sylius that allows you to define which adapter 
should be used (Winzou State Machine or Symfony Workflow) per graph.
