...
namespace spec\Sylius\ReportBundle\Form\Type;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\ReportBundle\Form\EventListener\BuildReportDataFetcherFormSubscriber;
use Sylius\ReportBundle\Form\EventListener\BuildReportRendererFormSubscriber;
...
class ReportTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ReportBundle\Form\Type\ReportType');
    }
