...
Documentation is available on [**docs.sylius.org**](http://docs.sylius.org/en/latest/components/Channel/index.html).
...
License can be found [here](https://github.com/Sylius/Channel/blob/master/LICENSE).
