...
namespace spec\Sylius\Channel\Context;

use Pamil\ProphecyCommon\Promise\CompositePromise;
use PhpSpec\ObjectBehavior;
use Sylius\Channel\Context\CachedPerRequestChannelContext;
...
class CachedPerRequestChannelContextSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Channel\Context\CachedPerRequestChannelContext');
    }
