...
namespace spec\Sylius\Channel\Context\RequestBased;

use PhpSpec\ObjectBehavior;
use Sylius\Channel\Context\RequestBased\HostnameBasedRequestResolver;
use Sylius\Channel\Context\RequestBased\RequestResolverInterface;
...
class HostnameBasedRequestResolverSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Channel\Context\RequestBased\HostnameBasedRequestResolver');
    }
