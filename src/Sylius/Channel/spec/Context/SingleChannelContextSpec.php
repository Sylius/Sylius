...
class SingleChannelContextSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Channel\Context\SingleChannel\ChannelContext');
    }
