...
namespace spec\Sylius\VariationBundle\Validator;

use Doctrine\Common\Collections\ArrayCollection;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\VariationBundle\Validator\Constraint\VariantCombination;
use Sylius\Variation\Model\OptionValueInterface;
...
class VariantCombinationValidatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\VariationBundle\Validator\VariantCombinationValidator');
    }
