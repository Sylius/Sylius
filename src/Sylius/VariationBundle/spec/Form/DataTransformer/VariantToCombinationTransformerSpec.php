...
namespace spec\Sylius\VariationBundle\Form\DataTransformer;
...
class VariantToCombinationTransformerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\VariationBundle\Form\DataTransformer\VariantToCombinationTransformer');
    }
