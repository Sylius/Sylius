...
namespace spec\Sylius\VariationBundle\Form\Type;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\VariationBundle\Form\DataTransformer\VariantToCombinationTransformer;
...
class VariantMatchTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\VariationBundle\Form\Type\VariantMatchType');
    }
