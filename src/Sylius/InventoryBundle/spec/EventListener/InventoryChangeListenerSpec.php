...
namespace spec\Sylius\InventoryBundle\EventListener;

use PhpSpec\ObjectBehavior;
use Sylius\InventoryBundle\EventListener\InventoryChangeListenerInterface;
use Sylius\Inventory\Model\StockableInterface;
use Sylius\Inventory\Operator\BackordersHandlerInterface;
...
class InventoryChangeListenerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\InventoryBundle\EventListener\InventoryChangeListener');
    }
