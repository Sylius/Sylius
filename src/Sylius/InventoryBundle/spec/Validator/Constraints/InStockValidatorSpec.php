...
namespace spec\Sylius\InventoryBundle\Validator\Constraints;

use PhpSpec\ObjectBehavior;
use Sylius\InventoryBundle\Validator\Constraints\InStock;
use Sylius\Inventory\Checker\AvailabilityCheckerInterface;
...
class InStockValidatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\InventoryBundle\Validator\Constraints\InStockValidator');
    }
