...
namespace spec\Sylius\User\Model;
...
class CustomerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\User\Model\Customer');
    }
    ...
    {
        $this->shouldImplement('Sylius\User\Model\UserAwareInterface');
    }

    function it_implements_groupable_interface()
    {
        $this->shouldImplement('Sylius\User\Model\GroupableInterface');
    }
