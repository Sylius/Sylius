...
Documentation is available on [**docs.sylius.org**](http://docs.sylius.org/en/latest/components/index.html).
...
License can be found [here](https://github.com/Sylius/Customer/blob/master/LICENSE).
