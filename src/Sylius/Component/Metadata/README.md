Metadata Component [![Build status...](https://secure.travis-ci.org/Sylius/Metadata.png?branch=master)](http://travis-ci.org/Sylius/Metadata)
================
...
Documentation is available on [**docs.sylius.org**](http://docs.sylius.org/en/latest/components/Metadata/index.html).
...
License can be found [here](https://github.com/Sylius/Metadata/blob/master/LICENSE).

Authors
-------

The component was originally created by [Kamil Kokot](http://kamil.kokot.me).
See the list of [contributors](https://github.com/Sylius/Metadata/contributors).
