...
/**
 * @mixin \Sylius\Component\Metadata\Model\Twitter\SummaryCard
 *
...
class SummaryCardSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Component\Metadata\Model\Twitter\SummaryCard');
    }

    function it_implements_Summary_Card_interface()
    {
        $this->shouldImplement('Sylius\Component\Metadata\Model\Twitter\SummaryCardInterface');
    }
