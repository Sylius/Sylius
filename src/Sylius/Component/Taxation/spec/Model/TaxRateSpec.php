...
class TaxRateSpec extends ObjectBehavior
{
    ...
    public function it_should_implement_Sylius_tax_rate_interface()
    {
    ...
    public function it_should_not_belong_to_category_by_default()
    {
        $this->getCategory()->shouldReturn(null);
    }

    public function it_should_allow_assigning_itself_to_category(TaxCategoryInterface $category)
    {
        $this->setCategory($category);
        $this->getCategory()->shouldReturn($category);
    }

    public function it_should_allow_detaching_itself_from_category(TaxCategoryInterface $category)
    {
        $this->setCategory($category);
    ...
    public function it_should_have_amount_equal_to_0_by_default()
    {
    ...
    public function it_should_represent_amount_as_percentage()
    {
        $this->setAmount(0.23);
    ...
    public function it_should_not_be_included_in_price_by_default()
    {
        $this->shouldNotBeIncludedInPrice();
    }

    public function its_inclusion_in_price_should_be_mutable()
    {
        $this->setIncludedInPrice(true);
        $this->shouldBeIncludedInPrice();
    }

    public function it_should_not_have_calculator_defined_by_default()
    {
        $this->getCalculator()->shouldReturn(null);
    }

    public function its_calculator_should_be_mutable()
    {
