...
final class TaxonSpec extends ObjectBehavior
{
    ...
    public function it_implements_taxon_interface(): void
    {
    ...
    public function its_parent_is_mutable(TaxonInterface $taxon): void
    {
        $this->setParent($taxon);
        $this->getParent()->shouldReturn($taxon);
    }

    public function it_is_root_by_default(): void
    {
        $this->shouldBeRoot();
    }

    public function it_is_not_root_when_has_parent(TaxonInterface $taxon): void
    {
        $this->setParent($taxon);
        $this->shouldNotBeRoot();
    }

    public function it_is_root_when_has_no_parent(TaxonInterface $taxon): void
    {
        $this->shouldBeRoot();
    ...
    public function it_returns_a_list_of_ancestors(
    ...
    public function it_returns_a_list_with_single_ancestor(TaxonInterface $parentTaxon): void
    {
    ...
    public function it_returns_an_empty_list_of_ancestors_if_called_on_root_taxon(): void
    {
    ...
    public function its_fullname_is_null_if_unnamed(): void
    {
        $this->getFullname()->shouldReturn(null);
    }

    public function its_fullname_equal_name_if_no_parent(): void
    {
        $this->setName('Category');
        $this->getFullname()->shouldReturn('Category');
    }

    public function its_fullname_prepends_with_parents_fullname(TaxonInterface $root): void
    {
    ...
    public function it_initializes_child_taxon_collection_by_default(): void
    {
        $this->getChildren()->shouldHaveType(Collection::class);
    }

    public function it_allows_to_check_if_given_taxon_is_its_child(TaxonInterface $taxon): void
    {
        $this->hasChild($taxon)->shouldReturn(false);
    }

    public function it_allows_to_add_child_taxons(TaxonInterface $taxon): void
    {
    ...
    public function it_allows_to_remove_child_taxons(TaxonInterface $taxon): void
    {
        $taxon->getParent()->willReturn(null);
        $taxon->setParent($this)->shouldBeCalled();
    ...
    public function it_has_not_children_by_default(): void
    {
        $this->hasChildren()->shouldReturn(false);
    }

    public function it_has_children_when_you_have_added_child(TaxonInterface $taxon): void
    {
        $this->addChild($taxon);
