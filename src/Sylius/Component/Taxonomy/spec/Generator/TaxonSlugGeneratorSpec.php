...
{
    public function it_implements_taxon_slug_generator_interface(): void
    {
        $this->shouldImplement(TaxonSlugGeneratorInterface::class);
    }

    public function it_generates_slug_for_root_taxon(
    ...
    public function it_generates_slug_for_root_taxon_replacing_apostrophes_with_hyphens(
        TaxonInterface $taxon,
        TaxonTranslationInterface $taxonTranslation
    ): void {
        $taxon->getTranslation('pl_PL')->willReturn($taxonTranslation);
    ...
    public function it_generates_slug_for_child_taxon_when_parent_taxon_already_has_slug(
        TaxonInterface $taxon,
        TaxonTranslationInterface $taxonTranslation,
    ...
    public function it_generates_slug_for_child_taxon_even_when_parent_taxon_does_not_have_slug(
        TaxonInterface $taxon,
        TaxonTranslationInterface $taxonTranslation,
        TaxonInterface $parentTaxon,
        TaxonTranslationInterface $parentTaxonTranslation
    ...
    public function it_throws_an_exception_if_passed_taxon_has_no_name(
        TaxonInterface $taxon,
        TaxonTranslationInterface $taxonTranslation
    ): void {
        $taxon->getTranslation('pl_PL')->willReturn($taxonTranslation);
