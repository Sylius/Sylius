...
use Sylius\Component\Product\Model\Variable\OptionValueInterface;
...
class OptionSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Component\Product\Model\Variable\Option');
    }

    function it_implement_Sylius_option_interface()
    {
        $this->shouldImplement('Sylius\Component\Product\Model\Variable\OptionInterface');
    }
