...
{
    public function it_implements_Sylius_product_translation_interface(): void
    {
    ...
    public function it_has_no_meta_keywords_by_default(): void
    {
        $this->getMetaKeywords()->shouldReturn(null);
    }

    public function its_meta_keywords_is_mutable(): void
    {
        $this->setMetaKeywords('foo, bar, baz');
        $this->getMetaKeywords()->shouldReturn('foo, bar, baz');
    }

    public function it_has_no_meta_description_by_default(): void
    {
        $this->getMetaDescription()->shouldReturn(null);
    }

    public function its_meta_description_is_mutable(): void
    {
