...
class UserSpec extends ObjectBehavior
{
    ...
    public function it_has_no_password_requested_at_date_by_default()
    {
        $this->getPasswordRequestedAt()->shouldReturn(null);
    }

    public function its_password_requested_at_date_is_mutable()
    {
        $date = new \DateTime();
    ...
    public function it_should_return_true_if_password_request_is_non_expired()
    {
    ...
    public function it_should_return_false_if_password_request_is_expired()
    {
