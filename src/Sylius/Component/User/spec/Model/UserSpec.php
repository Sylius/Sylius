...
final class UserSpec extends ObjectBehavior
{
    ...
    public function its_not_verified_by_default(): void
    {
        $this->isVerified()->shouldReturn(false);
    }

    public function its_verified_at_date_is_mutable(\DateTime $date): void
    {
    ...
    public function its_verified_when_verified_at_is_not_empty(\DateTime $date): void
    {
        $this->setVerifiedAt($date);
    ...
    public function it_has_no_password_requested_at_date_by_default(): void
    {
        $this->getPasswordRequestedAt()->shouldReturn(null);
    }

    public function its_password_requested_at_date_is_mutable(): void
    {
        $date = new \DateTime();
    ...
    public function it_should_return_true_if_password_request_is_non_expired(): void
    {
    ...
    public function it_should_return_false_if_password_request_is_expired(): void
    {
    ...
    public function it_has_email_and_email_canonical(): void
    {
