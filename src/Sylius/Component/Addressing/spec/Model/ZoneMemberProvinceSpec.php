...
class ZoneMemberProvinceSpec extends ObjectBehavior
{
    ...
    public function its_province_is_mutable(ProvinceInterface $province)
    {
        $this->setProvince($province);
        $this->getProvince()->shouldReturn($province);
    }

    public function it_returns_province_name(ProvinceInterface $province)
    {
    ...
    public function it_has_fluent_interface(ProvinceInterface $province, ZoneInterface $zone)
    {
