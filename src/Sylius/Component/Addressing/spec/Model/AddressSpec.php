...
final class AddressSpec extends ObjectBehavior
{
    ...
    public function it_implements_Sylius_address_interface(): void
    {
    ...
    public function it_has_no_first_name_by_default(): void
    {
        $this->getFirstName()->shouldReturn(null);
    }

    public function its_first_name_is_mutable(): void
    {
        $this->setFirstName('John');
        $this->getFirstName()->shouldReturn('John');
    }

    public function it_has_no_last_name_by_default(): void
    {
        $this->getLastName()->shouldReturn(null);
    }

    public function its_last_name_is_mutable(): void
    {
    ...
    public function its_phone_number_is_mutable(): void
    {
        $this->setPhoneNumber('+48555123456');
        $this->getPhoneNumber()->shouldReturn('+48555123456');
    }

    public function it_has_no_country_by_default(): void
    {
        $this->getCountryCode()->shouldReturn(null);
    }

    public function its_country_code_is_mutable(): void
    {
        $this->setCountryCode('IE');
        $this->getCountryCode()->shouldReturn('IE');
    }

    public function it_allows_to_unset_the_country_code(): void
    {
        $this->setCountryCode('IE');
        $this->getCountryCode()->shouldReturn('IE');
    ...
    public function it_unsets_the_province_code_when_erasing_country_code(): void
    {
        $this->setCountryCode('IE');
    ...
    public function it_ignores_province_code_when_there_is_no_country_code(): void
    {
        $this->setCountryCode(null);
        $this->setProvinceCode('DU');
        $this->getProvinceCode()->shouldReturn(null);
    ...
    public function its_province_code_is_mutable(): void
    {
        $this->setCountryCode('IE');
    ...
    public function it_has_no_province_name_by_default(): void
    {
        $this->getProvinceName()->shouldReturn(null);
    }

    public function its_province_name_is_mutable(): void
    {
    ...
    public function its_company_is_mutable(): void
    {
        $this->setCompany('Foo Ltd.');
        $this->getCompany()->shouldReturn('Foo Ltd.');
    }

    public function it_has_no_street_by_default(): void
    {
        $this->getStreet()->shouldReturn(null);
    }

    public function its_street_is_mutable(): void
    {
        $this->setStreet('Foo Street 3/44');
        $this->getStreet()->shouldReturn('Foo Street 3/44');
    }

    public function it_has_no_city_by_default(): void
    {
        $this->getCity()->shouldReturn(null);
    }

    public function its_city_is_mutable(): void
    {
        $this->setCity('New York');
        $this->getCity()->shouldReturn('New York');
    }

    public function it_has_no_postcode_by_default(): void
    {
        $this->getPostcode()->shouldReturn(null);
    }

    public function its_postcode_is_mutable(): void
    {
        $this->setPostcode('24154');
        $this->getPostcode()->shouldReturn('24154');
    }

    public function its_creation_time_is_initialized_by_default(): void
    {
        $this->getCreatedAt()->shouldHaveType(\DateTimeInterface::class);
    }

    public function its_last_update_time_is_undefined_by_default(): void
    {
