...
class AddressSpec extends ObjectBehavior
{
    ...
    public function it_implements_Sylius_address_interface()
    {
    ...
    public function it_has_no_phone_number_by_default()
    {
        $this->getPhoneNumber()->shouldReturn(null);
    }

    public function its_phone_number_is_mutable()
    {
    ...
    public function it_allows_to_unset_the_country(CountryInterface $country)
    {
        $this->setCountry($country);
        $this->getCountry()->shouldReturn($country);
    ...
    public function it_unsets_the_province_when_erasing_the_country(
    ...
    public function it_has_no_province_by_default()
    {
        $this->getProvince()->shouldReturn(null);
    }

    public function it_throws_exception_if_trying_to_define_province_without_country(ProvinceInterface $province)
    {
        $this
    ...
    public function its_province_is_mutable(
        CountryInterface $country,
        ProvinceInterface $province
    ) {
        $country->hasProvince($province)->willReturn(true);
    ...
    public function it_throws_if_trying_to_define_province_which_does_not_belong_to_country(
        CountryInterface $country,
        ProvinceInterface $province
    ) {
    ...
    public function its_creation_time_is_initialized_by_default()
    {
        $this->getCreatedAt()->shouldHaveType('DateTime');
    }

    public function its_last_update_time_is_undefined_by_default()
    {
