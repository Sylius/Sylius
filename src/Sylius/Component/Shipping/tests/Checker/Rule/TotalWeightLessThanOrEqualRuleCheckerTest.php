...
final class TotalWeightLessThanOrEqualRuleCheckerTest extends TestCase
{
    private MockObject&ShippingSubjectInterface $shippingSubject;

    private TotalWeightLessThanOrEqualRuleChecker $ruleChecker;

    protected function setUp(): void
    {
        $this->shippingSubject = $this->createMock(ShippingSubjectInterface::class);
        $this->ruleChecker = new TotalWeightLessThanOrEqualRuleChecker();
    }
    ...
    public function testShouldRecognizeSubjectIfTotalWeightIsLessThanConfiguredWeight(): void
    {
    ...
    public function testShouldDenySubjectIfTotalWeightIsGreaterThanConfiguredWeight(): void
    {
