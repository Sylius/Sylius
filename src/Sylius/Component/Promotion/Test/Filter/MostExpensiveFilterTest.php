...
use Sylius\Component\Promotion\Filter\MostExpensiveFilter;

class MostExpensiveFilterTest extends \PHPUnit_Framework_TestCase
{
    /**
     * Subject under tests
     *
     * @var MostExpensiveFilter
     */
    private $sut;

    public function setUp()
    {
        $this->sut = new MostExpensiveFilter();
    }
     ...
     * @param $expectedItem
     */
    public function it_returns_element_with_the_most_unit_price($givenCollection, $expectedItem)
    {
