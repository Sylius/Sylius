 ...
 */
class MinimumInsufficientRequirementsExceptionSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Component\Inventory\Manager\MinimumInsufficientRequirementsException');
    }
