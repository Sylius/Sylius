Store Component [![Build status...](https://secure.travis-ci.org/Sylius/SyliusStoreBundle.png?branch=master)](http://travis-ci.org/Sylius/SyliusStoreBundle)
===============

PHP library for handling multiple stores in e-commerce applications.
...
Documentation is available on [**docs.sylius.org**](http://docs.sylius.org/en/latest/bundles/SyliusStoreBundle/index.html).
...
License can be found [here](https://github.com/Sylius/Store/blob/master/LICENSE).

Authors
-------

The component was originally created by [Paweł Jędrzejewski](http://pjedrzejewski.com).
See the list of [contributors](https://github.com/Sylius/Store/contributors).
