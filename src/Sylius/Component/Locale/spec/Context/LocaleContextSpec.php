...
class LocaleContextSpec extends ObjectBehavior
{
    ...
    public function it_implements_Sylius_locale_context_interface()
    {
        $this->shouldImplement('Sylius\Component\Locale\Context\LocaleContextInterface');
    }

    public function it_gets_default_locale()
    {
        $this->getDefaultLocale()->shouldReturn('pl_PL');
    }

    public function it_gets_locale_from_session($storage)
    {
    ...
    public function it_sets_locale_to_session($storage)
    {
