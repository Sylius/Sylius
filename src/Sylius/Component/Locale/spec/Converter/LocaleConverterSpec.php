...
{
    public function it_is_a_locale_converter(): void
    {
        $this->shouldImplement(LocaleConverterInterface::class);
    }

    public function it_converts_locale_name_to_locale_code(): void
    {
    ...
    public function it_converts_locale_code_to_locale_name(): void
    {
    ...
    public function it_throws_invalid_argument_exception_if_cannot_convert_name_to_code(): void
    {
        $this->shouldThrow(\InvalidArgumentException::class)->during('convertNameToCode', ['xyz']);
    }

    public function it_throws_invalid_argument_exception_if_cannot_convert_code_to_name(): void
    {
