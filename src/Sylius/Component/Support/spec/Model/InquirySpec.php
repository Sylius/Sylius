...
use Sylius\Component\Support\Model\TopicInterface;

/**
 * @author Michał Marcinkowski <michal.marcinkowski@lakion.com>
 */
class InquirySpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType('Sylius\Component\Support\Model\Inquiry');
    }

    function it_implements_Sylius_contact_inquiry_interface()
    {
        $this->shouldImplement('Sylius\Component\Support\Model\InquiryInterface');
    }
