...
class TopicSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Component\Support\Model\Topic');
    }

    function it_implements_Sylius_support_topic_interface()
    {
        $this->shouldImplement('Sylius\Component\Support\Model\TopicInterface');
    }
