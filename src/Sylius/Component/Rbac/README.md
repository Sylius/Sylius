Rbac Component [![Build status...](https://secure.travis-ci.org/Sylius/Rbac.png?branch=master)](http://travis-ci.org/Sylius/Rbac)
==============
...
Documentation is available on [**docs.sylius.org**](http://docs.sylius.org/en/latest/components/Rbac/index.html).
...
See the list of [contributors](https://github.com/Sylius/Rbac/contributors).
