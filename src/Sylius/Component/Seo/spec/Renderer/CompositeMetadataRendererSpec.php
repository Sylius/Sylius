...
namespace spec\Sylius\Component\Seo\Renderer;

use PhpSpec\ObjectBehavior;
use Sylius\Component\Seo\Model\MetadataInterface;
use Sylius\Component\Seo\Renderer\MetadataRendererInterface;

/**
 * @mixin \Sylius\Component\Seo\Renderer\CompositeMetadataRenderer
 *
...
class CompositeMetadataRendererSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Component\Seo\Renderer\CompositeMetadataRenderer');
    }

    function it_implements_Metadata_Renderer_interface()
    {
        $this->shouldImplement('Sylius\Component\Seo\Renderer\MetadataRendererInterface');
    }
