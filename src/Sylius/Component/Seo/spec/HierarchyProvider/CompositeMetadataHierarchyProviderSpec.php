...
namespace spec\Sylius\Component\Seo\HierarchyProvider;
...
/**
 * @mixin \Sylius\Component\Seo\HierarchyProvider\CompositeMetadataHierarchyProvider
 *
...
class CompositeMetadataHierarchyProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Component\Seo\HierarchyProvider\CompositeMetadataHierarchyProvider');
    }
