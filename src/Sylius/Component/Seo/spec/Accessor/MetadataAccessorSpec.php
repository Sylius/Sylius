...
namespace spec\Sylius\Component\Seo\Accessor;

use PhpSpec\ObjectBehavior;
use Sylius\Component\Seo\Model\MetadataInterface;
use Sylius\Component\Seo\Model\MetadataSubjectInterface;
use Sylius\Component\Seo\Provider\MetadataProviderInterface;
use Symfony\Component\PropertyAccess\PropertyAccessorInterface;

/**
 * @mixin \Sylius\Component\Seo\Accessor\MetadataAccessor
 *
...
class MetadataAccessorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Component\Seo\Accessor\MetadataAccessor');
    }

    function it_implements_Metadata_Helper_interface()
    {
        $this->shouldImplement('Sylius\Component\Seo\Accessor\MetadataAccessorInterface');
    }
