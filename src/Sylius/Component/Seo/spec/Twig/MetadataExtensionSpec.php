...
namespace spec\Sylius\Component\Seo\Twig;

use PhpSpec\ObjectBehavior;
use Sylius\Component\Seo\Accessor\MetadataAccessorInterface;
...
/**
 * @mixin \Sylius\Component\Seo\Twig\MetadataExtension
 *
...
class MetadataExtensionSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Component\Seo\Twig\MetadataExtension');
    }
