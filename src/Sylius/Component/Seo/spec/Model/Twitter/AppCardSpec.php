...
use Sylius\Component\Seo\Model\Twitter\AppCard;

/**
 * @mixin \Sylius\Component\Seo\Model\Twitter\AppCard
 *
...
class AppCardSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Component\Seo\Model\Twitter\AppCard');
    }

    function it_implements_App_Card_interface()
    {
        $this->shouldImplement('Sylius\Component\Seo\Model\Twitter\AppCardInterface');
    }
