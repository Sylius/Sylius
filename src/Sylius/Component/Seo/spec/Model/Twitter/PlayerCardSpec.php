...
use Sylius\Component\Seo\Model\Twitter\PlayerCard;

/**
 * @mixin \Sylius\Component\Seo\Model\Twitter\PlayerCard
 *
...
class PlayerCardSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Component\Seo\Model\Twitter\PlayerCard');
    }

    function it_implements_Summary_Card_interface()
    {
        $this->shouldImplement('Sylius\Component\Seo\Model\Twitter\PlayerCardInterface');
    }
