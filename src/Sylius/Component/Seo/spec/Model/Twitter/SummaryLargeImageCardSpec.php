...
use Sylius\Component\Seo\Model\Twitter\SummaryLargeImageCard;

/**
 * @mixin \Sylius\Component\Seo\Model\Twitter\SummaryLargeImageCard
 *
...
class SummaryLargeImageCardSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Component\Seo\Model\Twitter\SummaryLargeImageCard');
    }

    function it_implements_Summary_Large_Image_Card_interface()
    {
        $this->shouldImplement('Sylius\Component\Seo\Model\Twitter\SummaryLargeImageCardInterface');
    }
