...
final class OrderTotalLessThanOrEqualRuleCheckerTest extends TestCase
{
    ...
    private OrderTotalLessThanOrEqualRuleChecker $ruleChecker;
    ...
    protected function setUp(): void
    {
        ...
        $this->ruleChecker = new OrderTotalLessThanOrEqualRuleChecker();
    }
    ...
    {
        $this->assertInstanceOf(OrderTotalLessThanOrEqualRuleChecker::class, $this->ruleChecker);
    }
    ...
    public function testShouldRecognizeSubjectIfOrderTotalIsLessThanConfiguredAmount(): void
    {
    ...
    public function testShouldDenySubjectIfOrderTotalIsGreaterThanConfiguredAmount(): void
    {
        $this->subject->expects($this->once())->method('getOrder')->willReturn($this->order);
        $this->order->expects($this->once())->method('getChannel')->willReturn($this->channel);
