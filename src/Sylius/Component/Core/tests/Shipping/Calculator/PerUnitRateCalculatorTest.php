...
final class PerUnitRateCalculatorTest extends TestCase
{
    ...
    public function testShouldReturnPerUnitRateType(): void
    {
    ...
    public function testShouldCalculateTheTotalWithThePerUnitAmountConfiguredOnTheMethod(): void
    {
        ...
        $this->shipment->expects($this->once())->method('getShippingUnitCount')->willReturn(10);
        ...
        $this->assertSame(
            2000,
            $this->calculator->calculate($this->shipment, ['WEB' => ['amount' => 200]]),
        );
    }
