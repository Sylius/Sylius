...
{
    function let(DomainManagerInterface $manager, RepositoryInterface $variantRepository)
    {
        $this->beConstructedWith($manager, $variantRepository);
    }
    ...
    function it_adds_product_as_promotion(
        ...
        $manager->createNew()->willReturn($item);
