...
final class PerChannelCustomerStatisticsSpec extends ObjectBehavior
{
    ...
    public function it_has_number_of_orders(): void
    {
        $this->getOrdersCount()->shouldReturn(10);
    }

    public function it_has_the_combined_value_of_all_orders(): void
    {
        $this->getOrdersValue()->shouldReturn(20000);
    }

    public function it_has_a_clone_of_the_origin_channel_of_orders(ChannelInterface $channel): void
    {
        $this->getChannel()->shouldBeLike($channel);
    }

    public function it_has_an_average_value_of_an_order(): void
    {
