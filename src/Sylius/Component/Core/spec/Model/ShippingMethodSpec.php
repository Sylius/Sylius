...
final class ShippingMethodSpec extends ObjectBehavior
{
    ...
    public function it_implements_a_shipping_method_interface(): void
    {
        $this->shouldImplement(ShippingMethodInterface::class);
    }

    public function it_extends_a_shipping_method(): void
    {
        $this->shouldHaveType(BaseShippingMethod::class);
    }

    public function it_does_not_have_any_zone_defined_by_default(): void
    {
        $this->getZone()->shouldReturn(null);
    }

    public function it_allows_defining_zone(ZoneInterface $zone): void
    {
        $this->setZone($zone);
        $this->getZone()->shouldReturn($zone);
    }

    public function its_tax_category_is_mutable(TaxCategoryInterface $category): void
    {
