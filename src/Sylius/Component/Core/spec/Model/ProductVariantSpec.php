...
{
    public function it_implements_a_product_variant_interface(): void
    {
        $this->shouldImplement(ProductVariantInterface::class);
    }

    public function it_implements_a_taxable_interface(): void
    {
        $this->shouldImplement(TaxableInterface::class);
    }

    public function it_extends_a_product_variant_model(): void
    {
        $this->shouldHaveType(BaseProductVariant::class);
    }

    public function it_implements_a_shippable_interface(): void
    {
        $this->shouldImplement(ShippableInterface::class);
    }

    public function it_implements_versioned_interface(): void
    {
        $this->shouldImplement(VersionedInterface::class);
    }

    public function it_implements_a_product_image_aware_interface(): void
    {
    ...
    public function it_has_no_weight_by_default(): void
    {
        $this->getWeight()->shouldReturn(null);
    }

    public function its_weight_is_mutable(): void
    {
        $this->setWeight(120.00);
        $this->getWeight()->shouldReturn(120.00);
    }

    public function it_has_no_width_by_default(): void
    {
        $this->getWidth()->shouldReturn(null);
    }

    public function its_width_is_mutable(): void
    {
        $this->setWidth(15.00);
        $this->getWidth()->shouldReturn(15.00);
    }

    public function it_has_no_height_by_default(): void
    {
        $this->getHeight()->shouldReturn(null);
    }

    public function its_height_is_mutable(): void
    {
        $this->setHeight(40.00);
        $this->getHeight()->shouldReturn(40.00);
    }

    public function it_returns_correct_shipping_weight(): void
    {
        $this->setWeight(140.00);
        $this->getShippingWeight()->shouldReturn(140.00);
    }

    public function it_returns_correct_shipping_volume(): void
    {
        $this->setWidth(10.00);
    ...
    public function it_returns_correct_shipping_width(): void
    {
        $this->setWidth(100.00);
        $this->getShippingWidth()->shouldReturn(100.00);
    }

    public function it_returns_correct_shipping_height(): void
    {
    ...
    public function it_does_not_have_tax_category_by_default(): void
    {
        $this->getTaxCategory()->shouldReturn(null);
    }

    public function it_allows_setting_the_tax_category(TaxCategoryInterface $taxCategory): void
    {
        $this->setTaxCategory($taxCategory);
        $this->getTaxCategory()->shouldReturn($taxCategory);
    }

    public function it_allows_resetting_the_tax_category(TaxCategoryInterface $taxCategory): void
    {
        $this->setTaxCategory($taxCategory);
        $this->getTaxCategory()->shouldReturn($taxCategory);
    ...
    public function it_has_no_shipping_category_by_default(): void
    {
        $this->getShippingCategory()->shouldReturn(null);
    }

    public function its_shipping_category_is_mutable(ShippingCategoryInterface $shippingCategory): void
    {
        $this->setShippingCategory($shippingCategory);
        $this->getShippingCategory()->shouldReturn($shippingCategory);
    }

    public function it_adds_and_removes_channel_pricings(ChannelPricingInterface $channelPricing): void
    {
    ...
    public function it_has_channel_pricings_collection(
    ...
    public function it_checks_if_contains_channel_pricing_for_given_channel(
    ...
    public function it_returns_channel_pricing_for_given_channel(
    ...
    public function it_requires_shipping_by_default(): void
    {
        $this->isShippingRequired()->shouldReturn(true);
    }

    public function its_shipping_can_be_not_required(): void
    {
        $this->setShippingRequired(false);
        $this->isShippingRequired()->shouldReturn(false);
    }

    public function it_initializes_image_collection_by_default(): void
    {
        $this->getImages()->shouldHaveType(Collection::class);
    }

    public function it_adds_an_image(ProductImageInterface $image): void
    {
        $this->addImage($image);
    ...
    public function it_removes_an_image(ProductImageInterface $image): void
    {
        $this->addImage($image);
    ...
    public function it_returns_images_by_type(ProductImageInterface $image, Product $product): void
    {
