...
{
    public function it_implements_channel_pricing_interface(): void
    {
        $this->shouldImplement(ChannelPricingInterface::class);
    }

    public function its_channel_code_is_mutable(): void
    {
    ...
    public function it_does_not_have_original_price_by_default(): void
    {
        $this->getOriginalPrice()->shouldReturn(null);
    }

    public function its_original_price_is_mutable(): void
    {
        $this->setOriginalPrice(2000);
        $this->getOriginalPrice()->shouldReturn(2000);
    }

    public function its_price_can_be_reduced(): void
    {
        $this->setPrice(1000);
        $this->setOriginalPrice(2000);
    ...
    public function its_price_is_not_reduced_when_does_not_have_original_price(): void
    {
        $this->setPrice(2000);
        $this->isPriceReduced()->shouldReturn(false);
    }

    public function its_price_is_not_reduced_when_original_price_is_same_as_price(): void
    {
        $this->setPrice(2000);
        $this->setOriginalPrice(2000);
        $this->isPriceReduced()->shouldReturn(false);
    ...
    public function it_price_is_not_reduced_when_original_price_is_smaller_than_price(): void
    {
        $this->setPrice(2000);
