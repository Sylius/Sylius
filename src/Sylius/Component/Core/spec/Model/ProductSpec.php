...
{
    public function let(VariantInterface $variant): void
    {
    ...
    public function it_implements_a_product_interface(): void
    {
        $this->shouldImplement(ProductInterface::class);
    }

    public function it_implements_an_image_aware_interface(): void
    {
        $this->shouldImplement(ImagesAwareInterface::class);
    }

    public function it_extends_a_product_model(): void
    {
        $this->shouldHaveType(BaseProduct::class);
    }

    public function it_initializes_a_product_taxon_collection_by_default(): void
    {
        $this->getProductTaxons()->shouldHaveType(Collection::class);
    }

    public function it_adds_a_product_taxons(ProductTaxonInterface $productTaxon): void
    {
        $this->addProductTaxon($productTaxon);
        $this->hasProductTaxon($productTaxon)->shouldReturn(true);
    }

    public function it_removes_a_product_taxons(ProductTaxonInterface $productTaxon): void
    {
        $this->addProductTaxon($productTaxon);
    ...
    public function its_variant_selection_method_is_choice_by_default(): void
    {
        $this->getVariantSelectionMethod()->shouldReturn(Product::VARIANT_SELECTION_CHOICE);
    }

    public function its_variant_selection_method_can_be_changed_to_option_match(): void
    {
        $this->setVariantSelectionMethod(Product::VARIANT_SELECTION_MATCH);
    }

    public function it_throws_exception_if_any_other_value_is_given_as_variant_selection_method(): void
    {
        $this
    ...
    public function it_has_no_main_taxon_by_default(): void
    {
        $this->getMainTaxon()->shouldReturn(null);
    }

    public function it_sets_main_taxon(TaxonInterface $taxon): void
    {
    ...
    public function it_adds_an_image(ImageInterface $image): void
    {
        $this->addImage($image);
    ...
    public function it_removes_an_image(ImageInterface $image): void
    {
        $this->addImage($image);
    ...
    public function it_returns_images_by_type(ImageInterface $image): void
    {
    ...
    public function it_proxies_taxon_collection(ProductTaxonInterface $productTaxon, TaxonInterface $taxon, TaxonInterface $otherTaxon): void
    {
