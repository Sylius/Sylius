...
{
    public function it_implements_a_core_product_interface(): void
    {
        $this->shouldImplement(ProductTranslationInterface::class);
    }

    public function it_extends_a_product_translation_model(): void
    {
        $this->shouldHaveType(BaseProductTranslation::class);
    }

    public function it_does_not_have_a_short_description_by_default(): void
    {
        $this->getShortDescription()->shouldReturn(null);
    }

    public function its_short_description_is_mutable(): void
    {
