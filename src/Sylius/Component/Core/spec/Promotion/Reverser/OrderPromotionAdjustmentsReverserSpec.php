 ...
 */
final class OrderPromotionAdjustmentsReverserSpec extends ObjectBehavior
{
    ...
    function it_reverts_promotion_adjustments_on_all_units_of_given_order(
        ...
        $unit1->getAdjustments(AdjustmentInterface::ORDER_PROMOTION_ADJUSTMENT)->shouldBeCalled()->willReturn([$firstAdjustment]);
        ...
        $unit2->getAdjustments(AdjustmentInterface::ORDER_PROMOTION_ADJUSTMENT)->shouldBeCalled()->willReturn([$secondAdjustment]);
        $promotion->getCode()->shouldBeCalled()->willReturn('code');
