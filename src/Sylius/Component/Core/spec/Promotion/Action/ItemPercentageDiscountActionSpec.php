...
class ItemPercentageDiscountActionSpec extends ObjectBehavior
{
    ...
    function it_applies_percentage_discount_on_every_unit_in_order(
        ...
        $promotionAdjustment1->setType(AdjustmentInterface::PROMOTION_ADJUSTMENT)->shouldBeCalled();
        ...
        $promotionAdjustment2->setType(AdjustmentInterface::PROMOTION_ADJUSTMENT)->shouldBeCalled();
