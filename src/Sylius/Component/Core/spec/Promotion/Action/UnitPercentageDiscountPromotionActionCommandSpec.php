...
final class UnitPercentageDiscountPromotionActionCommandSpec extends ObjectBehavior
{
    ...
    function it_applies_percentage_discount_on_every_unit_in_order_using_several_filters_if_composite_is_not_defined(
        FactoryInterface $adjustmentFactory,
        FilterInterface $priceRangeFilter,
        FilterInterface $taxonFilter,
        FilterInterface $productFilter,
    ...
    function it_applies_percentage_discount_on_every_unit_in_order_using_composite_if_defined(
        FactoryInterface $adjustmentFactory,
        ...
        $compositeFilter->filter([$orderItem1], ['percentage' => 0.2, 'channel' => $channel])->willReturn([$orderItem1]);
    ...
    function it_applies_discount_only_to_non_discounted_units_if_promotion_does_not_apply_to_discounted_ones_using_several_filters_if_composite_is_not_defined(
        FactoryInterface $adjustmentFactory,
        FilterInterface $priceRangeFilter,
        FilterInterface $taxonFilter,
        FilterInterface $productFilter,
    ...
    function it_applies_discount_only_to_non_discounted_units_if_promotion_does_not_apply_to_discounted_ones_using_composite_if_defined(
        FactoryInterface $adjustmentFactory,
        FilterInterface $compositeFilter,
        ChannelInterface $channel,
        AdjustmentInterface $promotionAdjustment,
        ...
        $compositeFilter->filter([$orderItem1, $orderItem2], ['percentage' => 0.2, 'channel' => $channel])->willReturn([$orderItem1, $orderItem2]);
    ...
    function it_does_not_apply_a_discount_if_all_items_have_been_filtered_out_using_several_filters_if_composite_is_not_defined(
        FilterInterface $priceRangeFilter,
        FilterInterface $taxonFilter,
        FilterInterface $productFilter,
        ChannelInterface $channel,
