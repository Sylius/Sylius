...
final class OrderItemsTaxesApplicatorTest extends TestCase
{
    ...
    {
        /** @var FactoryInterface<AdjustmentInterface> $baseAdjustmentFactory */
        $baseAdjustmentFactory = new Factory(Adjustment::class);
        $applicator = new OrderItemsTaxesApplicator(
            new DecimalCalculator(),
            new AdjustmentFactory($baseAdjustmentFactory),
