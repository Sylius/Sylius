...
{
    public function it_implements_a_currency_name_converter_interface(): void
    {
        $this->shouldImplement(CurrencyNameConverterInterface::class);
    }

    public function it_converts_an_english_currency_name_to_code_by_default(): void
    {
        $this->convertToCode('Euro')->shouldReturn('EUR');
    }

    public function it_converts_a_name_to_a_code_for_given_locale(): void
    {
        $this->convertToCode('rupia indyjska', 'pl')->shouldReturn('INR');
    }

    public function it_throws_an_invalid_argument_exception_when_currency_not_exists(): void
    {
