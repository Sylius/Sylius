Media Component [![Build status...](https://secure.travis-ci.org/Sylius/Media.png?branch=master)](http://travis-ci.org/Sylius/Media)
===============

Media component for ORM-based applications in which there are Documents involved as well.
...
Documentation is available on [**docs.sylius.org**](http://docs.sylius.org/en/latest/components/Media/index.html).
...
See the list of [contributors](https://github.com/Sylius/Media/contributors).
