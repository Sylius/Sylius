Pricing Component [![Build status...](https://secure.travis-ci.org/Sylius/SyliusPricingBundle.png?branch=master)](http://travis-ci.org/Sylius/SyliusPricingBundle)
=================

Pricing library for PHP e-commerce apps.
...
License can be found [here](https://github.com/Sylius/Pricing/blob/master/LICENSE).

Authors
-------

The component was originally created by [Paweł Jędrzejewski](http://pjedrzejewski.com).
See the list of [contributors](https://github.com/Sylius/Pricing/contributors).
