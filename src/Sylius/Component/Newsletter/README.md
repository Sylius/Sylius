Newsletter Component [![Build status...](https://secure.travis-ci.org/Sylius/Newsletter.png?branch=master)](http://travis-ci.org/Sylius/Newsletter)
===============

Newsletter component for e-commerce applications.
...
Documentation is available on [**docs.sylius.org**](http://docs.sylius.org/en/latest/components/Newsletter/index.html).
...
License can be found [here](https://github.com/Sylius/Newsletter/blob/master/LICENSE).

Authors
-------

The component was originally created by [Paweł Jędrzejewski](http://pjedrzejewski.com).
See the list of [contributors](https://github.com/Sylius/Newsletter/contributors).
