 ...
 */
interface OrderInterface extends ResourceInterface, AdjustableInterface, CommentAwareInterface, TimestampableInterface, SoftDeletableInterface, SequenceSubjectInterface
{
