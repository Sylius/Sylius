...
final class OrderSpec extends ObjectBehavior
{
    ...
    public function it_does_not_have_completed_checkout_by_default(): void
    {
        $this->shouldNotBeCheckoutCompleted();
    }

    public function its_checkout_can_be_completed(): void
    {
        $this->completeCheckout();
        $this->shouldBeCheckoutCompleted();
    }

    public function it_has_checkout_completed_when_completion_date_is_set(): void
    {
        $this->shouldNotBeCheckoutCompleted();
    ...
    public function it_has_no_checkout_completion_date_by_default(): void
    {
        $this->getCheckoutCompletedAt()->shouldReturn(null);
    }

    public function its_checkout_completion_date_is_mutable(): void
    {
    ...
    public function it_has_no_number_by_default(): void
    {
        $this->getNumber()->shouldReturn(null);
    }

    public function its_number_is_mutable(): void
    {
        $this->setNumber('001351');
        $this->getNumber()->shouldReturn('001351');
    }

    public function it_creates_items_collection_by_default(): void
    {
        $this->getItems()->shouldHaveType(Collection::class);
    }

    public function it_adds_items_properly(OrderItemInterface $item): void
    {
    ...
    public function it_removes_items_properly(OrderItemInterface $item): void
    {
        $item->getTotal()->willReturn(420);
    ...
    public function it_has_items_total_equal_to_0_by_default(): void
    {
    ...
    public function it_creates_adjustments_collection_by_default(): void
    {
    ...
    public function it_removes_adjustments_recursively_properly(
    ...
    public function it_removes_adjustments_recursively_by_type_properly(
    ...
    public function it_has_adjustments_total_equal_to_0_by_default(): void
    {
        $this->getAdjustmentsTotal()->shouldReturn(0);
    }

    public function it_calculates_correct_adjustments_total(
    ...
    public function it_returns_adjustments_total_recursively(
    ...
    public function it_has_total_quantity(OrderItemInterface $orderItem1, OrderItemInterface $orderItem2): void
    {
    ...
    public function it_calculates_correct_total_after_items_and_adjustments_changes(
        AdjustmentInterface $adjustment1,
        AdjustmentInterface $adjustment2,
        OrderItemInterface $item1,
        OrderItemInterface $item2,
    ...
    public function it_calculates_correct_total_when_adjustment_is_bigger_than_cost(
        OrderItemInterface $item,
    ...
    public function it_clears_items(OrderItemInterface $item): void
    {
        $item->getTotal()->willReturn(420);
        $item->setOrder($this)->will(function (): void {});
