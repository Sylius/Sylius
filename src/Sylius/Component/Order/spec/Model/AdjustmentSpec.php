...
{
    public function it_implements_an_adjustment_interface(): void
    {
    ...
    public function it_does_not_belong_to_an_adjustable_by_default(): void
    {
        $this->getAdjustable()->shouldReturn(null);
    }

    public function it_allows_assigning_itself_to_an_adjustable(OrderInterface $order, OrderItemInterface $orderItem): void
    {
    ...
    public function it_allows_detaching_itself_from_an_adjustable(
    ...
    public function it_throws_an_exception_during_not_supported_adjustable_class_set(AdjustableInterface $adjustable): void
    {
        $this->shouldThrow(\InvalidArgumentException::class)->during('setAdjustable', [$adjustable]);
    }

    public function it_throws_an_exception_during_adjustable_change_on_locked_adjustment(
        OrderItemInterface $orderItem,
    ...
    public function its_amount_is_mutable(): void
    {
        $this->setAmount(399);
        $this->getAmount()->shouldReturn(399);
    }

    public function it_recalculates_adjustments_on_adjustable_entity_on_amount_change(
        OrderInterface $order,
        OrderItemInterface $orderItem,
        OrderItemUnitInterface $orderItemUnit
    ): void {
    ...
    public function it_does_not_recalculate_adjustments_on_adjustable_entity_on_amount_change_when_adjustment_is_neutral(
        OrderItemUnitInterface $orderItemUnit
    ): void {
        $orderItemUnit->addAdjustment($this->getWrappedObject())->shouldBeCalled();
        $this->setAdjustable($orderItemUnit);
    ...
    public function its_amount_should_accept_only_integer(): void
    {
        $this->setAmount(4498);
        $this->getAmount()->shouldReturn(4498);
    }

    public function it_is_not_neutral_by_default(): void
    {
        $this->shouldNotBeNeutral();
    }

    public function its_neutrality_is_mutable(): void
    {
        $this->shouldNotBeNeutral();
        $this->setNeutral(true);
    ...
    public function it_recalculate_adjustments_on_adjustable_entity_on_neutral_change(OrderItemUnitInterface $orderItemUnit): void
    {
        $orderItemUnit->addAdjustment($this->getWrappedObject())->shouldBeCalled();
        $this->setAdjustable($orderItemUnit);
        $orderItemUnit->recalculateAdjustmentsTotal()->shouldBeCalled();
    ...
    public function it_does_not_recalculate_adjustments_on_adjustable_entity_when_neutral_set_to_current_value(
        OrderInterface $order
    ): void {
        $order->addAdjustment($this->getWrappedObject())->shouldBeCalled();
        $this->setAdjustable($order);
    ...
    public function it_is_a_charge_if_amount_is_lesser_than_0(): void
    {
        $this->setAmount(-499);
        $this->shouldBeCharge();
    ...
    public function it_is_a_credit_if_amount_is_greater_than_0(): void
    {
        $this->setAmount(2999);
        $this->shouldBeCredit();
    ...
    public function its_origin_code_is_mutable(): void
    {
