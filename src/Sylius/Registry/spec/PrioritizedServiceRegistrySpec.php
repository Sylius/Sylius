...
namespace spec\Sylius\Registry;

require_once __DIR__.'/Fixture/SampleServiceInterface.php';

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use spec\Sylius\Registry\Fixture\SampleServiceInterface;
use Sylius\Registry\NonExistingServiceException;
use Sylius\Registry\PrioritizedServiceRegistry;
...
class PrioritizedServiceRegistrySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Registry\PrioritizedServiceRegistry');
    }
