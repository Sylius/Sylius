...
namespace Sylius\SequenceBundle\Doctrine\ORM;
...
use Sylius\Sequence\Model\SequenceInterface;
use Sylius\Sequence\Model\SequenceSubjectInterface;
use Sylius\Sequence\Registry\NonExistingGeneratorException;
use Sylius\Sequence\SyliusSequenceEvents;
