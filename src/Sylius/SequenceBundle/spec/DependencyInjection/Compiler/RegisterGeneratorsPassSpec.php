...
namespace spec\Sylius\SequenceBundle\DependencyInjection\Compiler;
...
class RegisterGeneratorsPassSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\SequenceBundle\DependencyInjection\Compiler\RegisterGeneratorsPass');
    }
