...
namespace spec\Sylius\ProductBundle\Validator;

use Doctrine\Common\Persistence\ObjectRepository;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\ProductBundle\Validator\Constraint\ProductUnique;
...
class ProductUniqueValidatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ProductBundle\Validator\ProductUniqueValidator');
    }
