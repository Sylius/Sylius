...
namespace spec\Sylius\ProductBundle\EventListener;

use Doctrine\Common\Persistence\ObjectManager;
use Doctrine\Common\Persistence\ObjectRepository;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\Archetype\Builder\ArchetypeBuilderInterface;
...
class ArchetypeUpdateListenerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ProductBundle\EventListener\ArchetypeUpdateListener');
    }
