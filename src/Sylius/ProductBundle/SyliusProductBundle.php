...
namespace Sylius\ProductBundle;

use Sylius\ProductBundle\DependencyInjection\Compiler\ServicesPass;
use Sylius\ProductBundle\DependencyInjection\Compiler\ValidatorPass;
