...
namespace Sylius\ProductBundle\Form\Type;

use Sylius\ProductBundle\Form\EventSubscriber\ProductOptionFieldSubscriber;
use Sylius\ProductBundle\Form\EventSubscriber\SimpleProductSubscriber;
