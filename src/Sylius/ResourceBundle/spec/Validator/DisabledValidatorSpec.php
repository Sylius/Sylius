...
namespace spec\Sylius\ResourceBundle\Validator;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\ResourceBundle\Validator\Constraints;
use Sylius\Resource\Model\ToggleableInterface;
use Symfony\Component\Validator\ConstraintValidatorInterface;
use Symfony\Component\Validator\Context\ExecutionContextInterface;

/**
 * @mixin \Sylius\ResourceBundle\Validator\DisabledValidator
 *
...
class DisabledValidatorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ResourceBundle\Validator\DisabledValidator');
    }
