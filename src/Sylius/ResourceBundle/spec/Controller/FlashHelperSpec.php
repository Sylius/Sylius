...
use Sylius\ResourceBundle\Controller\FlashHelper;
...
class FlashHelperSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ResourceBundle\Controller\FlashHelper');
    }

    function it_implements_flash_helper_interface()
    {
        $this->shouldImplement('Sylius\ResourceBundle\Controller\FlashHelperInterface');
    }
