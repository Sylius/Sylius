...
use Sylius\ResourceBundle\Controller\StateMachine;
use Sylius\ResourceBundle\Controller\StateMachineInterface as ResourceStateMachineInterface;
...
class StateMachineSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ResourceBundle\Controller\StateMachine');
    }
