...
use Sylius\ResourceBundle\Controller\EventDispatcher;
use Sylius\ResourceBundle\Controller\EventDispatcherInterface as ControllerEventDispatcherInterface;
...
class EventDispatcherSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ResourceBundle\Controller\EventDispatcher');
    }
