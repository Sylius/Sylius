...
namespace spec\Sylius\ResourceBundle\EventListener;
...
use Sylius\ResourceBundle\EventListener\ORMRepositoryClassSubscriber;
...
class ORMRepositoryClassSubscriberSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ResourceBundle\EventListener\ORMRepositoryClassSubscriber');
    }
