...
use Sylius\ResourceBundle\EventListener\ODMRepositoryClassSubscriber;
...
class ODMRepositoryClassSubscriberSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ResourceBundle\EventListener\ODMRepositoryClassSubscriber');
    }
