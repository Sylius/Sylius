...
namespace spec\Sylius\ResourceBundle\Twig;

use Pagerfanta\Pagerfanta;
use PhpSpec\ObjectBehavior;
use Sylius\ResourceBundle\Controller\Parameters;
...
class ResourceExtensionSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ResourceBundle\Twig\ResourceExtension');
    }
