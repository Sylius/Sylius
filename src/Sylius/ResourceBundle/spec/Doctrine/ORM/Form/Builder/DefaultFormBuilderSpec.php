...
namespace spec\Sylius\ResourceBundle\Doctrine\ORM\Form\Builder;
...
use Sylius\ResourceBundle\Doctrine\ORM\Form\Builder\DefaultFormBuilder;
...
class DefaultFormBuilderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ResourceBundle\Doctrine\ORM\Form\Builder\DefaultFormBuilder');
    }
