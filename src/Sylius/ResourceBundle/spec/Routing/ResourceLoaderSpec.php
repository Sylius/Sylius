...
namespace spec\Sylius\ResourceBundle\Routing;

use PhpSpec\ObjectBehavior;
use Sylius\ResourceBundle\Routing\ResourceLoader;
use Sylius\ResourceBundle\Routing\RouteFactoryInterface;
...
class ResourceLoaderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ResourceBundle\Routing\ResourceLoader');
    }
