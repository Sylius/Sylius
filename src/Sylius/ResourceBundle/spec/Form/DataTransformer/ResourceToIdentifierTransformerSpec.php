...
namespace spec\Sylius\ResourceBundle\Form\DataTransformer;
...
class ResourceToIdentifierTransformerSpec extends ObjectBehavior
{
    ...
    {
        $repository->getClassName()->willReturn('spec\Sylius\ResourceBundle\Form\DataTransformer\FakeEntity');
        $this->beConstructedWith($repository, 'id');
    }

    function it_is_initializable()
    {
        $this->shouldHaveType('Sylius\ResourceBundle\Form\DataTransformer\ResourceToIdentifierTransformer');
    }
