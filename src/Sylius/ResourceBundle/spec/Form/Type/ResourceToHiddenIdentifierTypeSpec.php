...
namespace spec\Sylius\ResourceBundle\Form\Type;

use Doctrine\Common\Persistence\ManagerRegistry;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Sylius\ResourceBundle\Form\DataTransformer\ResourceToIdentifierTransformer;
...
class ResourceToHiddenIdentifierTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ResourceBundle\Form\Type\ResourceToHiddenIdentifierType');
    }
