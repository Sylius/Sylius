...
use Sylius\ResourceBundle\Form\EventSubscriber\ResourceTranslationsSubscriber;
...
class ResourceTranslationsTypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ResourceBundle\Form\Type\ResourceTranslationsType');
    }
