...
namespace spec\Sylius\ResourceBundle\Form\EventSubscriber;
...
class ResourceTranslationsSubscriberSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\ResourceBundle\Form\EventSubscriber\ResourceTranslationsSubscriber');
    }
