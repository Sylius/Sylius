...
In order to customize the login view you should extend the ``@SyliusShopBundle/views/login.html.twig`` template file
in your theme directory: ``app/themes/CrimsonTheme/SyliusShopBundle/views/login.html.twig``.
