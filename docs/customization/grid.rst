...
.. note::
    ...
    We assume that you are familiar with grids. If not check the documentation of the :doc:`Grid Bundle </bundles/bundles/SyliusGridBundle/index>`
    and :doc:`Grid Component </bundles/components/Grid/index>` first.
...
* :doc:`Grid - Component Documentation </bundles/components/Grid/index>`
