...
That's it! Your class is now a resource. In order to learn what does it mean, please refer to the :doc:`SyliusResourceBundle </bundles/bundles/SyliusResourceBundle/index>` documentation.
