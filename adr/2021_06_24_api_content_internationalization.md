...
* Good, because it is simplest and fastes solution at the moment of writing this document.
...
As researched by @pamil, we can take advanatge of JSON-LD processor, return data according to its specification and leave 
...
* Bad, because it is not part of API Platform yet and significant effor would need to be done in order to provide proper solution.
...
The first approach should be used in admin section of API, while the third one should be use in shop section. This way, we
