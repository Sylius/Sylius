 ...
 */
class Version20151217104913 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sylius_product_attribute ADD storage_type VARCHAR(255) NOT NULL, ADD validation LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE name code VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sylius_product_attribute ADD name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, DROP code, DROP storage_type, DROP validation');
