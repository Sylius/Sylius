...
class Version20141203091118 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema)
    {
        ...
        foreach ($productOptions as $productOption) {
            $this->connection->insert('sylius_product_option_translation', [
        ...
        foreach ($countries as $country) {
            $this->connection->insert('sylius_country_translation', [
                    'name' => $country['name'],
        ...
        foreach ($syliusProducts as $syliusProduct) {
            $this->connection->insert('sylius_product_translation', [
        ...
        foreach ($shippingMethods as $shippingMethod) {
            $this->connection->insert('sylius_shipping_method_translation', [
        ...
        foreach ($syliusTaxonomies as $syliusTaxonomy) {
            $this->connection->insert('sylius_taxonomy_translation', [
    ...
    public function down(Schema $schema)
    {
        ...
        foreach ($countryTranslations as $countryTranslation) {
            $this->connection->update(
                ...
                ['id' => $countryTranslation['translatable_id']]
            );
        }
        ...
        foreach ($productTranslations as $productTranslation) {
            $this->connection->update(
                ...
                ['id' => $productTranslation['translatable_id']]
            );
        }
        ...
        foreach ($productAttributesTranslations as $productAttributesTranslation) {
            $this->connection->update(
                ...
                ['presentation' => $productAttributesTranslation['presentation']],
                ['id' => $productAttributesTranslation['translatable_id']]
            );
        }
        ...
        foreach ($productOptionTranslations as $productOptionTranslation) {
            $this->connection->update(
                ...
                ['presentation' => $productOptionTranslation['presentation']],
                ['id' => $productOptionTranslation['translatable_id']]
            );
        }
        ...
        foreach ($shippingMethodsTranslations as $shippingMethodsTranslation) {
            $this->connection->update(
                ...
                ['name' => $shippingMethodsTranslation['name']],
                ['id' => $shippingMethodsTranslation['translatable_id']]
            );
        }
        ...
        foreach ($taxonomyTranslations as $taxonomyTranslation) {
            $this->connection->update(
                'sylius_taxonomy',
                ['name' => $taxonomyTranslation['name']],
                ['id' => $taxonomyTranslation['translatable_id']]
            );
        }
