 ...
 */
class Version20160921143454 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE sylius_product_image (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, path VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, code VARCHAR(255) NOT NULL, INDEX IDX_88C64B2D7E3C61F9 (owner_id), UNIQUE INDEX code_idx (owner_id, code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sylius_taxon_image CHANGE taxon_id owner_id INT NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX code_idx ON sylius_taxon_image');
        $this->addSql('ALTER TABLE sylius_taxon_image CHANGE owner_id taxon_id INT NOT NULL');
